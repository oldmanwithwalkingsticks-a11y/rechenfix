...
- **Welle-Status:** Welle 1 ✅ komplett (April 2026); Welle 2 Stufe 1 Auto ✅ (130–132.6); Welle 2 Stufe 2 Gesundheit ✅ (140–144b); **Welle 2 Stufe 3 Wohnen ✅** (147–148b, 25.04.2026); **Welle 2 Stufe 3 Arbeit ✅** (Block A 149a-d + 150a-d, Block B 152a + 153a/b + 153b-fix, 26.04.2026; geparkt für Welle 3 oder späteren Slot: 152b `feiertage.ts` SSOT-Lib, 153c Lib-Audit-Bundle für 5 Block-B-Libs, P3-B1 ueberstunden-Netto-Refactor mit Steuerklasse-Input). Vollständige Welle-Historie: [docs/audit-arbeitspapiere/welle-status-historie.md](https://github.com/oldmanwithwalkingsticks-a11y/rechenfix/blob/main/docs/audit-arbeitspapiere/welle-status-historie.md).
...
| KostBRÄG 2025 RVG/FamGKG-Tabellen | ~+6 % gegenüber Vor-2025-Werten | offen (149d Update offen — wartet auf externe Wert-Verifikation) | inline (`ScheidungskostenRechner`) | KostBRÄG 04.06.2025, gültig ab 01.06.2025 |
...
- **149d** — scheidungskosten-rechner KostBRÄG 2025 (P1-A5): **OFFEN** — wartet auf externe Verifikation der RVG/FamGKG-Tabellenwerte ab Stichtag 01.06.2025 (Karsten checkt juris Prozesskostenrechner / BMJ-Tabellen / famgkg-online.de)
- **150** — P2-Polish-Batch Block A: Mutterschutz Fehlgeburt 13./17./20. SSW (Mutterschutzanpassungsgesetz BGBl. 2025 I Nr. 59), Mutterschutz Behinderungs-Verlängerung Antragspflicht; Unterhalt Elternunterhalt-Update auf Angehörigen-Entlastungsgesetz (100k-Schwelle, 50 % statt 30 %, SB 2.000 € statt 2.650 €); Elternzeit 30h → 32h-Korrektur (BEEG-Reform 01.09.2021); Süd-OLG-Hinweis Ehegattenunterhalt — **OFFEN**
- **151** — P3-UX Block A (17 Items): Mobilitätsprämie § 101 EStG, EuGH Kücükdeveci, BAG-Zugangsbeweis, § 1a Abs. 2 S. 3 KSchG-Aufrundung, Muster 9 etc. — **OFFEN**

...
- **178 eigenständige Rechner in 10 Kategorien** (Alltag 23, Finanzen **45**, Gesundheit 17, Auto & Verkehr 11, Wohnen & Energie 25, Mathe & Schule 18, Arbeit & Recht **17**, Kochen & Ernährung 12, Sport & Fitness **5**, **Technik 5**). Neu seit 19.06.2026 (Welle 19): **10. Kategorie „Technik"** (`kategorieSlug: 'technik'`, Icon 💻) mit 5 Rechnern (internetgeschwindigkeit, datenmengen-umrechner, megapixel, stromverbrauch-geraete, bildschirmgroesse-ppi) — „Tiefe vor Breite", jeder direkt im Goldstandard; Sport von 2 auf 5 erweitert (kalorienverbrauch, vo2max, 1rm, Wellbeing-sensibel). Frühere Verschiebung 26.04.2026 (Prompt 149a): arbeitslosengeld-rechner aus Arbeit nach Finanzen migriert (SSOT-Konsistenz pro Kategorie-Datei).
...
- **204 URLs** in der Sitemap: 178 Rechner + 10 Kategorien + 6 Long-Tail-Brutto-Netto-Varianten (`/finanzen/2000-euro-brutto-netto` bis `/5000-euro-brutto-netto`) + 2 Sonderseiten (`brutto-netto-tabelle`, `mindestlohn-netto`) + Root + `/aktualisierungen` + 6 Meta-Pages (über uns, qualität, feedback, barrierefreiheit, impressum, datenschutz). Bewusst draußen: `/ki-rechner` (noindex W15A.4), `/admin/affiliate-stats` (intern), `/social` (noindex Bio-Hub). Sitemap-Generator zieht Rechner/Kategorien dynamisch — neue Kategorie-Datei wird automatisch erfasst.

...
- **195 URLs** in der Sitemap: 170 Rechner + 9 Kategorien + 6 Long-Tail-Brutto-Netto-Varianten (`/finanzen/2000-euro-brutto-netto` bis `/5000-euro-brutto-netto`) + 2 Sonderseiten (`brutto-netto-tabelle`, `mindestlohn-netto`) + Root + `/aktualisierungen` + 6 Meta-Pages (über uns, qualität, feedback, barrierefreiheit, impressum, datenschutz). Bewusst draußen: `/ki-rechner` (noindex W15A.4), `/admin/affiliate-stats` (intern).

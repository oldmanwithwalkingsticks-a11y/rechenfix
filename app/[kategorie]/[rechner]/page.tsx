        ...
        <div className="flex-1 min-w-0">
          ...
          {config.slug === 'brutto-netto-rechner' && (
            <section className="card p-6 md:p-8 mb-8 no-print">
              <h2 className="text-xl md:text-2xl font-bold text-primary-600 dark:text-primary-300 mb-4">Beliebte Gehaltsbeispiele</h2>
          ...
          <>
            ...
            {/* FAQ */}
            <section className="card p-6 md:p-8 mb-8 no-print">
              <h2 className="text-xl md:text-2xl font-bold text-primary-600 dark:text-primary-300 mb-4">Häufige Fragen</h2>
          ...
          */}
          {config.slug !== 'wissenschaftlicher-taschenrechner' && (
            <section className="card p-6 md:p-8 mb-8 no-print">
              <h2 className="text-xl md:text-2xl font-bold text-primary-600 dark:text-primary-300 mb-4">Das könnte Sie auch interessieren</h2>

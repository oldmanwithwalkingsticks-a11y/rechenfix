...
function berechneNetto(sk: 1 | 2 | 3 | 4 | 5 | 6) {
...
const faq = [
  {
    ...
    antwort: `Bei 3.000 € brutto bleiben in Steuerklasse 1 nach Abzug aller Steuern und Sozialabgaben ca. ${fmt(berechneNetto(1).nettoMonat)} € netto übrig. Das entspricht einer Abzugsquote von rund ${berechneNetto(1).abzuegeProzent}%.`,
  },
  {
    frage: 'Welche Abzüge habe ich bei 3.000 Euro brutto?',
    antwort: 'Von 3.000 € brutto werden Lohnsteuer, Solidaritätszuschlag (falls zutreffend), sowie Sozialabgaben (Kranken-, Renten-, Arbeitslosen- und Pflegeversicherung) abgezogen. Die genaue Höhe hängt von Steuerklasse und weiteren Faktoren ab.',
  },
  {
    frage: 'Wie viel netto bei 3.000 Euro brutto in Steuerklasse 3?',
    antwort: `In Steuerklasse 3 behalten Sie bei 3.000 € brutto ca. ${fmt(berechneNetto(3).nettoMonat)} € netto. Das ist deutlich mehr als in Steuerklasse 1, da der Ehepartner in SK5 den höheren Steuerabzug trägt.`,
  },
  {
    frage: 'Ist 3.000 Euro brutto ein gutes Gehalt?',
    antwort: '3.000 € brutto liegt etwas unter dem deutschen Durchschnittsgehalt von ca. 4.100 € brutto (2025). In Ostdeutschland und in vielen Ausbildungsberufen ist es jedoch ein übliches Einstiegsgehalt.',
  },
];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: '3.000 Euro brutto wie viel netto 2026? | Rechenfix',
    description: '3.000€ brutto in netto umrechnen ✓ Alle Steuerklassen ✓ Mit Abzügen ✓ Aktuell für 2026.',
    url: 'https://rechenfix.de/finanzen/3000-euro-brutto-netto',
    siteName: 'Rechenfix.de',
    type: 'website',
    locale: 'de_DE',
  },
  alternates: {
    canonical: 'https://rechenfix.de/finanzen/3000-euro-brutto-netto',
  },
};

export default function BruttoNetto3000() {
  ...
  const breadcrumbItems = [
    ...
    { name: '3.000 € brutto netto', url: '/finanzen/3000-euro-brutto-netto' },
  ];
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="card p-6 md:p-8 mb-8">
            ...
            <div className="result-box mt-6">
              <p className="text-white/80 text-sm mb-1">3.000 € brutto in Steuerklasse 1</p>
            ...
            <div className="mt-6 text-center">
              <Link
                href="/finanzen/brutto-netto-rechner"
          ...
          <section className="card p-6 md:p-8 mb-8">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed space-y-4">
              ...
              <p>
                In <strong className="text-gray-800 dark:text-gray-100">Steuerklasse 1</strong> (Ledige) behalten Sie von 3.000 € brutto ca. {fmt(ergebnisse[0].ergebnis.nettoMonat)} € netto. Das entspricht rund {(100 - ergebnisse[0].ergebnis.abzuegeProzent).toFixed(0)}% Ihres Bruttogehalts. Die Abzüge setzen sich aus Lohnsteuer ({fmt(ergebnisse[0].ergebnis.lohnsteuer)} €), Krankenversicherung ({fmt(ergebnisse[0].ergebnis.krankenversicherung)} €), Rentenversicherung ({fmt(ergebnisse[0].ergebnis.rentenversicherung)} €), Arbeitslosenversicherung ({fmt(ergebnisse[0].ergebnis.arbeitslosenversicherung)} €) und Pflegeversicherung ({fmt(ergebnisse[0].ergebnis.pflegeversicherung)} €) zusammen.
              </p>
              <p>
                Deutlich günstiger fahren <strong className="text-gray-800 dark:text-gray-100">Verheiratete in Steuerklasse 3</strong>: Hier bleiben ca. {fmt(ergebnisse[2].ergebnis.nettoMonat)} € netto — das sind {fmt(ergebnisse[2].ergebnis.nettoMonat - ergebnisse[0].ergebnis.nettoMonat)} € mehr pro Monat als in Steuerklasse 1. Der Grund: In SK3 werden die Freibeträge beider Partner beim Hauptverdiener berücksichtigt, was die Lohnsteuer erheblich senkt.
              </p>
              <p>
                Am wenigsten Netto bleibt in <strong className="text-gray-800 dark:text-gray-100">Steuerklasse 5 und 6</strong>. Steuerklasse 5 ist das Gegenstück zu SK3 für den geringverdienenden Partner, während SK6 für Zweit- und Nebenjobs gilt — hier entfallen alle Freibeträge, weshalb die Abzüge besonders hoch ausfallen.
              </p>
              <p>
                <strong className="text-gray-800 dark:text-gray-100">Wichtig zu wissen:</strong> Die Steuerklasse beeinflusst nur die monatlichen Abzüge, nicht die tatsächliche Jahressteuer. Über die Steuererklärung gleicht das Finanzamt die Differenz aus. Paare mit der Kombination 3/5 sind zur Abgabe einer Steuererklärung verpflichtet.
              </p>
              <p>
                Zusätzliche Faktoren wie Kirchensteuer (8-9% der Lohnsteuer), Kinderfreibeträge oder private Krankenversicherung verändern das Nettogehalt. Nutzen Sie unseren <Link href="/finanzen/brutto-netto-rechner" className="text-primary-500 hover:text-primary-600 font-medium">Brutto-Netto-Rechner</Link> für eine individuelle Berechnung mit allen Parametern.
              </p>
            </div>
          </section>

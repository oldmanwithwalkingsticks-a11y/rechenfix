...
| 22.08.2026 | `/impressum` | Abschnitt „Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV" ergänzt (Karsten Kautz, Dülkener Straße 35, 47804 Krefeld), eingefügt zwischen Umsatzsteuer-ID und Verbraucherstreitbeilegung im Aufbau der Nachbarabschnitte. Sichtbares Stand-Datum von „16. August 2026" auf „22. August 2026" gehoben. Kein anderer Abschnitt berührt. Grund: Der Blog kann journalistisch-redaktionell gestaltete Inhalte enthalten; Entscheidung des Betreibers vom 21.08.2026, die Angabe aufzunehmen, statt die Abgrenzung offenzuhalten. | A | § 18 Abs. 2 MStV; keine Behördenauskunft, keine Abmahnung zugrunde liegend | `08c45af` |
| 22.08.2026 | `/datenschutz` | **Welle R8.** Abschnitt 9: Anfragenzähler zutreffend beschrieben — Schlüssel ist ein mit geheimem Schlüssel gebildeter Prüfwert über die IP-Adresse, nicht „je Gerät"; der zweite Zähler der KI-Erklärungen (Minutenfenster, Prozessspeicher) ergänzt; ausdrücklich festgehalten, dass auf dem Endgerät nichts gespeichert oder ausgelesen wird; Folge der IP-Schlüsselung benannt (geteiltes Kontingent, Neubeginn bei IP-Wechsel); Rechtsgrundlage Art. 6 Abs. 1 lit. f DSGVO ergänzt. Abschnitt 2: Zweck „Begrenzung missbräuchlicher Nutzung" in die Übersicht aufgenommen. Abschnitt 8a: Querverweis auf Abschnitt 9 gesetzt. Stand-Datum auf 22. August 2026. | B | Codestand `/api/ki-rechner` und `/api/explain`, verifiziert 22.08.2026 (Salz seit `3d2ca22`); Art. 5 Abs. 1 lit. a, Art. 12 Abs. 1, Art. 13 Abs. 1 lit. c und Abs. 2 lit. a, Art. 6 Abs. 1 lit. f DSGVO | `62b7e77`, `1af3f4d`, `3c6ad22`, `e719fb5` |
| 28.08.2026 | `/impressum` | Abschnitt „Verbraucherstreitbeilegung / Universalschlichtungsstelle" ersatzlos entfernt. Er erklärte die Teilnahme an einem Streitbeilegungsverfahren vor der Universalschlichtungsstelle des Zentrums für Schlichtung e.V., Straßburger Straße 8, 77694 Kehl am Rhein, samt Link auf verbraucher-schlichter.de. Kein Ersatztext; der folgende Abschnitt „Hinweis zu Affiliate-Links" rückt auf und bleibt unverändert. Sichtbares Stand-Datum von „22. August 2026" auf „28. August 2026". Kein anderer Abschnitt und keine andere Datei berührt. **Anmerkung zur Begründung:** Der Commit-Betreff nennt als Grund, § 36 Abs. 1 Nr. 1 VSBG greife mangels Verbraucherverträgen nicht. Der Wortlaut trägt das nicht — Absatz 1 knüpft an „ein Unternehmer, der eine Webseite unterhält oder Allgemeine Geschäftsbedingungen verwendet", nicht an den Abschluss von Verbraucherverträgen. Tragend ist stattdessen **§ 36 Abs. 3 VSBG**: Von der Pflicht nach Absatz 1 Nummer 1 ausgenommen ist, wer am 31. Dezember des Vorjahres zehn oder weniger Personen beschäftigt hat. Absatz 1 Nummer 2 greift nach der Entfernung ohnehin nicht mehr, weil weder eine Selbstverpflichtung noch eine gesetzliche Teilnahmepflicht besteht. Das Ergebnis ist in beiden Lesarten dasselbe; festgehalten wird die Abweichung, damit sie beim Quartalslauf nicht als geprüfte Begründung weitergelesen wird. | B | § 36 VSBG im Wortlaut, abgerufen 28.08.2026, `https://www.gesetze-im-internet.de/vsbg/__36.html` (HTTP 200); Beschäftigtenzahl nach Betreiberangabe; Entscheidung des Betreibers vom 28.08.2026 | `f0ca18d` |
| 04.09.2026 | `/datenschutz` | **Welle 133.** Abschnitt 11: Postfachanbieter **Hostinger International Ltd.** (61 Lordou Vironos str., 6023 Larnaca, Zypern) ergänzt, mit EU-Speicherung der Nachrichten, dem Unterauftragnehmer **Proofpoint, Inc.** (USA) — technische Begleitdaten regelmäßig, voller Nachrichteninhalt einschließlich Anhängen erst bei ausdrücklicher Verdachtsmeldung — und dem Verweis auf Anhang 3 des Auftragsverarbeitungsvertrags; dazu eine eigene Drittland-Hinweisbox (Art. 45 DSGVO über das EU-US Data Privacy Framework, im Übrigen Standardvertragsklauseln nach Art. 46 Abs. 2 lit. c DSGVO). Abschnitt 5: Standardvertragsklauseln als Rückfallweg neben dem Angemessenheitsbeschluss ergänzt — sie sind über Schedule 3 des Vercel-DPA vertraglich bereits Bestandteil, standen aber nicht im Text. Stand-Datum auf 4. September 2026. Abschnitt 9 (KI-Funktionen) und der Resend-Absatz unberührt. **Anlass war eine Lücke, kein Fehler im Bestehenden:** Die Erklärung nannte bisher keinen Postfachanbieter — `grep -ri "hostinger"` über das Repo lieferte genau einen Treffer, und der lag in `lib/termine.ts`. Wer an `info@rechenfix.de` schrieb, dessen Nachricht lag damit bei einem Auftragsverarbeiter, der in der Erklärung nicht vorkam (Art. 13 Abs. 1 lit. e, wegen des US-Unterauftragnehmers auch lit. f). | B | Support-Auskunft Hostinger vom 04.09.2026; Hostinger-DPA Fassung 18.08.2026, Abschnitte 1, 6.3, 9.1 und Anhang 3, `https://www.hostinger.com/legal/dpa`; Vercel-DPA Fassung 17.03.2026, wirksam 31.03.2026, Schedule 3, `https://vercel.com/legal/dpa` | `79df0e4`, `97d490c`, `d6002b0` |
| 06.09.2026 | `/impressum` | Wirtschafts-Identifikationsnummer **DE293513316-00001** nach § 139 c AO ergänzt, unmittelbar nach der Umsatzsteuer-Identifikationsnummer im selben Abschnitt; Formulierung und Auszeichnung nach der Form der Nachbarzeile (Gesetz ausgeschrieben, Leerzeichen vor dem Buchstabenzusatz). Sichtbares Stand-Datum von „28. August 2026" auf „6. September 2026". Kein anderer Abschnitt und keine andere Rechtsseite berührt; strukturierte Daten unangetastet (`vatID`/`taxID` kommen im Repo nicht vor). **Die Angabe ist freiwillig:** § 5 Abs. 1 Nr. 6 DDG verlangt die USt-IdNr. **oder** die W-IdNr., und die USt-IdNr. stand bereits im Impressum. Die Ergänzung erfolgt auf ausdrückliche Entscheidung des Betreibers vom 06.09.2026, **nicht zur Erfüllung einer Pflicht** — wer hier später eine Pflicht hineinliest, liest falsch. **Zur Vorgeschichte:** Der Punkt lief seit dem 03.09.2026 als offener Posten „wartet auf Bestätigung", weil ein Zuteilungsschreiben erwartet wurde. Ein solches ergeht konstruktionsbedingt nicht: Wurde die USt-IdNr. vor Einführung der W-IdNr. vergeben, erfolgt die Zuteilung durch öffentliche Bekanntmachung des BMF, wonach die USt-IdNr. zugleich als W-IdNr. zu verwenden ist — ergänzt um ein fünfstelliges Unterscheidungsmerkmal. Die am 03.09.2026 in Susannes Referenzdatei als *Erwartung* geführte Ableitung hat sich damit bestätigt; sie war zu Recht nicht ins Impressum übernommen worden, solange sie unbelegt war. | A | § 139c AO; § 5 Abs. 1 Nr. 6 DDG; Darstellungen des Bundeszentralamts für Steuern und des Bayerischen Landesamts für Steuern, gelesen 06.09.2026; Wert vom Betreiber am 06.09.2026 bestätigt | `92c46bf` |
| 10.09.2026 | `/datenschutz` | Firmierung des Versanddienstleisters in Abschnitt 11 berichtigt: **Plus Five Five, Inc.** (2261 Market Street #5039, San Francisco, CA 94114, USA) statt der bisher genannten „Resend, Inc.". Zwei Fundstellen — die Nennung im Absatz zum Formularversand und der Drittland-Hinweis. Der **Dienstname „Resend" bleibt stehen**, damit wiedererkennbar bleibt, was der Nutzer im eigenen Postfach sieht; die Anschrift folgt der Form der Nachbarangaben (Gesellschaft, Anschrift in Klammern — wie Vercel Inc., Awin AG, Hostinger International Ltd.). Sichtbares Stand-Datum von „4. September 2026" auf „10. September 2026". Kein anderer Abschnitt, keine andere Rechtsseite, kein Programmcode berührt — Paketname, Importe und `RESEND_API_KEY` bleiben, der Dienst heißt tatsächlich so; falsch war allein die **Gesellschaft**. **Die Übermittlungsgrundlage ist bewusst unverändert geblieben:** weiterhin Standardvertragsklauseln nach Art. 46 Abs. 2 lit. c DSGVO. Ob vorrangig der Angemessenheitsbeschluss zum EU-US Data Privacy Framework greift, ist **offen** — der Teilnehmereintrag Nr. 8907 existiert, sein aktueller Status war am 09.09.2026 nicht lesbar, weil die DPF-Liste als JavaScript-Anwendung ausgeliefert wird. Solange das ungeklärt ist, wird an der Grundlage nichts geschrieben; bestätigt sich die Zertifizierung später, ist das für Vercel bereits vorhandene Muster zu übernehmen (Art. 45 als Grundlage, Standardvertragsklauseln zusätzlich als Rückfallweg). **Kein Eintrag unter `/aktualisierungen`:** Diese Seite führt ausschließlich Nutzer-Feedback zu Rechnern aus `lib/feedback-log.ts`, keine Rechtstextänderungen. **Nicht angefasst:** die Anschrift von Anthropic PBC — die Seite nennt 500 Howard Street, das Verarbeitungsverzeichnis 548 Market St, PMB 90375; welche zutrifft, ist ungeklärt und wird gesondert verfolgt. | A | Nutzungsbedingungen und Data Processing Addendum von Resend (dort zeichnet Plus Five Five, Inc. als Datenimporteurin) sowie Teilnehmereintrag Nr. 8907 der Data-Privacy-Framework-Liste, lautend auf PLUS FIVE FIVE — alle drei gelesen 09.09.2026; Art. 13 Abs. 1 lit. e DSGVO | `725737b` |
| 11.09.2026 | `/datenschutz` | Abschnitt 11: Resend-Hinweisbox auf **Art. 45 DSGVO über das EU-US Data Privacy Framework** umgestellt, Standardvertragsklauseln nach Art. 46 Abs. 2 lit. c zusätzlich als Rückfallweg — nach dem Vercel-Muster aus Abschnitt 5, gleicher Aufbau, gleicher Link auf dataprivacyframework.gov. **Damit ist die im Eintrag vom 10.09.2026 offen gelassene Frage beantwortet:** Der DPF-Status des Teilnehmereintrags Nr. 8907 war dort nicht lesbar und ist es am 11.09.2026 gewesen. Der Satz „Es gelten dieselben Einschränkungen wie im Abschnitt zu den KI-Funktionen beschrieben." ist **entfallen** — er verweist auf die Einschränkungen einer Übermittlung allein auf Standardvertragsklauseln und passt zu einer DPF-gestützten Übermittlung nicht; die Vercel-Box trägt ihn aus demselben Grund nicht. Abschnitt 8a: Standortangabe zu Upstash von „Frankfurt/Irland" auf **„Frankfurt am Main"** berichtigt, weil keine Lesekopie in Irland besteht. **Über die Vorlage hinaus ist dieselbe Berichtigung in Abschnitt 8** (Affiliate-Klickdaten) vorgenommen worden: [lib/redis.ts](../../lib/redis.ts) führt genau einen Redis-Client, beide Sätze beschreiben also dieselbe Datenbank — eine als falsch erkannte Aussage an der zweiten Stelle stehen zu lassen, wäre nicht vertretbar gewesen. Sichtbares Stand-Datum von „10. September 2026" auf „11. September 2026". **Ausdrücklich unberührt: Abschnitt 9 und die Anthropic-Anschrift.** Welche Gesellschaft dort Vertragspartnerin ist, ist offen — Commercial Terms und Quittungen nennen verschiedene; Anfrage an privacy@anthropic.com vom 11.09.2026, Wiedervorlage 25.09.2026 als `anthropic-vertragspartnerin` in [lib/termine.ts](../../lib/termine.ts). | A | DPF-Teilnehmereintrag Nr. 8907 (PLUS FIVE FIVE, 2261 Market Street #5039, San Francisco, CA 94114), gelesen 11.09.2026: EU-U.S. DPF „Active – Re-certification under Review", UK Extension ebenso, Erstzertifizierung 20.02.2025, nächste Fälligkeit 03.03.2027, abgedeckt Non-HR-Daten; Vercel-Konsole, Store `rechenfix-stats`, Upstash-ID `e5991d1a-e12a-49f7-bb13-4888b1d786c6`, Primary Region `fra1`, Read Regions leer, gelesen 11.09.2026; Art. 13 Abs. 1 lit. e und f DSGVO | `4c09844` |
| 11.09.2026 | `/datenschutz` | **Abschnitt 9: Empfänger und Übermittlungskette berichtigt.** Dienstleister ist die **Anthropic Ireland, Limited** (6th Floor, South Bank House, Barrow Street, Dublin 4, D04 TR29, Irland) statt der bisher genannten Anthropic PBC, 500 Howard Street — nach den Commercial Terms ist „Anthropic" für Kunden mit Sitz im EWR die irische Gesellschaft, und sie ist damit die Auftragsverarbeiterin. Die Hinweisbox behält die Überschrift „Datenübermittlung in die USA", beschreibt die Übermittlung aber nicht mehr als unmittelbare Übermittlung an die US-Gesellschaft, sondern als **Zugriff verbundener Unternehmen, darunter die Anthropic, PBC** — weiterhin auf Grundlage der Standardvertragsklauseln nach Art. 46 Abs. 2 lit. c DSGVO. **Der Hinweis auf das Restrisiko bleibt wörtlich:** Die Anthropic, PBC ist nicht im Data Privacy Framework zertifiziert, ein Behördenzugriff bleibt also nicht in jedem Fall auszuschließen. **Damit ist die im Eintrag vom 10.09.2026 offen gelassene Anschriftenfrage erledigt** — dort standen 500 Howard Street (Seite) gegen 548 Market St (Verarbeitungsverzeichnis). Beide betrafen die **falsche Gesellschaft**, weshalb keine von beiden zu übernehmen war. Der Einmaltermin `anthropic-vertragspartnerin` ist als erledigt aus [lib/termine.ts](../../lib/termine.ts) entfernt (19 → 18 Kennungen); erledigte Einmaltermine blieben sonst dauerhaft als überfällig stehen. Stand-Datum unverändert 11. September 2026, am selben Tag bereits gesetzt. **Ausdrücklich unberührt: [/ki-transparenz](../../app/ki-transparenz/page.tsx)** mit „Claude (Anthropic PBC, USA)" — die Seite benennt nach der KI-Verordnung das eingesetzte KI-System und dessen **Anbieter**, nicht den Empfänger personenbezogener Daten; Anbieter des Modells ist die Anthropic, PBC, die Angabe bleibt richtig. | B | Commercial Terms of Service, in Kraft seit 17.06.2025, Begriffsbestimmung „Anthropic"; Data Processing Addendum, in Kraft seit 24.02.2025, Schedule 1 Teil A.2 (Standardvertragsklauseln Modul 2 und Modul 3); schriftliche Antwort von Anthropic vom 11.09.2026, 01:09 Uhr MESZ, von support@mail.anthropic.com — nach Tempo (79 Sekunden nach Versand) und Quellenangabe eine **automatisierte Support-Antwort**, deshalb als Bestätigung geführt, nicht als alleinige Grundlage; unbeantwortet blieb dort, warum die Quittungen von der Anthropic, PBC kommen. **Die Unterauftragnehmer-Seite `anthropic.com/subprocessors` war am 11.09.2026 nicht auswertbar** (HTTP 200, 5.980 B, Titel „Anthropic Trust Center", 22 Zeichen sichtbarer Text — reine JavaScript-Anwendung; weder „Affiliate" noch „Anthropic, PBC" noch „Anthropic Ireland" im ausgelieferten Quelltext). Art. 13 Abs. 1 lit. e und f DSGVO | `7eb2855` |
| 22.09.2026 | `/datenschutz` | **Welle 142.** Abschnitt Affiliate-Links: Die Liste nach „Wir arbeiten derzeit mit folgenden Partnerprogrammen (über das Awin-Netzwerk)“ nennt jetzt **vierzehn** Programme statt sieben — ergänzt burda-vergleicht, CosmosDirekt, GymBeam, HanseMerkur, hotel.de, Nature's Way und smava; alphabetisch nach angezeigtem Namen. Jeder Eintrag trägt `data-programm` mit dem Schlüssel aus `AFFILIATE_PROGRAMS`. Sichtbares Stand-Datum von „18. September 2026“ auf „22. September 2026“. Kein anderer Satz des Abschnitts berührt, insbesondere nicht die Nennung der Awin AG als Vermittlerin. **Berichtigt wird eine unzutreffende Tatsachenangabe**, nicht eine fehlende Pflichtangabe — ob die Aufzählung Pflicht ist, wird hier nicht behauptet. **Warum sie so lange falsch stand:** Die Dienste-Wache führt Awin als einen Dienst; die Zahl der Programme dahinter ist für sie unsichtbar. Seit dieser Welle hält der Prebuild-Guard `scripts/check-affiliate-partnerliste.mjs` Liste und Code deckungsgleich — ein neues Programm bricht den Build, bis diese Liste nachgezogen ist. | A | Codestand `components/AffiliateBox.tsx` an `f3a27a2`, 14 Schlüssel in `AFFILIATE_PROGRAMS`, gemessen 22.09.2026; Guard-Lauf nach der Änderung Exit 0, Gegenprobe ohne GymBeam Exit 1 | `11f7faa` |
...
| 16.08.2026 | alle | ~~Browserprüfung auf JavaScript-gesetzte Cookies und Verbindungen nach Interaktion steht aus. Statische Analyse sieht das nicht.~~ — **erledigt am 21.08.2026.** Ohne Interaktion bleiben Cookies, Local und Session Storage leer; erst die Nutzerhandlung legt die Darstellungseinstellung im Local Storage ab. Deckt sich mit Abschnitt 7.1 der Datenschutzerklärung, keine Textfolge. Ergebnis im Wortlaut in Susannes Registry unter `browserpruefung`. | — |
...
|---|---|---|---|
| 16.08.2026 | `/impressum`, `/barrierefreiheit` | Karsten, Inkognito-Browser | **erledigt — geprüft am 17.08.2026** — Datum sichtbar? Dark Mode lesbar? Position wie `/datenschutz`? |
| 17.08.2026 | Stand-Daten nach R1 | Karsten | **bestanden** — Stand-Datum auf `/impressum` sichtbar, im Dark Mode lesbar, Position wie auf `/datenschutz`. |
...
| 16.08.2026 | Theme-Speicherung nach R4 | Karsten, Inkognito + Application-Tab | **erledigt — siehe Eintrag vom 17.08.2026** — (1) Startseite laden, nichts anklicken → Local Storage leer? (2) System auf dunkel, laden → dunkle Darstellung, weiterhin kein Eintrag? (3) Umschalter betätigen → Eintrag erscheint? (4) Neu laden → gewählte Darstellung bleibt, kein Umspringen? |
...
| 17.08.2026 | Freiwilligkeit und § 25 nach R5 | Karsten, Browser | **erledigt — siehe Einträge vom 17.08.2026** — Barrierefreiheitsseite: Einleitung sichtbar, Stand weiterhin Mai 2026? Datenschutzerklärung: 7a und 7b mit derselben Rechtsgrundlage und demselben Aufbau? |
...
| 17.08.2026 | Theme-Speicherung nach R4 | Karsten, Inkognito + Application-Tab | **bestanden** — nach dem ersten Aufruf ohne Nutzeraktion bleibt der Local storage leer; `rechenfix-theme` entsteht erst durch Betätigen des Umschalters. |
| 17.08.2026 | `/datenschutz` 7a und 7b nach R5 | Karsten | **bestanden** — beide Abschnitte tragen dieselbe Rechtsgrundlage und denselben Aufbau. |
| 17.08.2026 | Ereigniserfassung nach R7 | Karsten, Browser | **erledigt — geprüft am 17.08.2026** — Datenschutzerklärung Abschnitt 8a: vier Ereignisarten aufgeführt (Zähler, Klicks, Feedback, PDF), Freitext-Satz verweist auf Abschnitt 11, Zusage beginnt mit „Für diese Nutzungsstatistik gilt"? Abschnitt 11 nennt den User-Agent? |
| 17.08.2026 | `/datenschutz` 8, 8a und 11 nach R7 | Karsten | **bestanden** — die drei Abschnitte sind untereinander stimmig, die Verweise stimmen, kein Vorgang wird doppelt mit abweichenden Angaben beschrieben. |
...
- **vierteljährlich ab 01.12.2026** — Angemessenheitsbeschluss zum EU-US Data Privacy Framework
  prüfen. Fällt er, sind die Abschnitte 5, 6 und 11 der Datenschutzerklärung noch am selben Tag
  auf Art. 46 Abs. 2 lit. c DSGVO umzustellen; die Standardvertragsklauseln liegen bei Vercel und
  Hostinger vertraglich bereits vor. Geführt wird der Termin als `dpf-angemessenheit` in
  [lib/termine.ts](../../lib/termine.ts) — **hier nicht zweitpflegen**, sonst nennen zwei Kanäle
  verschiedene Daten.
- **halbjährlich ab 04.03.2027** — Anhang 3 des Hostinger-Auftragsverarbeitungsvertrags gegen den
  geführten Stand vom 04.09.2026 abgleichen (AWS EMEA, Google Cloud EMEA, Cloudflare, MailChannels,
  Proofpoint, Anthropic Ireland, spectra tech). Nach Abschnitt 6.3 des Vertrags werden neue
  Unterauftragnehmer dort ergänzt, mit zehn Tagen Widerspruchsfrist; Zugänge außerhalb der EU
  berühren Abschnitt 11. Geführt als `hostinger-unterauftragnehmer` in
  [lib/termine.ts](../../lib/termine.ts) — ebenfalls nicht zweitpflegen.
...
| 18.09.2026 | rechenfix.de | /datenschutz | Abschnitt E-Mail-Kontakt: Hostingers Unterauftragnehmer für den E-Mail-Betrieb waren unvollständig genannt — der Text führte allein die Proofpoint, Inc. (USA). Auf Nachfrage des Betreibers hat Hostingers Compliance-Team am 18.09.2026 schriftlich **drei** benannt: Proofpoint, Inc. (USA, Spam- und Schadsoftwareschutz), **Cloudflare, Inc.** (USA, vorgelagerte Schicht zwischen Nutzern und Hostingers Servern) und **MailChannels Corporation** (Kanada, Zustellung ausgehender Nachrichten samt Spam-Prüfung). Die beiden letzten fehlten vollständig. Das ist eine Lücke nach Art. 13 Abs. 1 lit. e DSGVO, und sie bestand hier ebenso wie auf wuerdezeit.de — der Absatz ist zwischen beiden Seiten wörtlich gleich, weshalb derselbe Fehler an zwei Stellen stand und an zwei Stellen berichtigt wurde. Jetzt alle drei mit ihrer jeweiligen Rolle als Liste, mit dem Datum der Auskunft im sichtbaren Text — eine Nennung ohne Stand altert unbemerkt. Der Drittland-Absatz ist entsprechend aufgeteilt: EU-US Data Privacy Framework für die beiden US-Gesellschaften, eigener Angemessenheitsbeschluss für Kanada (Entscheidung 2002/2/EG, beschränkt auf privatwirtschaftliche Organisationen unter PIPEDA), Standardvertragsklauseln nur noch für das, was darüber hinausgeht. Bewusst NICHT behauptet wird, dass die einzelnen Gesellschaften auf der DPF-Liste stehen: Cloudflare erklärt seine Zertifizierung selbst (trust-hub/gdpr, gelesen 18.09.2026), bei Proofpoint war das auf der Vertrauensseite nicht auffindbar, und die DPF-Liste selbst ist eine JavaScript-Anwendung, die sich aus dieser Umgebung nicht abrufen lässt. Der Text nennt deshalb die Grundlage der Übermittlung, nicht den Zertifizierungsstatus einzelner Firmen. | A | Schriftliche Auskunft Hostinger Compliance Team vom 18.09.2026, vom Betreiber vorgelegt; cloudflare.com/trust-hub/gdpr (gelesen 18.09.2026); Art. 13 Abs. 1 lit. e, Art. 45, Art. 46 Abs. 2 lit. c DSGVO; Entscheidung 2002/2/EG | siehe Commit dieses Laufs |

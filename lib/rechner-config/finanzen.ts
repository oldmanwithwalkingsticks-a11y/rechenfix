...
Wenn Sie als Unternehmer Waren oder Dienstleistungen einkaufen, zahlen Sie auf diese Einkäufe MwSt — die sogenannte Vorsteuer. Diese können Sie in Ihrer Umsatzsteuervoranmeldung geltend machen und vom Finanzamt zurückfordern. Voraussetzung ist eine ordnungsgemäße Rechnung mit gesondertem Ausweis der MwSt. Der Vorsteuerabzug ist einer der wichtigsten steuerlichen Vorteile für Selbstständige.`,
    // W19-Goldstandard: mwst-rechner auf volle Tiefe (~1.300 W, 10 Bausteine), Leitformat
    // „Tabellen-Nachschlagewerk". Alle Sätze/§§ gegen Primärquelle geprüft (Stand 06/2026):
    // gesetze-im-internet.de § 12/§ 13b/§ 14/§ 19 UStG; Gastronomie-Reform StÄndG 2025
    // (BGBl. I Nr. 363, § 12 Abs. 2 Nr. 15 UStG, ab 01.01.2026 Speisen 7 % / Getränke 19 %,
    // Hotel-Frühstück Speisen 7 % — ZDH/Bundesregierung). erklaerung bleibt Fallback.
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Mehrwertsteuer — die wichtigste Verbrauchsteuer',
        html: `<p>Die Mehrwertsteuer (MwSt) — im Gesetz als Umsatzsteuer (USt) bezeichnet — ist die wichtigste indirekte Steuer in Deutschland und nach der Lohnsteuer die zweitgrößte Einnahmequelle des Staates. Indirekt heißt: Getragen wird sie vom Endverbraucher, abgeführt aber vom Unternehmen. Jeder Betrieb schlägt die Steuer auf seine Netto-Preise auf, zieht sie beim Kunden ein und leitet sie ans Finanzamt weiter. Das Unternehmen ist damit nur Steuereinsammler, nicht Steuerträger.</p><p>Geregelt ist die Steuer im Umsatzsteuergesetz (UStG). Es kennt im Wesentlichen drei Sätze: den Regelsatz von 19 % (§ 12 Abs. 1 UStG) für die meisten Waren und Dienstleistungen, den ermäßigten Satz von 7 % (§ 12 Abs. 2 UStG) für Güter des Grundbedarfs und seit 2023 einen Nullsteuersatz von 0 % für die Lieferung und Installation von Photovoltaikanlagen auf Wohngebäuden (§ 12 Abs. 3 UStG). Für Selbstständige, Händler und die Buchhaltung ist das exakte Umrechnen zwischen Netto und Brutto deshalb Alltag — und eine häufige Fehlerquelle, weil die Logik oft falsch verstanden wird.</p><p>Wirtschaftlich ist die Umsatzsteuer ein Schwergewicht: Sie bringt dem Staat jährlich weit über 250 Milliarden Euro und finanziert damit einen großen Teil des öffentlichen Haushalts. Eingeführt wurde das heutige System der Mehrwertsteuer mit Vorsteuerabzug 1968 — davor wurde die Steuer auf jeder Handelsstufe kumulativ erhoben, was Waren mit langer Lieferkette künstlich verteuerte. Das Mehrwertsteuerprinzip belastet dagegen nur den auf jeder Stufe neu geschaffenen Mehrwert, weshalb am Ende exakt der Verbraucherpreis besteuert wird — unabhängig davon, wie viele Zwischenhändler beteiligt waren.</p>`,
      },
      {
        typ: 'text',
        titel: 'So rechnen Sie richtig — und der häufigste Denkfehler',
        html: `<p>Die wichtigste Regel zuerst: Der Bruttobetrag entspricht <strong>119 %</strong> (bei 19 %) bzw. <strong>107 %</strong> (bei 7 %) des Nettobetrags — nicht 100 %. Wer von einem Bruttopreis die Mehrwertsteuer herausrechnen will, darf deshalb <strong>nicht</strong> einfach den Prozentsatz vom Brutto abziehen.</p><p>Der korrekte Weg führt über die Division: Netto = Brutto ÷ 1,19 (bzw. ÷ 1,07). Erst die Differenz aus Brutto und Netto ergibt den Steuerbetrag. Umgekehrt gilt für den Aufschlag: Brutto = Netto × 1,19. Der Denkfehler „19 % vom Brutto abziehen" führt systematisch zu einem zu niedrigen Nettobetrag, weil sich die 19 % per Definition auf den Nettowert beziehen, nicht auf den ohnehin schon erhöhten Bruttowert. Bei kleinen Beträgen ist der Unterschied gering, bei vierstelligen Rechnungen geht er schnell in zweistellige Eurobeträge — und damit in eine falsche Umsatzsteuer-Voranmeldung.</p><p>Beim ermäßigten Satz gilt dieselbe Logik mit dem Faktor 1,07: Aus 21,40 € brutto werden 21,40 ÷ 1,07 = 20,00 € netto, die Steuer beträgt 1,40 €. Wer regelmäßig zwischen beiden Sätzen wechselt — etwa im Handel mit Lebensmitteln und Non-Food —, sollte die Divisoren 1,19 und 1,07 sicher parat haben. Praktisch ist auch der direkte Weg zum Steueranteil im Bruttopreis: Bei 19 % stecken 19 ÷ 119 = rund 15,97 % des Bruttobetrags als Steuer drin, bei 7 % sind es 7 ÷ 107 = rund 6,54 %.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Brutto in Netto und MwSt zerlegen',
        schritte: [
          { label: 'Bruttobetrag (inkl. 19 % MwSt)', formel: '119,00 €', ergebnis: '119,00 €' },
          { label: 'Netto = Brutto ÷ 1,19', formel: '119,00 € ÷ 1,19', ergebnis: '100,00 €' },
          { label: 'MwSt = Brutto − Netto', formel: '119,00 € − 100,00 €', ergebnis: '19,00 €' },
          { label: 'Gegenprobe: Netto × 1,19', formel: '100,00 € × 1,19', ergebnis: '119,00 €' },
        ],
        fazit: 'Der häufige Denkfehler: 19 % von 119 € = 22,61 € — das wäre falsch. Die 19 % beziehen sich auf die 100 € netto, nicht auf die 119 € brutto. Korrekt sind 19,00 € MwSt.',
      },
      {
        typ: 'tabelle',
        ...
        zeilen: [
          ...
          ['Bücher, Zeitungen, Zeitschriften', '7 %', '§ 12 Abs. 2 Nr. 1 + Nr. 14'],
          ['Restaurant: Speisen (vor Ort & to-go)', '7 %', '§ 12 Abs. 2 Nr. 15 (ab 2026)'],
          ['Restaurant: Getränke', '19 %', '§ 12 Abs. 1'],
          ['Hotel-Übernachtung', '7 %', '§ 12 Abs. 2 Nr. 11'],
          ...
          ['Handwerk, Elektronik, Kleidung', '19 %', '§ 12 Abs. 1'],
          ['Kaviar, Hummer, Langusten', '19 %', 'Anlage 2 (Ausnahme)'],
          ['Süßkartoffeln', '19 %', 'Anlage 2 (Ausnahme)'],
          ['Arzt, Wohnraummiete, Versicherung', 'befreit', '§ 4'],
        ],
        fussnote: 'Die vollständige Liste der 7-%-Güter steht in Anlage 2 zu § 12 Abs. 2 UStG. Stand 06/2026.',
      },
      {
        typ: 'text',
        titel: 'Gastronomie-Reform 2026: dauerhaft 7 % auf Speisen',
        html: `<p>Das <strong>Steueränderungsgesetz 2025</strong> (BGBl. I Nr. 363) hat zum <strong>1. Januar 2026</strong> die Besteuerung der Gastronomie dauerhaft neu geregelt: Restaurant- und Verpflegungsdienstleistungen unterliegen seither dem ermäßigten Satz von <strong>7 %</strong> (§ 12 Abs. 2 Nr. 15 UStG) — mit Ausnahme der Getränke, die weiter mit 19 % besteuert werden.</p><p>Bis Ende 2025 galt eine Ungleichbehandlung: Speisen zum Verzehr vor Ort wurden mit 19 % besteuert, dieselben Speisen zum Mitnehmen (To-Go) nur mit 7 %. Diese Unterscheidung entfällt. Seit 2026 gilt einheitlich: <strong>alle Speisen 7 %, alle Getränke 19 %</strong> — egal ob im Restaurant, am Imbiss, als Lieferung oder zum Mitnehmen. Profitieren von der Senkung nicht nur Restaurants und Cafés, sondern auch Bäckereien und Metzgereien mit Sitzgelegenheit, Caterer sowie die Kita-, Schul- und Krankenhausverpflegung. Beim Hotel-Frühstück sind die Speisen mit 7 %, die Getränke mit 19 % zu besteuern; für Pauschalpreise lässt das Bundesfinanzministerium eine Aufteilung von 30 % auf die Getränke zu.</p><p>Eine Feinheit gibt es bei den Getränken selbst: Milch und Milchmischgetränke mit einem Milchanteil von mindestens 75 % — etwa Latte Macchiato oder Trinkmilch — sowie Leitungswasser gelten als ermäßigt und werden mit 7 % besteuert, wenn sie außer Haus abgegeben werden. Klassische Getränke wie Limonade, Saft, Kaffee oder Alkohol bleiben dagegen bei 19 %. Für die Praxis bedeutet die Reform vor allem weniger Abgrenzungsstreit: Die jahrelange Frage, ob ein Brötchen „zum Hieressen" oder „zum Mitnehmen" verkauft wurde, ist für den Steuersatz auf Speisen nun bedeutungslos geworden.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Reverse-Charge nach § 13b: Wer schuldet die Umsatzsteuer?',
        ...
        zeilen: [
          ...
          ['Industrieschrott und Altmetall', 'Leistungsempfänger', '§ 13b Abs. 2 Nr. 7'],
          ['Lieferung von Anlagegold', 'Leistungsempfänger', '§ 13b Abs. 2 Nr. 9'],
        ...
        fussnote: 'Beim Reverse-Charge stellt der Leistende ohne USt-Ausweis aus; der Empfänger schuldet und meldet die Steuer selbst (§ 13b UStG).',
      },
      {
        typ: 'text',
        titel: 'Reverse-Charge in der Praxis',
        html: `<p>In der Praxis funktioniert das Verfahren so: Der leistende Unternehmer stellt eine <strong>Nettorechnung ohne Umsatzsteuer</strong> aus und ergänzt den Pflichthinweis „Steuerschuldnerschaft des Leistungsempfängers". Der Empfänger berechnet die Umsatzsteuer selbst, meldet sie in seiner Umsatzsteuer-Voranmeldung an — und zieht sie zugleich als Vorsteuer wieder ab, sofern er voll vorsteuerabzugsberechtigt ist. Das Ergebnis ist dann eine Nullsumme: Die Steuer wird angemeldet und im selben Atemzug erstattet, es fließt kein Geld.</p><p>Wichtig ist die korrekte Behandlung trotzdem, denn formale Fehler sind teuer. Weist der Leistende fälschlich Umsatzsteuer aus, obwohl Reverse-Charge greift, schuldet er diese Steuer nach § 14c UStG dennoch — der Empfänger darf sie aber <strong>nicht</strong> als Vorsteuer ziehen. Beide Seiten sollten daher vor der Rechnungsstellung prüfen, ob ein Reverse-Charge-Tatbestand vorliegt.</p><p>Für grenzüberschreitende Verkäufe an Privatkunden gibt es ein verwandtes Verfahren, den One-Stop-Shop (OSS): Wer Waren an Verbraucher in anderen EU-Ländern liefert und die EU-weite Lieferschwelle von 10.000 € im Jahr überschreitet, schuldet die Umsatzsteuer im Land des Kunden — kann sie aber gebündelt über das OSS-Portal des Bundeszentralamts für Steuern melden, statt sich in jedem einzelnen Land registrieren zu müssen.</p>`,
      },
      {
        typ: 'text',
        titel: 'Vorsteuerabzug & Umsatzsteuer-Voranmeldung',
        html: `<p>Der <strong>Vorsteuerabzug</strong> ist das Herzstück des Mehrwertsteuersystems und für Unternehmen der wichtigste Hebel. Die Umsatzsteuer, die ein Betrieb auf eigene Einkäufe zahlt — vom Bürostuhl bis zur Maschine —, heißt Vorsteuer. Diese verrechnet er mit der Umsatzsteuer, die er selbst von seinen Kunden eingenommen hat: Ist die eingenommene Steuer höher, führt er die Differenz ans Finanzamt ab; ist die gezahlte Vorsteuer höher, erstattet das Finanzamt den Überschuss. So zahlt das Unternehmen unterm Strich nur Steuer auf den selbst geschaffenen Mehrwert.</p><p>Abgewickelt wird das über die <strong>Umsatzsteuer-Voranmeldung</strong>, die elektronisch über ELSTER eingereicht wird — je nach Vorjahres-Zahllast monatlich oder vierteljährlich, in den ersten beiden Jahren nach einer Gründung grundsätzlich monatlich. Nach Jahresende folgt zusätzlich die Umsatzsteuer-Jahreserklärung, die alle Voranmeldungen zusammenfasst und ausgleicht.</p><p>Voraussetzung für jeden Vorsteuerabzug ist eine <strong>ordnungsgemäße Rechnung</strong> mit allen Pflichtangaben nach § 14 Abs. 4 UStG (siehe Tabelle unten). Fehlt auch nur eine Angabe, kann das Finanzamt den Abzug streichen — der Betrieb bleibt dann auf der gezahlten Vorsteuer sitzen. Deshalb lohnt es sich, eingehende Rechnungen vor der Verbuchung kurz auf Vollständigkeit zu prüfen.</p>`,
      },
      {
        typ: 'tabelle',
        ...
        zeilen: [
          ['Name + Anschrift', 'von leistendem Unternehmer UND Empfänger, jeweils vollständig'],
          ...
          ['Menge + Art der Leistung', 'handelsübliche Bezeichnung der Lieferung/Leistung'],
          ['Leistungszeitpunkt', 'Liefer- oder Leistungsdatum bzw. -zeitraum'],
          ['Entgelt (netto)', 'aufgeschlüsselt nach Steuersätzen'],
          ['Steuersatz + Steuerbetrag', 'oder Hinweis auf eine Steuerbefreiung'],
          ['Im Voraus vereinbarte Minderung', 'z. B. Skonto- oder Rabattvereinbarung'],
          ['Aufbewahrungshinweis', 'bei Leistungen an Privatpersonen rund um ein Grundstück'],
        ],
...
Wichtig zu beachten: In der Praxis mindern die Abgeltungssteuer (25% plus Solidaritätszuschlag) die tatsächlichen Erträge. Der Sparerpauschbetrag von 1.000 € (bzw. 2.000 € für Ehepaare) bleibt steuerfrei. Inflation verringert zudem die Kaufkraft des Endkapitals. Trotzdem bleibt der Zinseszins das mächtigste Werkzeug für den langfristigen Vermögensaufbau.`,
    ...
    contentBloecke: [
      ...
      },
      {
        ...
        html: `<p>Auf Kapitalerträge — Zinsen, Dividenden und Kursgewinne — erhebt der Staat die <strong>Abgeltungsteuer</strong>. Sie beträgt 25 % (§ 32d Abs. 1 EStG), dazu kommt der Solidaritätszuschlag von 5,5 % auf die Steuer, sodass effektiv <strong>26,375 %</strong> anfallen. Für Kirchenmitglieder erhöht die Kirchensteuer (8 oder 9 %) die Gesamtbelastung auf bis zu rund 28 %.</p><p>Steuerfrei bleibt der <strong>Sparerpauschbetrag</strong> von 1.000 € pro Person bzw. 2.000 € bei zusammenveranlagten Ehegatten (§ 20 Abs. 9 EStG). Damit die Bank Erträge bis zu dieser Grenze ohne Steuerabzug auszahlt, müssen Sie ihr einen <strong>Freistellungsauftrag</strong> erteilen — pro Bank getrennt, die Summe aller Aufträge darf den Höchstbetrag nicht übersteigen. Der Freistellungsauftrag ist also die Anweisung, den Pauschbetrag anzuwenden, nicht der Pauschbetrag selbst.</p><p>Wer mit seinem persönlichen Steuersatz unter 25 % liegt, kann über die <strong>Günstigerprüfung</strong> (§ 32d Abs. 6 EStG) in der Steuererklärung beantragen, dass die Erträge mit dem niedrigeren persönlichen Satz besteuert werden — das Finanzamt erstattet die Differenz, wenn es günstiger ist.</p><p>Ein Rechenbeispiel: Wer 1.500 € Zinsen erzielt und einen Freistellungsauftrag über 1.000 € erteilt hat, zahlt nur auf die übersteigenden 500 € Steuer — 26,375 % von 500 € = 131,88 €. Ohne Freistellungsauftrag würden zunächst auf die vollen 1.500 € 395,63 € einbehalten; den zu viel gezahlten Betrag holt man sich erst über die Steuererklärung zurück. Die Günstigerprüfung lohnt vor allem bei niedrigem Gesamteinkommen — etwa für Studierende, Rentner mit kleiner Rente oder in Jahren ohne Erwerbseinkommen: Liegt der persönliche Grenzsteuersatz unter 25 %, sinkt die Belastung auf dieses Niveau.</p>`,
      },
      {
        typ: 'text',
        titel: 'Vorabpauschale: Steuer auf thesaurierende Fonds',
        html: `<p>Wer in <strong>thesaurierende Fonds oder ETFs</strong> investiert, die ihre Erträge nicht ausschütten, sondern automatisch wieder anlegen, zahlt trotzdem jährlich eine kleine Steuer im Voraus — die <strong>Vorabpauschale</strong> (§ 18 InvStG). Sie sorgt dafür, dass thesaurierende Fonds nicht über Jahrzehnte komplett steuerfrei wachsen, bevor erst beim Verkauf abgerechnet wird.</p><p>Grundlage ist der jährlich vom Bundesfinanzministerium veröffentlichte <strong>Basiszins</strong>, den die Deutsche Bundesbank aus den Renditen langlaufender Bundeswertpapiere ableitet. Für 2026 beträgt er <strong>3,20 %</strong> (2025: 2,53 %) — der höchste Wert seit Einführung der Regelung. Der steuerpflichtige Basisertrag errechnet sich als Fondswert zum Jahresanfang × Basiszins × 70 %. Beispiel: 50.000 € × 3,20 % × 0,7 = 1.120 € Basisertrag.</p><p>Die Vorabpauschale ist der <strong>kleinere</strong> Wert aus diesem Basisertrag und der tatsächlichen Wertsteigerung des Fonds — in einem Verlustjahr fällt sie auf null. Besteuert wird sie mit den üblichen 26,375 %, ein Freistellungsauftrag wird angerechnet. Den Betrag zieht die Depotbank automatisch Anfang des Folgejahres ein (für 2026 also im Januar 2027). Wichtig zur Einordnung: Die Vorabpauschale ist <strong>keine Zusatzsteuer</strong> — sie wird beim späteren Verkauf voll gegengerechnet und mindert lediglich den Steuerstundungseffekt.</p><p>Praktisch heißt das: Auf dem Verrechnungskonto sollte Anfang Januar genug Guthaben liegen, damit die Depotbank die fällige Steuer einziehen kann — sonst drohen eine Rückfrage oder ein Sollsaldo. Bei voll ausgeschöpftem Freistellungsauftrag fällt die Vorabpauschale dagegen gar nicht ins Gewicht.</p>`,
      },
      {
        typ: 'infobox',
        variante: 'tipp',
      ...
      {
        typ: 'text',
        titel: 'Sollzins vs. Effektivzins — worauf es ankommt',
        html: `<p>Beim Kredit stehen zwei Zinssätze im Angebot, und nur einer ist ehrlich vergleichbar. Der <strong>Sollzins</strong> ist der reine Zins auf das geliehene Kapital. Der <strong>Effektivzins</strong> (effektiver Jahreszins, vorgeschrieben nach § 6 PAngV) bezieht zusätzlich Bearbeitungs- und Nebenkosten sowie die unterjährige Verrechnung mit ein — er bildet die tatsächliche jährliche Belastung ab. Deshalb gilt: Kredite immer am Effektivzins vergleichen, nie am niedriger wirkenden Sollzins.</p><p>Beim Sparen gibt es ein Pendant. Auch hier weichen nominaler und effektiver Zins voneinander ab, abhängig vom <strong>Zinsgutschrift-Rhythmus</strong>: Wird der Zins monatlich statt jährlich gutgeschrieben, wirkt der Zinseszins bereits unterjährig — aus einem nominalen Satz wird ein etwas höherer Effektivzins. Bei sonst gleichem Nominalzins ist das Angebot mit häufigerer Gutschrift also das bessere. Wer Sparangebote vergleicht, sollte deshalb nicht nur auf den beworbenen Prozentsatz, sondern auch auf das Gutschrift-Intervall achten.</p><p>Wie groß die Lücke beim Kredit sein kann, zeigt ein Beispiel: Ein Ratenkredit mit 6,0 % Sollzins landet durch Bearbeitungsmodalitäten und die monatliche Verrechnung schnell bei einem effektiven Jahreszins von 6,3 bis 6,5 %. Auf eine Kreditsumme von 15.000 € über fünf Jahre macht ein halber Prozentpunkt bereits mehrere Hundert Euro Mehrkosten aus. Wer zwei Angebote nur am Sollzins misst, übersieht genau diese Differenz — der gesetzlich vorgeschriebene Effektivzins macht sie sichtbar und vergleichbar.</p>`,
      },
      {
        typ: 'checkliste',
...
Eine **Abfindung** bei einvernehmlicher Auflösung des Arbeitsverhältnisses wird in der Regel **nicht auf das ALG I angerechnet**, wenn die ordentliche Kündigungsfrist eingehalten wurde. Wird die Kündigungsfrist verkürzt, kann das ALG während der eigentlich geltenden Kündigungsfrist ruhen (§ 158 SGB III). Darüber hinaus unterliegt die Abfindung der **Fünftelregelung** als außerordentliche Einkünfte — das kann steuerlich günstig sein.`,
    ...
    contentBloecke: [
      ...
      },
      {
        typ: 'diagramm',
        variante: 'balken',
        titel: 'Bezugsdauer-Staffel im Überblick',
        daten: [
          { label: '12 Mon. versichert', wert: 6, einheit: 'Mon.' },
          { label: '16 Mon. versichert', wert: 8, einheit: 'Mon.' },
          { label: '20 Mon. versichert', wert: 10, einheit: 'Mon.' },
          { label: '24 Mon. versichert', wert: 12, einheit: 'Mon.' },
          { label: '30 Mon. (ab 50)', wert: 15, einheit: 'Mon.' },
          { label: '36 Mon. (ab 55)', wert: 18, einheit: 'Mon.' },
          { label: '48 Mon. (ab 58)', wert: 24, einheit: 'Mon.' },
        ],
        fussnote: 'Anspruchsdauer in Monaten je Stufe — sie verdoppelt sich von 6 auf 24 Monate. Werte konsistent zur Tabelle oben. § 147 Abs. 2 SGB III.',
      },
      {
        typ: 'beispielrechnung',
        ...
        fazit: 'Aus 3.000 € brutto werden rund 1.243 € ALG I im Monat — der Tagessatz (41,44 €) wird dabei immer mit 30 multipliziert, unabhängig von der echten Monatslänge. Mit mindestens einem Kind steigt der Satz auf 67 % (siehe Beispiel mit Kind weiter unten). Das Leistungsentgelt von 2.072 € ist ein pauschaliertes Netto und weicht vom tatsächlichen Lohn-Netto ab.',
      },
      {
        typ: 'text',
    ...
    contentBloecke: [
      ...
      },
      {
        ...
        werte: [
          ...
          { label: '2026', wert: '13,90 €', hinweis: 'Vierte MiLoV' },
          { label: 'ab 2027', wert: '14,60 €', hinweis: 'Vierte MiLoV, Stufe 2' },
        ],
      },
      {
        typ: 'tabelle',
...
Der Rechner zeigt nicht nur das Problem, sondern auch die Hebel: Homeoffice-Tage sparen Pendelzeit und Fahrtkosten. Meal-Prep statt Kantine spart 100 bis 150 Euro pro Monat. Und die konsequente Dokumentation von Überstunden führt entweder zu Vergütung oder zu einer realistischeren Workload-Planung. Jede Verbesserung erhöht Ihren wahren Stundenlohn sofort.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Der wahre Stundenlohn — mehr als Gehalt ÷ Vertragsstunden',
        html: `<p>Der offizielle Stundenlohn ist schnell berechnet: Nettogehalt geteilt durch die vertraglichen Arbeitsstunden. Diese Zahl blendet aber aus, was ein Job tatsächlich an Zeit und Geld kostet. Der <strong>wahre Stundenlohn</strong> rechnet zwei Dinge gegen: die gesamte Zeit, die wirklich für den Job draufgeht — inklusive Pendeln und unbezahlter Mehrarbeit — und die Kosten, die nur entstehen, weil man arbeiten geht.</p><p>Das Ergebnis liegt fast immer spürbar unter dem offiziellen Wert und ist für viele ein Augenöffner. Die Formel lautet: wahrer Stundenlohn = (Nettogehalt − berufsbedingte Kosten) ÷ (Vertragsstunden + Pendelzeit + unbezahlte Überstunden). Sinn der Rechnung ist nicht, den eigenen Job schlechtzurechnen, sondern zwei Angebote oder Lebenssituationen ehrlich vergleichbar zu machen. Besonders aufschlussreich ist der Blick auf die Zeit: Eine Stunde, die man im Auto oder im Zug verbringt, bringt finanziell nichts, kostet aber Lebenszeit. Der wahre Stundenlohn macht diesen verborgenen Preis sichtbar und in Euro messbar. Die Zahlen auf dieser Seite sind vereinfachte Beispiele und ersetzen keine Steuerberatung.</p>`,
      },
      {
        typ: 'vergleich',
        titel: 'Nomineller vs. wahrer Stundenlohn',
        spalteA: 'Offizieller Stundenlohn',
        spalteB: 'Wahrer Stundenlohn',
        zeilen: [
          { kriterium: 'Einkommensbasis', a: 'Netto (oft sogar nur Brutto)', b: 'Netto minus berufsbedingte Kosten' },
          { kriterium: 'Zeitbasis', a: 'nur Vertragsstunden', b: 'plus Pendeln und unbezahlte Mehrarbeit' },
          { kriterium: 'Berufsbedingte Kosten', a: 'unberücksichtigt', b: 'abgezogen (Fahrt, Essen, Kleidung)' },
          { kriterium: 'Aussagekraft', a: 'schöngerechnet', b: 'realistischer Verdienst je Lebensstunde' },
          { kriterium: 'Typisch im Beispiel', a: '≈ 12,70 €/h', b: '≈ 9–10 €/h' },
        ],
      },
      {
        typ: 'beispielrechnung',
        titel: 'Brutto-Stundenlohn vs. Netto-Stundenlohn',
        schritte: [
          { label: 'Bruttogehalt', formel: 'monatlich', ergebnis: '3.500 €' },
          { label: 'minus Sozialabgaben (≈ 20,95 %)', formel: '3.500 € × 20,95 %', ergebnis: '− 733 €' },
          { label: 'minus Lohnsteuer (vereinfacht, StKl I)', formel: 'progressiv', ergebnis: '≈ − 570 €' },
          { label: 'Netto (vereinfachte Schätzung)', formel: 'Brutto − SV − Steuer', ergebnis: '≈ 2.200 €' },
          { label: 'Netto-Stundenlohn bei 40 h/Woche', formel: '2.200 € ÷ 173 h', ergebnis: '≈ 12,70 €' },
        ],
        fazit: 'Schon der Schritt von Brutto zu Netto verändert den Stundenlohn deutlich. Von 3.500 Euro brutto bleiben nach Sozialabgaben (rund 20,95 Prozent Arbeitnehmeranteil) und Lohnsteuer in dieser vereinfachten Schätzung für Steuerklasse I etwa 2.200 Euro netto. Geteilt durch rund 173 Monatsstunden (40 Stunden pro Woche) ergibt das einen Netto-Stundenlohn von etwa 12,70 Euro — der Brutto-Stundenlohn von gut 20 Euro ist also nur die halbe Wahrheit. Die genaue Steuerlast hängt von Steuerklasse, Kirchenzugehörigkeit, Kinderfreibeträgen und Bundesland ab; feste Eurobeträge lassen sich daraus nicht allgemein ableiten. Dieser Netto-Stundenlohn ist aber erst der Ausgangspunkt — der wahre Stundenlohn liegt nochmals darunter, sobald unbezahlte Zeit und berufsbedingte Kosten hinzukommen. Schon hier zeigt sich: Der Brutto-Stundenlohn taugt nicht als Maßstab fürs eigene Budget.',
      },
      {
        typ: 'text',
        titel: 'Unbezahlte Zeit frisst den Stundenlohn',
        html: `<p>Der größte Hebel beim wahren Stundenlohn ist die Zeit. Wer pendelt, investiert täglich Zeit, die weder bezahlt wird noch echte Freizeit ist. Eine halbe Stunde pro Strecke summiert sich auf rund eine Stunde am Tag und damit auf über 200 zusätzliche Stunden im Jahr — bei gleicher Bezahlung. Im Stundenlohn ausgedrückt sinkt der reale Verdienst, weil dieselbe Nettosumme nun auf mehr Stunden verteilt wird.</p><p>Ähnlich wirken <strong>unbezahlte Überstunden</strong>: Wer regelmäßig länger bleibt, ohne dass diese Zeit vergütet oder abgefeiert wird, senkt seinen effektiven Stundenlohn unmittelbar. Auch Mittagspausen, die faktisch der Erreichbarkeit dienen, oder lange Anfahrten zu wechselnden Einsatzorten zählen hierzu. Wichtig ist die ehrliche Erfassung: Nicht jede Minute am Arbeitsplatz ist produktiv, aber jede investierte Stunde gehört in die Rechnung, wenn man wissen will, was eine Stunde Lebenszeit für den Job tatsächlich einbringt. Genau diese Gesamtzeit setzt der Rechner ins Verhältnis zum Netto.</p>`,
      },
      {
        typ: 'vergleich',
        titel: 'Bezahlte Arbeitszeit vs. unbezahlter Zusatzaufwand',
        spalteA: 'Wird bezahlt',
        spalteB: 'Frisst den Lohn unbemerkt',
        zeilen: [
          { kriterium: 'Zeit', a: 'vertragliche Arbeitsstunden', b: 'Pendeln, unbezahlte Überstunden, Bereitschaft' },
          { kriterium: 'Wege', a: 'Dienstreisen (meist vergütet)', b: 'täglicher Arbeitsweg' },
          { kriterium: 'Geld', a: 'Gehalt, Zulagen', b: 'Sprit, Ticket, Mittagessen, Kleidung' },
          { kriterium: 'Sichtbarkeit', a: 'steht im Vertrag', b: 'taucht nirgends auf' },
          { kriterium: 'Wirkung auf den wahren Lohn', a: 'hebt ihn', b: 'senkt ihn' },
        ],
      },
      {
        typ: 'beispielrechnung',
        titel: 'Mit 1 Stunde Pendeln pro Tag',
        schritte: [
          { label: 'Netto (Beispiel)', formel: 'vereinfachte Schätzung', ergebnis: '2.200 €' },
          { label: 'Vertragsstunden/Monat', formel: '40 h × 4,33', ergebnis: '173 h' },
          { label: 'Pendelzeit/Monat', formel: '60 Min/Tag × 21,7 Tage', ergebnis: '+ 21,7 h' },
          { label: 'Gesamtzeit', formel: '173 + 21,7', ergebnis: '≈ 195 h' },
          { label: 'Lohn pro echter Stunde', formel: '2.200 € ÷ 195 h', ergebnis: '≈ 11,30 €' },
        ],
        fazit: 'Eine Stunde Pendeln am Tag — also je 30 Minuten pro Strecke — addiert über den Monat rund 22 unbezahlte Stunden. Die Gesamtzeit für den Job steigt damit von 173 auf etwa 195 Stunden, während das Netto gleich bleibt. Der Lohn pro tatsächlich investierter Stunde sinkt dadurch von 12,70 auf rund 11,30 Euro, ganz ohne dass Kosten berücksichtigt wären. Wer 45 Minuten pro Strecke fährt, verliert noch mehr. Das macht deutlich, warum Wohnortwahl und Arbeitsweg den realen Verdienst stärker beeinflussen als viele denken: Eine Gehaltserhöhung kann durch einen längeren Pendelweg rechnerisch teilweise aufgezehrt werden. Die 21,7 Arbeitstage pro Monat sind ein üblicher Durchschnittswert.',
      },
      {
        typ: 'beispielrechnung',
        titel: 'Unbezahlte Überstunden',
        schritte: [
          { label: 'Gesamtzeit mit Pendeln', formel: 'aus Schritt zuvor', ergebnis: '≈ 195 h' },
          { label: 'Unbezahlte Überstunden', formel: '3 h/Woche × 4,33', ergebnis: '+ 13 h' },
          { label: 'Echte Gesamtzeit', formel: '195 + 13', ergebnis: '≈ 208 h' },
          { label: 'Lohn pro echter Stunde', formel: '2.200 € ÷ 208 h', ergebnis: '≈ 10,58 €' },
        ],
        fazit: 'Kommen drei unbezahlte Überstunden pro Woche hinzu, wächst die echte Monatszeit um weitere rund 13 Stunden auf etwa 208 Stunden. Der Lohn je investierter Stunde fällt damit auf gut 10,50 Euro — und das immer noch vor Abzug der berufsbedingten Kosten. Unbezahlte Mehrarbeit ist besonders tückisch, weil sie oft schleichend zur Gewohnheit wird und im Gehalt überhaupt nicht auftaucht. Wer regelmäßig zwei Stunden täglich länger bleibt, arbeitet rechnerisch fast einen zusätzlichen unbezahlten Tag pro Woche. Für den ehrlichen Vergleich zweier Stellen ist genau diese unsichtbare Zeit entscheidend: Zwei Jobs mit identischem Gehalt können sich im wahren Stundenlohn erheblich unterscheiden. Die hier genutzten Werte stammen aus dem Standard-Beispiel des Rechners.',
      },
      {
        typ: 'vergleich',
        titel: 'Zwei Jobs, gleiches Brutto, anderer Aufwand',
        spalteA: 'Job A — nah, geregelt',
        spalteB: 'Job B — Pendeln + Mehrarbeit',
        zeilen: [
          { kriterium: 'Bruttogehalt', a: '3.500 €', b: '3.500 €' },
          { kriterium: 'Arbeitsweg', a: '10 Min je Strecke', b: '45 Min je Strecke' },
          { kriterium: 'Unbezahlte Überstunden', a: 'keine', b: '5 h/Woche' },
          { kriterium: 'Echte Wochenzeit', a: '≈ 42 h', b: '≈ 53 h' },
          { kriterium: 'Wahrer Stundenlohn', a: 'deutlich höher', b: 'deutlich niedriger' },
        ],
      },
      {
        typ: 'text',
        titel: 'Berufsbedingte Kosten gegenrechnen',
        html: `<p>Neben der Zeit kostet ein Job auch Geld — und zwar Ausgaben, die ohne den Job gar nicht anfielen. Dazu zählen <strong>Fahrtkosten</strong> (Sprit, Verschleiß, ÖPNV-Ticket), das tägliche <strong>Mittagessen</strong> oder der Coffee-to-go auswärts sowie <strong>Arbeitskleidung</strong> und deren Reinigung. Im Schnitt kommen so schnell 200 bis 400 Euro im Monat zusammen, die das verfügbare Netto schmälern.</p><p>Für den wahren Stundenlohn werden diese Kosten vom Nettogehalt abgezogen, bevor durch die Gesamtstunden geteilt wird. Ein Teil davon lässt sich über die Steuererklärung als Werbungskosten teilweise zurückholen — etwa die Entfernungspauschale für den Arbeitsweg oder Aufwendungen für typische Berufskleidung. Das mindert die Belastung, hebt sie aber selten vollständig auf, weil nur ein Teil erstattet wird und auch nur, soweit die Werbungskosten den Pauschbetrag übersteigen. In der Beispielrechnung bleiben die Kosten daher als realer Abzug stehen. Welche Posten im Einzelfall absetzbar sind, klärt die Steuererklärung — dies ist keine Steuerberatung.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Fahrtkosten und Arbeitskleidung abgezogen',
        schritte: [
          { label: 'Netto (Beispiel)', formel: 'vereinfachte Schätzung', ergebnis: '2.200 €' },
          { label: 'minus Fahrtkosten', formel: 'Sprit / Ticket', ergebnis: '− 100 €' },
          { label: 'minus Essen auswärts', formel: '8 €/Tag × 21,7', ergebnis: '− 174 €' },
          { label: 'Bereinigtes Netto', formel: '2.200 − 100 − 174', ergebnis: '≈ 1.926 €' },
          { label: 'Wahrer Stundenlohn', formel: '1.926 € ÷ 208 h', ergebnis: '≈ 9,25 €' },
        ],
        fazit: 'Zieht man die berufsbedingten Kosten ab, sinkt das verfügbare Netto im Beispiel von 2.200 auf rund 1.926 Euro. Geteilt durch die echte Gesamtzeit von etwa 208 Stunden bleibt ein wahrer Stundenlohn von rund 9,25 Euro — gegenüber 12,70 Euro offiziellem Netto-Stundenlohn ein Minus von fast 30 Prozent. Aus gut 20 Euro Brutto-Stundenlohn ist damit real ein einstelliger Betrag geworden. Genau dieser Wert zeigt, was eine Stunde Lebenszeit für den Job nach allen Abzügen tatsächlich einbringt. Die Einzelposten sind Beispielwerte; mit Arbeitskleidung, höheren Fahrtkosten oder mehr Pendelzeit fällt das Ergebnis noch niedriger aus. Der Rechner oben setzt Ihre eigenen Zahlen ein und vergleicht das Ergebnis zusätzlich mit dem gesetzlichen Mindestlohn. So wird sichtbar, ob der wahre Stundenlohn noch komfortabel über der Lohnuntergrenze liegt oder ihr bedenklich nahekommt.',
      },
      {
        typ: 'statistik',
        titel: 'Was den wahren Lohn am stärksten senkt',
        werte: [
          { label: 'Langer Arbeitsweg', wert: 'sehr hoch', hinweis: '45 Min/Strecke = über 300 unbezahlte Std/Jahr' },
          { label: 'Unbezahlte Überstunden', wert: 'hoch', hinweis: 'jede Stunde senkt den Lohn direkt' },
          { label: 'Hohe Fahrtkosten', wert: 'mittel', hinweis: 'Sprit, Verschleiß, ÖPNV-Ticket' },
          { label: 'Auswärts essen', wert: 'mittel', hinweis: 'Kantine, Bäcker, Coffee-to-go summieren sich' },
          { label: 'Teilzeit mit Fixkosten', wert: 'relativ hoch', hinweis: 'feste Wege- und Essenskosten auf weniger Stunden' },
        ],
      },
      {
        typ: 'checkliste',
        titel: 'Den eigenen wahren Stundenlohn ermitteln',
        punkte: [
...
Weil die Grenzbelastung so hoch ist, lohnen sich steuerfreie Zusatzleistungen oft mehr als eine Bruttoerhöhung. Zu den wichtigsten **steuerfreien Benefits** zählen: Das **Deutschlandticket als Jobticket** (63 Euro/Monat seit 2026 komplett steuerfrei), **Essenszuschüsse** (bis 7,67 Euro pro Arbeitstag), **Kindergarten-Zuschüsse** (unbegrenzt steuerfrei für nicht-schulpflichtige Kinder), **betriebliche Altersvorsorge** (Entgeltumwandlung bis 302 Euro/Monat steuerfrei), **Gesundheitsförderung** (bis 600 Euro/Jahr für zertifizierte Kurse), **Handy- und Laptop-Zuschüsse** sowie **Erholungsbeihilfen**. Ein Essenszuschuss von 115 Euro/Monat (7,67 € × 15 Tage) entspricht einer Brutto-Erhöhung von rund 200 Euro — Sie sparen Abgaben von rund 50 Prozent. Verhandeln Sie deshalb nicht nur über das Grundgehalt, sondern auch über die Zusatzleistungen. Für einen kompletten Gehaltsvergleich nach Branche und Region nutzen Sie unseren [Gehaltsvergleich](/finanzen/gehaltsvergleich).`,
    faq: [
      {
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Was von der Gehaltserhöhung netto übrig bleibt',
        html: `<p>Eine Gehaltserhöhung klingt nach einem klaren Plus — doch auf dem Konto kommt regelmäßig deutlich weniger an, als die Brutto-Zahl verspricht. Der Grund ist die sogenannte <strong>Grenzbelastung</strong>: Auf jeden zusätzlich verdienten Euro fallen Lohnsteuer, gegebenenfalls Solidaritätszuschlag und Kirchensteuer sowie Sozialabgaben an. Bei mittleren Einkommen bleibt von einem Brutto-Plus typischerweise nur etwas mehr als die Hälfte als Netto übrig.</p><p>Wichtig ist die Unterscheidung zwischen dem, was Sie zusätzlich brutto bekommen, und dem, was netto tatsächlich mehr ankommt. Wer eine Erhöhung verhandelt, sollte deshalb nicht nur auf die Brutto-Prozente schauen, sondern auf den Netto-Zuwachs pro Monat — und am besten auch auf den Jahreswert. Dieser Rechner stellt altes und neues Netto direkt gegenüber und weist aus, welcher Anteil der Erhöhung an Steuer und Abgaben geht. Schon kleine Unterschiede bei Steuerklasse, Kinderfreibeträgen oder Kirchensteuer verschieben das Ergebnis spürbar, weshalb ein Blick auf die eigenen Eckdaten mehr hilft als jede pauschale Faustregel. Die Zahlen sind eine Orientierung und ersetzen keine Steuerberatung.</p>`,
      },
      {
        typ: 'vergleich',
        titel: 'Brutto-Plus vs. Netto-Plus',
        spalteA: 'Brutto-Erhöhung',
        spalteB: 'Netto-Erhöhung',
        zeilen: [
          { kriterium: 'Was es bezeichnet', a: 'mehr auf dem Gehaltszettel (vor Abzügen)', b: 'mehr auf dem Konto (nach Abzügen)' },
          { kriterium: 'Wovon abhängig', a: 'Verhandlung mit dem Arbeitgeber', b: 'Steuerklasse, Einkommen, SV, Kirche, Bundesland' },
          { kriterium: 'Anteil bei mittlerem Einkommen', a: '100 %', b: 'oft rund 50–60 %' },
          { kriterium: 'Aussagekraft fürs Budget', a: 'gering — täuscht ein größeres Plus vor', b: 'hoch — das ist das verfügbare Geld' },
          { kriterium: 'Rolle im Gespräch', a: 'nennt der Arbeitgeber zuerst', b: 'die eigentlich relevante Größe' },
        ],
      },
      {
        typ: 'beispielrechnung',
        titel: '+200 € brutto: was netto ankommt',
        schritte: [
          { label: 'Brutto-Erhöhung', formel: '+200 €/Monat', ergebnis: '+200 €' },
          { label: 'Beispielhafte Grenzbelastung', formel: 'rund 44 %', ergebnis: '≈ 44 %' },
          { label: 'Abgaben auf die Erhöhung', formel: '200 € × 44 %', ergebnis: '≈ 88 €' },
          { label: 'Netto-Zuwachs', formel: '200 € − 88 €', ergebnis: '≈ 112 €' },
        ],
        fazit: 'Von 200 Euro brutto mehr kommen in diesem Beispiel rund 112 Euro netto an — gut die Hälfte. Die zugrunde gelegte Grenzbelastung von etwa 44 Prozent ist ein typischer Wert für ein mittleres Einkommen in Steuerklasse I ohne Kirchensteuer; sie ist kein fester Satz, sondern hängt von Einkommen, Steuerklasse, Bundesland und Kirchenzugehörigkeit ab. Bei höherem Ausgangsgehalt unterhalb der Beitragsbemessungsgrenzen fällt die Grenzbelastung eher höher aus, der Netto-Anteil also kleiner. Wichtig ist die Rechenrichtung: Erst die Abgaben auf den Zuwachs abziehen, dann bleibt der tatsächliche Netto-Effekt. Genau diesen rechnet der Rechner oben mit Ihren echten Eckdaten aus — das Beispiel zeigt nur das Prinzip und ersetzt keine Steuerberatung. Wer mehrere Szenarien durchspielt, erkennt rasch, dass für einen bestimmten Netto-Wunsch ein deutlich höheres Brutto-Ziel nötig sein kann, als zunächst gedacht.',
      },
      {
        typ: 'text',
        titel: 'Progression: warum die Erhöhung stärker besteuert wird',
        html: `<p>Das deutsche Einkommensteuerrecht ist progressiv (§ 32a EStG): Je höher das Einkommen, desto höher der Steuersatz auf den jeweils nächsten Euro. Bis zum Grundfreibetrag bleibt das Einkommen steuerfrei, danach steigt der Satz stufenlos an, bis er im Spitzenbereich bei 42 Prozent liegt. Für eine Gehaltserhöhung zählt nicht der Durchschnittssteuersatz über das gesamte Einkommen, sondern der höhere <strong>Grenzsteuersatz</strong> auf den oberen Teil.</p><p>Deshalb wird gerade der Zuwachs überdurchschnittlich belastet: Die Erhöhung sitzt oben auf dem Einkommen und trifft damit den höchsten persönlichen Steuersatz. Hinzu kommen die Sozialabgaben, die bis zu den jeweiligen Beitragsbemessungsgrenzen voll mitlaufen. In der Summe ergibt sich für viele Arbeitnehmer eine Grenzbelastung von rund 40 bis 50 Prozent. Welche genaue Höhe sich ergibt, hängt von Einkommen, Steuerklasse, Kirchenzugehörigkeit und Bundesland ab — feste Eurobeträge lassen sich daraus nicht pauschal ableiten. Wer wissen will, wie stark der nächste Gehaltssprung belastet wird, schaut deshalb auf den Grenzsteuersatz an der eigenen Einkommensstelle, nicht auf die bereits gezahlte Durchschnittsquote.</p>`,
      },
      {
        typ: 'vergleich',
        titel: 'Grenz- vs. Durchschnittssteuersatz',
        spalteA: 'Durchschnittssteuersatz',
        spalteB: 'Grenzsteuersatz',
        zeilen: [
          { kriterium: 'Bezieht sich auf', a: 'das gesamte Einkommen', b: 'den nächsten zusätzlichen Euro' },
          { kriterium: 'Relevanz für die Erhöhung', a: 'irreführend zu niedrig', b: 'maßgeblich' },
          { kriterium: 'Beispiel (Single, mittleres Gehalt)', a: 'rund ein Drittel', b: 'rund 40–45 %' },
          { kriterium: 'Wie er sich verhält', a: 'steigt nur langsam', b: 'springt mit dem Einkommen' },
          { kriterium: 'Häufiger Denkfehler', a: '„meine Quote gilt auch für den Zuwachs"', b: 'der Zuwachs wird höher belastet' },
        ],
      },
      {
        typ: 'beispielrechnung',
        titel: 'Erhöhung über die Beitragsbemessungsgrenze hinaus',
        schritte: [
          { label: 'Teil der Erhöhung unter der BBG', formel: 'Steuer + volle Sozialabgaben', ergebnis: 'höhere Belastung' },
          { label: 'Sozialabgaben-Anteil (AN) darunter', formel: 'rund 20 %', ergebnis: '≈ 20 %' },
          { label: 'Teil oberhalb der BBG', formel: 'nur noch Steuer, keine SV', ergebnis: 'geringere Belastung' },
          { label: 'Folge für die Grenzbelastung', formel: 'fällt im oberen Teil', ergebnis: 'z. B. 48 % → 42 %' },
        ],
        fazit: 'Die Sozialabgaben werden nur bis zur jeweiligen Beitragsbemessungsgrenze (BBG) erhoben — oberhalb fallen für den darüber liegenden Teil des Einkommens keine Beiträge mehr an. Schiebt eine Erhöhung das Gehalt über eine BBG, wird der obere Teil des Zuwachses nur noch mit Lohnsteuer belastet, nicht mehr mit Sozialabgaben. Dadurch kann die Grenzbelastung in diesem Bereich sinken — im Beispiel von rund 48 auf etwa 42 Prozent. Das wirkt zunächst paradox, ist aber die direkte Folge der Beitragsdeckelung. Für die Renten- und Arbeitslosenversicherung gilt eine andere, höhere BBG als für die Kranken- und Pflegeversicherung, weshalb der Effekt gestaffelt eintritt. Für die meisten Arbeitnehmer spielt das keine Rolle, weil ihr Einkommen unter den Grenzen liegt; relevant wird der Effekt erst bei höheren Gehältern nahe oder oberhalb einer BBG. Die genauen Grenzwerte ändern sich jährlich; maßgeblich ist die im jeweiligen Jahr gültige Rechengröße.',
      },
      {
        typ: 'statistik',
        titel: 'Typische Netto-Quote einer Erhöhung (Spanne)',
        werte: [
          { label: 'Geringes Einkommen (nahe Grundfreibetrag)', wert: '~65–75 % netto', hinweis: 'niedrige Grenzbelastung, da der Tarif erst flach ansteigt' },
          { label: 'Mittleres Einkommen', wert: '~50–60 % netto', hinweis: 'Grenzbelastung rund 40–50 %, je nach Steuerklasse und Kirche' },
          { label: 'Höheres Einkommen unter den BBG', wert: '~45–50 % netto', hinweis: 'hohe Grenzbelastung, da alle Abgaben voll mitlaufen' },
          { label: 'Oberhalb der KV/PV-BBG', wert: 'etwas höher', hinweis: 'keine KV/PV-Beiträge mehr auf den Zuwachs' },
          { label: 'Grobe Faustregel', wert: 'rund die Hälfte', hinweis: 'vom Brutto-Plus bleibt netto — als grobe Orientierung, im Einzelfall mehr oder weniger' },
        ],
      },
      {
        typ: 'text',
        titel: 'Brutto-Alternativen: was mehr bringen kann',
        html: `<p>Weil die Grenzbelastung so hoch ist, lohnt sich der Blick auf steuerfreie oder pauschal besteuerte Zusatzleistungen. Anders als beim Bruttogehalt fallen darauf keine oder nur geringe Abgaben an — der zugewendete Betrag kommt also weitgehend ungeschmälert an. Typische Beispiele sind ein Jobticket beziehungsweise Deutschlandticket, ein Essenszuschuss, Zuschüsse zur Kinderbetreuung, betriebliche Altersvorsorge per Entgeltumwandlung, Angebote zur Gesundheitsförderung sowie steuerfreie Sachbezüge im monatlichen Freibetrag.</p><p>Der Effekt ist erheblich: Eine steuerfreie Leistung von 50 Euro entspricht netto oft einer Brutto-Erhöhung von rund 90 bis 100 Euro, weil dort etwa die Hälfte an Steuer und Abgaben verloren ginge. In Gehaltsgesprächen lohnt es sich deshalb, neben dem Grundgehalt auch über solche Bausteine zu sprechen. Die konkreten Höchstbeträge und Voraussetzungen ändern sich allerdings immer wieder — vor einer Zusage gehören sie in die Steuererklärung oder ins Gespräch mit der Lohnbuchhaltung. Steuerfreie Bausteine sind dabei kein vollwertiger Ersatz für mehr Bruttogehalt: Sie sind zweckgebunden und wirken sich oft nicht auf die spätere Rente aus. Dies ist keine Steuerberatung.</p>`,
      },
      {
        typ: 'vergleich',
        titel: 'Gehaltserhöhung vs. steuerfreie Sachbezüge',
        spalteA: 'Brutto-Gehaltserhöhung',
        spalteB: 'Steuerfreier Sachbezug',
        zeilen: [
          { kriterium: 'Abgaben darauf', a: 'Steuer + Sozialabgaben (oft ~50 %)', b: 'keine oder stark reduziert' },
          { kriterium: 'Netto-Wirkung von 50 €', a: 'rund 25–30 € netto', b: 'nahe 50 € Gegenwert' },
          { kriterium: 'Wirkung auf die Rente', a: 'erhöht spätere Rentenansprüche', b: 'meist ohne Rentenwirkung' },
          { kriterium: 'Flexibilität', a: 'frei verwendbar', b: 'zweckgebunden (Ticket, Essen …)' },
          { kriterium: 'Voraussetzungen', a: 'keine besonderen', b: 'gesetzliche Grenzen und Bedingungen' },
        ],
      },
      {
        typ: 'beispielrechnung',
        titel: 'Reale Kaufkraft nach Inflation',
        schritte: [
          { label: 'Nominale Erhöhung', formel: '+8 % brutto', ergebnis: '+8 %' },
          { label: 'Beispiel-Inflation', formel: 'rund 2,5 %', ergebnis: '≈ 2,5 %' },
          { label: 'Realer Brutto-Zuwachs', formel: '8 % − 2,5 %', ergebnis: '≈ 5,5 %-Punkte' },
          { label: 'Nach Abgaben (Netto)', formel: 'Grenzbelastung mindert zusätzlich', ergebnis: 'real spürbar weniger' },
        ],
        fazit: 'Eine Erhöhung bringt real nur so viel, wie sie die Teuerung übersteigt. Steigt das Gehalt um 8 Prozent, während die Preise um rund 2,5 Prozent zulegen, bleibt ein realer Brutto-Zuwachs von etwa 5,5 Prozentpunkten. Davon geht über die Grenzbelastung noch ein erheblicher Teil an Steuer und Abgaben ab, sodass der reale Netto-Gewinn kleiner ausfällt, als die nominale Prozentzahl vermuten lässt. Aus 8 Prozent auf dem Papier kann real netto leicht ein nur einstelliger, niedriger Zuwachs werden. Steigt das Gehalt nur in Höhe der Inflation, ist der reale Zuwachs null — man spricht dann von der kalten Progression, weil man trotz gleicher Kaufkraft steuerlich etwas höher rutscht. Für eine belastbare Einschätzung lohnt sich deshalb der Blick auf die reale, inflationsbereinigte Veränderung statt nur auf die nominale Prozentzahl. Die hier genutzte Inflationsrate ist ein Beispielwert; der tatsächliche Wert schwankt und sollte für eine eigene Rechnung nachgeschlagen werden.',
      },
      {
        typ: 'checkliste',
...
Wer für sich zu dem Schluss kommt, dass Riester sich nicht lohnt, hat mehrere Alternativen: Ein **[ETF-Sparplan](/finanzen/etf-sparplanrechner)** bietet deutlich mehr Flexibilität, meist niedrigere Kosten und bessere Renditechancen — allerdings ohne staatliche Zulage und ohne Steuerförderung in der Ansparphase. Eine **Rürup-Rente (Basisrente)** eignet sich besonders für Selbstständige und Gutverdiener, weil die Beiträge zu 100 % als Sonderausgaben absetzbar sind (bis zum Höchstbetrag). Die **betriebliche Altersvorsorge (bAV)** ist oft eine sehr gute Ergänzung, weil der Arbeitgeber häufig Zuschüsse zahlt. Und der klassische Weg bleibt natürlich: in die gesetzliche Rente freiwillig einzahlen und die **Rentenlücke** mit unserem [Rentenrechner](/finanzen/rentenrechner) im Blick behalten.`,
    // W19-Goldstandard: riester-rechner auf volle Tiefe (~1.560 W, 15 Bausteine).
    // Leitformat „Vergleich & Einordnung" — 3 vergleich-Bausteine dominant (Zulagen vs.
    // Sonderausgabenabzug · Riester 2026 vs. Reform ab 2027 · Riester vs. ETF), grenzt sich
    // von rente (tabelle) und etf (diagramm) ab. ALLE Werte aus lib/berechnungen/riester.ts
    // reproduziert (Lib-Resolver-Check 25.06.2026): A1 40k/0K/35 % → Eigenbeitrag 1.425 €,
    // Förderung 560 €, Quote 39 %; A2 28k/2K/25 % → 345 €, 775 €, 225 %; A3 60k/beide/42 %
    // → 1.750 €, 860 €, 49 %. Werte 2026: Grundzulage 175 € (§ 84), Kinderzulage 300/185 €
    // (§ 85), Höchstbetrag 2.100 € (§ 10a), Sockel 60 € / 4 % (§ 86 EStG).
    // REFORM-DISZIPLIN: 2026-Werte = geltend (Bestandsschutz), 2027-Werte = geplante
    // Neuregelung (Bundestag 27.03.2026, Umsetzung 01.01.2027) — überall klar getrennt.
    // erklaerung bleibt Fallback.
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Was ist die Riester-Rente?',
        html: `<p>Die <strong>Riester-Rente</strong> ist eine staatlich geförderte private Altersvorsorge, eingeführt 2002, um das abgesenkte Niveau der gesetzlichen Rente teilweise auszugleichen. Das Besondere ist die <strong>doppelte Förderung</strong> über zwei Kanäle: direkte <strong>Zulagen</strong> vom Staat (Grund- und Kinderzulage) und eine <strong>Steuerersparnis</strong> über den Sonderausgabenabzug.</p><p>Welcher der beiden Wege für Sie günstiger ist, müssen Sie nicht selbst ausrechnen: Das Finanzamt führt automatisch die sogenannte <strong>Günstigerprüfung</strong> durch und gewährt immer die höhere Förderung. Mindestens erhalten Sie die Zulagen; ist Ihr Steuervorteil größer, bekommen Sie die Differenz zusätzlich erstattet.</p><p>Anspruch haben unter anderem sozialversicherungspflichtig Beschäftigte, Beamte, bestimmte Selbstständige und — mittelbar — deren nicht erwerbstätige Ehepartner. Dieser Rechner zeigt für Ihre Situation den optimalen Eigenbeitrag, die Zulagen, die Steuerersparnis und die daraus folgende Förderquote. Die Bescheinigung des Anbieters tragen Sie in die <a href="/finanzen/steuererstattung-rechner">Steuererklärung</a> ein.</p>`,
      },
      {
        typ: 'text',
        titel: 'Grundzulage und Kinderzulage',
        html: `<p>Die <strong>Grundzulage</strong> beträgt <strong>175 € pro Jahr</strong> für jeden Riester-Sparer. Ehepaare, bei denen beide einen eigenen Vertrag haben, erhalten sie zweimal — zusammen 350 €. Hinzu kommt die <strong>Kinderzulage</strong>: <strong>300 €</strong> pro Jahr für jedes ab 2008 geborene Kind und <strong>185 €</strong> für früher geborene. Die Zulage fließt, solange Sie für das Kind Kindergeld beziehen.</p><p>Für junge Sparer gibt es einen Anreiz zum frühen Start: Wer den Vertrag vor dem 25. Geburtstag abschließt, erhält einmalig <strong>200 € Berufseinsteigerbonus</strong>. Alle Zulagen zahlt der Staat direkt auf den Vertrag ein.</p><p>Damit das automatisch läuft, sollten Sie den <strong>Dauerzulagenantrag</strong> stellen — dann beantragt der Anbieter die Zulagen jedes Jahr für Sie, ohne dass Sie aktiv werden müssen. Voraussetzung für die volle Zulage ist allerdings, dass Sie den Mindesteigenbeitrag einzahlen — dazu gleich mehr.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Riester-Zulagen 2026 im Überblick',
        kopf: ['Förderbaustein', 'Betrag 2026', 'Rechtsgrundlage'],
        zeilen: [
        ...
        fussnote: 'Diese Werte gelten 2026 unverändert; für vor dem 01.01.2027 abgeschlossene Verträge auch darüber hinaus (Bestandsschutz). Für die volle Zulage ist ein Mindesteigenbeitrag von 4 % des Vorjahresbruttos abzüglich Zulagen nötig.',
      },
      {
        typ: 'vergleich',
        titel: 'Zwei Förderwege: Zulagen vs. Steuervorteil',
        spalteA: 'Zulagen',
        spalteB: 'Sonderausgabenabzug',
        zeilen: [
          { kriterium: 'Was', a: 'Grundzulage 175 € + Kinderzulage 300/185 €', b: 'Eigenbeitrag + Zulagen bis 2.100 € absetzbar' },
          { kriterium: 'Wirkung', a: 'feste Euro-Beträge, direkt auf den Vertrag', b: 'Steuerersparnis = Betrag × Grenzsteuersatz' },
          { kriterium: 'Stark bei', a: 'Familien & Geringverdienern', b: 'Gutverdienern mit hohem Steuersatz' },
          { kriterium: 'Antrag', a: 'Zulagenantrag (einmalig als Dauerantrag)', b: 'Anlage AV in der Steuererklärung' },
          { kriterium: 'Günstigerprüfung', a: 'immer mindestens die Zulagen', b: 'Differenz nur, wenn Steuervorteil größer' },
        ],
      },
      {
        typ: 'text',
        titel: 'Mindesteigenbeitrag: 4 % vom Vorjahresbrutto',
        html: `<p>Die Zulagen gibt es nicht geschenkt: Für die <strong>volle Förderung</strong> müssen Sie einen <strong>Mindesteigenbeitrag</strong> einzahlen. Er beträgt <strong>4 % Ihres Vorjahresbruttoeinkommens</strong>, abzüglich der bereits gewährten Zulagen. Nach unten gilt ein <strong>Sockelbetrag von 60 € pro Jahr</strong> (5 € im Monat), nach oben ist der geförderte Beitrag bei einem <strong>Höchstbetrag von 2.100 €</strong> inklusive Zulagen gedeckelt.</p><p>Wer weniger als den Mindesteigenbeitrag einzahlt, bekommt die Zulagen <strong>anteilig gekürzt</strong>: Bei nur der Hälfte des nötigen Beitrags gibt es auch nur die halbe Zulage. Deshalb lohnt es sich, den Beitrag nach jeder Gehaltsänderung zu überprüfen.</p><p>Der <strong>optimale Eigenbeitrag</strong> ist genau der Betrag, der die volle Zulage sichert, ohne unnötig über den geförderten Höchstbetrag hinauszugehen. Dieser Rechner ermittelt ihn automatisch — Sie sehen sofort, wie viel Sie mindestens einzahlen sollten, um keine Förderung zu verschenken.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Beispiel: Single, 40.000 €, keine Kinder (35 %)',
        schritte: [
          { label: 'Zulagen', formel: 'Grundzulage 175 € (keine Kinder)', ergebnis: '175 €' },
          { label: 'Optimaler Eigenbeitrag', formel: '4 % × 40.000 € − 175 € Zulage', ergebnis: '1.425 €' },
          { label: 'Sonderausgabenabzug', formel: 'Eigenbeitrag 1.425 € + Zulage 175 €', ergebnis: '1.600 €' },
          { label: 'Steuerersparnis', formel: '1.600 € × 35 % Grenzsteuersatz', ergebnis: '560 €' },
          { label: 'Günstigerprüfung', formel: '560 € Steuervorteil > 175 € Zulage', ergebnis: 'Steuerweg gewinnt' },
        ],
        fazit: 'Gesamtförderung 560 € bei 1.425 € Eigenbeitrag — eine Förderquote von 39 %. Für jeden selbst eingezahlten Euro gibt der Staat rund 39 Cent dazu. Bei diesem Single-Haushalt dominiert der Steuervorteil über den Sonderausgabenabzug, nicht die Zulage. Bei einer Familie mit zwei Kindern und niedrigerem Einkommen kehrt sich das Bild um: Dort tragen die Zulagen (775 €) den Großteil, der Eigenbeitrag sinkt auf 345 €, und die Förderquote springt auf über 200 %. Genau diese Spreizung zeigt, warum sich Riester für die einen stark und für die anderen kaum lohnt — entscheidend sind Kinderzahl und Einkommen.',
      },
      {
        typ: 'tabelle',
        titel: 'Für wen lohnt sich Riester? Drei Profile',
        kopf: ['Profil', 'Eigenbeitrag/Jahr', 'Förderung/Jahr', 'Förderquote'],
        zeilen: [
          ['Familie, 28.000 €, 2 Kinder, 25 %', '345 €', '775 €', '225 %'],
          ['Single, 40.000 €, 0 Kinder, 35 %', '1.425 €', '560 €', '39 %'],
          ['Paar (beide), 60.000 €, 0 Kinder, 42 %', '1.750 €', '860 €', '49 %'],
        ],
        fussnote: 'Optimaler Eigenbeitrag und Gesamtförderung aus diesem Rechner (Werte 2026). Förderquote = Gesamtförderung ÷ Eigenbeitrag. Je mehr Kinder und je geringer das Einkommen, desto höher fällt die Quote aus.',
      },
      {
        typ: 'text',
        titel: 'Für wen sich Riester besonders lohnt',
        html: `<p>Ob sich Riester lohnt, hängt stark von der Lebenssituation ab — die Förderquote macht es sichtbar. <strong>Familien mit Kindern</strong> und <strong>Geringverdiener</strong> profitieren am meisten: Weil die Zulagen feste Beträge sind, sinkt der nötige Eigenbeitrag stark, und die Förderquote kann <strong>über 200 %</strong> erreichen. Eine Familie mit zwei Kindern und 28.000 € Einkommen zahlt nur 345 € selbst und erhält 775 € Förderung.</p><p><strong>Gutverdiener</strong> mit hohem Grenzsteuersatz profitieren weniger über die Zulage, dafür stark über den Steuervorteil: Bei 42 % ist der Sonderausgabenabzug der entscheidende Hebel.</p><p><strong>Weniger attraktiv</strong> ist Riester häufig für Singles mit mittlerem Einkommen ohne Kinder — wegen teils hoher Verwaltungskosten, der vollen Besteuerung der späteren Rente und der eingeschränkten Vererbbarkeit. Hier ist oft ein <a href="/finanzen/etf-sparplanrechner">ETF-Sparplan</a> die flexiblere Wahl.</p>`,
      },
      {
        typ: 'text',
        titel: 'Wohnriester: Förderung fürs Eigenheim',
        html: `<p>Ein Sonderweg ist <strong>Wohnriester</strong> (Eigenheimrente, § 92a EStG): Statt fürs Rentenalter zu sparen, können Sie das geförderte Kapital für <strong>selbstgenutztes Wohneigentum</strong> einsetzen — für Kauf, Bau oder die Tilgung eines Immobiliendarlehens. Zulagen und Steuervorteil fließen dann in die eigene Immobilie statt in einen Sparvertrag.</p><p>Auch hier gilt das Prinzip der nachgelagerten Besteuerung: Die geförderten Beträge werden auf einem <strong>Wohnförderkonto</strong> erfasst und im Rentenalter versteuert — wahlweise jährlich über die Laufzeit verteilt oder einmalig mit einem Abschlag von 30 %. Der Vorteil liegt auf der Hand: Die Förderung senkt unmittelbar die Wohnkosten und beschleunigt die Entschuldung.</p><p>Wohnriester lohnt sich vor allem für Familien mit hohen Kinderzulagen, die ohnehin Wohneigentum anstreben. Wie bei jedem Riester-Produkt sollten Sie aber Kosten und die langfristige Bindung des Kapitals im Blick behalten — eine selbst genutzte Immobilie lässt sich nicht kurzfristig zu Geld machen.</p>`,
      },
      {
        typ: 'infobox',
        variante: 'hinweis',
        titel: 'Reform der Altersvorsorge: Umsetzung erst 2027',
        text: 'Die private Altersvorsorge wurde reformiert (Bundestag 27.03.2026, Bundesrat 08.05.2026), die Umsetzung erfolgt aber erst zum 01.01.2027. Für 2026 gelten unverändert die bisherigen Werte: 175 € Grundzulage, 300/185 € Kinderzulage, 2.100 € Höchstbetrag, 4 % Mindestbeitrag. Wichtig: Vor dem 01.01.2027 abgeschlossene Verträge genießen Bestandsschutz und laufen mit der bisherigen Förderung weiter. Dieser Rechner bildet die geltende 2026- und Bestandslogik ab.',
      },
      {
        typ: 'vergleich',
        titel: 'Riester 2026 vs. geplante Reform ab 2027',
        spalteA: 'Riester 2026 (geltend)',
        spalteB: 'Reform ab 2027 (geplant)',
        zeilen: [
          { kriterium: 'Grundzulage', a: '175 € pauschal pro Jahr', b: 'beitragsproportional: 0,50 €/€ bis 360 €, dann 0,25 €/€ bis 1.800 € (max. 540 €)' },
          { kriterium: 'Kinderzulage', a: '300 € (ab 2008) / 185 € (davor)', b: 'volle 300 €/Kind ab 25 €/Monat Sparbeitrag' },
          { kriterium: 'Mindestbeitrag', a: '4 % Vorjahresbrutto, Sockel 60 €', b: 'pauschal 120 €/Jahr' },
          { kriterium: 'Berufseinsteiger', a: '200 € einmalig', b: '200 € Bonus (fortgeführt)' },
          { kriterium: 'Produkt', a: 'Garantiepflicht (100 % Beitragserhalt)', b: 'Altersvorsorgedepot ohne Garantiepflicht möglich' },
        ],
      },
      {
        typ: 'vergleich',
        titel: 'Riester-Rente vs. ETF-Sparplan',
        spalteA: 'Riester-Rente',
        spalteB: 'ETF-Sparplan',
        zeilen: [
          { kriterium: 'Staatliche Förderung', a: 'Zulagen + Steuervorteil', b: 'keine' },
          { kriterium: 'Renditechance', a: 'oft konservativ (Garantie)', b: 'höher, marktabhängig' },
          { kriterium: 'Kosten', a: 'teils hohe Verwaltungskosten', b: 'TER ab 0,1–0,2 %' },
          { kriterium: 'Flexibilität', a: 'gebunden bis zur Rente', b: 'jederzeit verfügbar' },
          { kriterium: 'Besteuerung der Rente', a: 'voll nachgelagert', b: 'nur Gewinn, 30 % Teilfreistellung' },
          { kriterium: 'Vererbbarkeit', a: 'eingeschränkt', b: 'uneingeschränkt' },
        ],
      },
      {
        typ: 'text',
        titel: 'Besteuerung in der Rentenphase und Kritikpunkte',
        html: `<p>Die Förderung in der Ansparphase hat eine Kehrseite: In der Auszahlungsphase wird die Riester-Rente <strong>voll nachgelagert besteuert</strong>. Die in der Ansparzeit steuerlich begünstigten Beiträge und die Zulagen werden also im Alter mit dem dann gültigen persönlichen Steuersatz belastet — der allerdings im Ruhestand meist niedriger liegt als im Erwerbsleben.</p><p>Kritisch gesehen werden vor allem die <strong>Kosten</strong> vieler Verträge: Abschluss- und Verwaltungsgebühren können einen erheblichen Teil der Förderung aufzehren. Auch die <strong>Vererbbarkeit</strong> ist eingeschränkt — stirbt der Sparer in der Ansparphase, geht das Guthaben nur an den Ehepartner förderunschädlich über; andere Erben müssen die erhaltene Förderung zurückzahlen.</p><p>Neben Riester gibt es weitere geförderte Wege: die <strong>Rürup-Rente</strong> (Basisrente, Beiträge voll absetzbar — ideal für Selbstständige) und die <strong>betriebliche Altersvorsorge</strong> mit Arbeitgeberzuschuss. Wie groß Ihre gesamte Versorgungslücke ist, zeigt der <a href="/finanzen/rentenrechner">Rentenrechner</a>.</p>`,
      },
      {
        typ: 'text',
        titel: 'Ruhen lassen, wechseln oder kündigen?',
        html: `<p>Was, wenn sich die Lebenssituation ändert? Ein Riester-Vertrag lässt sich <strong>beitragsfrei stellen</strong> — Sie pausieren die Einzahlungen, das angesparte Guthaben bleibt erhalten und wird weiter verzinst. Das ist etwa in der Elternzeit oder bei vorübergehend knappem Budget sinnvoll; die bereits erhaltene Förderung bleibt unangetastet.</p><p>Auch ein <strong>Anbieterwechsel</strong> ist möglich: Das Guthaben kann förderunschädlich auf einen anderen zertifizierten Riester-Vertrag übertragen werden. Das lohnt sich, wenn ein neuer Anbieter deutlich günstigere Kosten bietet — allerdings können Wechselgebühren anfallen, die man gegenrechnen sollte.</p><p>Anders die <strong>Kündigung mit Auszahlung</strong> vor dem Rentenalter: Sie gilt als <strong>förderschädliche Verwendung</strong> (§ 93 EStG). Sämtliche Zulagen und Steuervorteile müssen zurückgezahlt werden, nur die reinen Einzahlungen samt Erträgen bleiben. Wer aussteigen möchte, fährt deshalb meist besser, den Vertrag ruhen zu lassen, statt ihn zu kündigen.</p>`,
      },
      {
        typ: 'statistik',
        titel: 'Eckwerte zur Riester-Förderung 2026',
        werte: [
          { label: 'Grundzulage', wert: '175 €', hinweis: 'pro Person und Jahr (§ 84 EStG)' },
          { label: 'Kinderzulage (ab 2008)', wert: '300 €', hinweis: 'pro Kind/Jahr, solange Kindergeld' },
          { label: 'Höchstbetrag', wert: '2.100 €', hinweis: 'absetzbar inkl. Zulagen (§ 10a EStG)' },
          { label: 'Mindesteigenbeitrag', wert: '4 %', hinweis: 'des Vorjahresbruttos − Zulagen, Sockel 60 €' },
          { label: 'Reform-Umsetzung', wert: '01.01.2027', hinweis: 'Bestandsverträge behalten alte Förderung' },
        ],
      },
      {
        typ: 'checkliste',
        titel: 'Riester optimal nutzen',
        punkte: [
      ...
      },
      {
        typ: 'infobox',
        variante: 'warnung',
        titel: 'Vereinfachte Schätzung — keine Anlageberatung',
    ...
    quellen: [
      { titel: '§ 10a EStG: Zusätzliche Altersvorsorge (Höchstbetrag 2.100 €, Günstigerprüfung)', url: 'https://www.gesetze-im-internet.de/estg/__10a.html' },
      { titel: '§ 84 EStG: Grundzulage (175 €/Jahr)', url: 'https://www.gesetze-im-internet.de/estg/__84.html' },
      { titel: '§ 85 EStG: Kinderzulage (300 € ab 2008 / 185 € davor)', url: 'https://www.gesetze-im-internet.de/estg/__85.html' },
      { titel: 'BMF: Reform der privaten Altersvorsorge (Bestandsschutz, Umsetzung 01.01.2027)', url: 'https://www.bundesfinanzministerium.de/Content/DE/FAQ/reform-der-privaten-altersvorsorge.html', hinweis: 'Bundestag 27.03.2026, Bundesrat 08.05.2026; 2027er-Werte sind geplante Neuregelung, 2026 gelten unverändert die bisherigen Werte.' },
    ],
    affiliate: [
  ...
  },
  {
    ...
    beispiel: 'Beispiel: 200 € AG-Budget → Brutto-Erhöhung ≈ 109 € netto (StKl I). Als Essenszuschuss (115,05 € steuerfrei) ≈ 115,05 € netto — rund 6 € mehr pro Monat.',
...
**Essenszuschuss / Restaurantschecks — bis 7,67 €/Arbeitstag (2026):** Der Arbeitgeber kann für jeden Arbeitstag einen Zuschuss zum Mittagessen gewähren — die Obergrenze für 2026 liegt bei **7,67 € pro Tag** (amtlicher Sachbezugswert 4,57 € + steuerfreier Arbeitgeberzuschuss 3,10 €). Bei 15 Arbeitstagen pro Monat sind das **115,05 € steuerfrei**. Die Kosten werden meist über digitale Meal-Vouchers (z. B. Bonago, Sodexo, Pluxee) abgewickelt, die in Restaurants oder Supermärkten eingelöst werden können.
...
- Wie sich Kirchensteuer auf die Gesamtbelastung auswirkt`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Was die Abgeltungsteuer ist',
        html: `<p>Die <strong>Kapitalertragsteuer</strong> — meist <strong>Abgeltungsteuer</strong> genannt — ist die pauschale Steuer auf Einkünfte aus Kapitalvermögen: Zinsen, Dividenden, Kursgewinne und Fondserträge. Anders als beim progressiven Einkommensteuertarif gilt hier ein <strong>einheitlicher Satz von 25 %</strong> (§ 32d EStG), unabhängig von der Höhe des übrigen Einkommens. Hinzu kommen <strong>5,5 % Solidaritätszuschlag</strong> auf die Steuer und gegebenenfalls Kirchensteuer.</p><p>Den Abzug erledigt in der Regel die <strong>Bank automatisch</strong>: Sie behält die Steuer direkt ein und führt sie ans Finanzamt ab — daher der Name „Abgeltung". Damit ist die Steuer grundsätzlich erledigt, eine Angabe in der Steuererklärung ist meist nicht nötig. Zwei Stellschrauben senken die Belastung spürbar: der <strong>Sparerpauschbetrag</strong> und die <strong>Teilfreistellung</strong> bei Fonds. Beide zeigt dieser Rechner. Mit dem reinen Vermögensaufbau (ETF-Sparplanrechner) hat die Steuerfrage nichts zu tun — hier geht es allein um die Besteuerung der Erträge. Eingegeben werden die Ertragsart, die Höhe der Erträge, der Familienstand (für den Pauschbetrag), die Kirchensteuerpflicht und gegebenenfalls Verluste; daraus ergibt sich die geschätzte Steuer samt effektivem Steuersatz und Netto-Ertrag.</p>`,
      },
      {
        typ: 'text',
        titel: 'Der Sparerpauschbetrag — und der Freistellungsauftrag',
        html: `<p>Jeder Anleger hat einen jährlichen <strong>Sparerpauschbetrag</strong>: <strong>1.000 € für Singles</strong>, <strong>2.000 € für zusammenveranlagte Ehepaare</strong> (Stand 2026). Bis zu dieser Höhe bleiben Kapitalerträge komplett steuerfrei — erst der Teil darüber wird besteuert.</p><p>Damit die Bank die Erträge nicht vorschnell versteuert, braucht sie einen <strong>Freistellungsauftrag</strong>. Ohne ihn führt sie ab dem ersten Euro Abgeltungsteuer ab, und man muss zu viel gezahlte Steuer später über die Anlage KAP zurückholen. Der Pauschbetrag lässt sich auf mehrere Banken aufteilen — in der Summe darf er den Höchstbetrag aber nicht überschreiten, sonst drohen Rückfragen des Finanzamts. Wer mehrere Depots hat, sollte die Aufteilung also im Blick behalten. Der Freistellungsauftrag ist kostenlos und jederzeit änderbar; er gehört zu den einfachsten Steuer-Optimierungen überhaupt. Auch Ehepaare profitieren: Ein gemeinsamer Freistellungsauftrag bündelt beide Pauschbeträge zu 2.000 €, die flexibel über die Depots beider Partner verteilt werden können. Wer den Auftrag vergisst, verliert kein Geld endgültig — die zu viel einbehaltene Steuer lässt sich über die Anlage KAP zurückholen, nur eben mit Verzögerung und Aufwand.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Zinsen: 2.000 € (ledig)',
        schritte: [
          { label: 'Zinserträge', formel: '', ergebnis: '2.000 €' },
          { label: 'Teilfreistellung', formel: 'Zinsen: keine', ergebnis: '0 €' },
          { label: 'Sparerpauschbetrag (ledig)', formel: '', ergebnis: '− 1.000 €' },
          { label: 'steuerpflichtiger Ertrag', formel: '2.000 − 1.000', ergebnis: '1.000 €' },
          { label: 'Abgeltungsteuer', formel: '1.000 × 25 %', ergebnis: '250 €' },
          { label: 'Solidaritätszuschlag', formel: '250 × 5,5 %', ergebnis: '13,75 €' },
          { label: 'Steuer gesamt', formel: '250 + 13,75', ergebnis: '263,75 €' },
        ],
        fazit: 'Bei 2.000 € Zinsen schützt zunächst der Sparerpauschbetrag die ersten 1.000 € — nur die restlichen 1.000 € werden besteuert. Darauf fallen 25 % Abgeltungsteuer (250 €) plus 5,5 % Solidaritätszuschlag (13,75 €) an, zusammen 263,75 €. Netto bleiben 1.736,25 €. Der effektive Steuersatz auf den gesamten Ertrag liegt damit bei nur 13,2 %, weil der halbe Ertrag steuerfrei blieb. Zinsen und Dividenden genießen keine Teilfreistellung — hier wirkt allein der Pauschbetrag. Läge der Ertrag unter 1.000 €, fiele gar keine Steuer an; erst oberhalb des Pauschbetrags beginnt die Besteuerung mit dem vollen Satz von 26,375 %.',
      },
      {
        typ: 'tabelle',
        titel: 'Teilfreistellung je Anlageart (§ 20 InvStG)',
        kopf: ['Anlageart', 'steuerfrei (Teilfreistellung)', 'steuerpflichtig'],
        zeilen: [
          ['Aktienfonds / Aktien-ETF (≥ 51 %)', '30 %', '70 %'],
          ['Mischfonds (≥ 25 % Aktien)', '15 %', '85 %'],
          ['Zinsen, Anleihen', '0 %', '100 %'],
          ['Dividenden (Einzelwerte)', '0 %', '100 %'],
          ['Aktien-Kursgewinne (direkt)', '0 %', '100 %'],
        ],
        fussnote: 'Teilfreistellung für Privatanleger nach § 20 InvStG, Stand 2026. Sie gleicht die Vorbelastung auf Fondsebene aus: Bei Aktienfonds/-ETFs bleiben 30 % der Erträge steuerfrei, bei Mischfonds 15 %. Für direkt gehaltene Aktien, Dividenden und Zinsen gibt es keine Teilfreistellung — sie ist eine Besonderheit der Fonds. Immobilienfonds (60 %/80 %) bildet dieser Rechner nicht ab. Wichtig: Die Teilfreistellung wird vor dem Sparerpauschbetrag abgezogen — erst wird der steuerfreie Anteil herausgerechnet, dann der Pauschbetrag. Diese Reihenfolge entscheidet darüber, wie viel am Ende überhaupt steuerpflichtig bleibt.',
      },
      {
        typ: 'statistik',
        titel: 'Kapitalertragsteuer in Zahlen (2026)',
        werte: [
          { label: 'Abgeltungsteuer', wert: '25 %', hinweis: '+ 5,5 % Soli → effektiv 26,375 %' },
          { label: 'Sparerpauschbetrag', wert: '1.000 / 2.000 €', hinweis: 'ledig / verheiratet, pro Jahr' },
          { label: 'Teilfreistellung Aktien-ETF', wert: '30 %', hinweis: 'Mischfonds 15 %' },
          { label: 'Effektivsatz Aktien-ETF', wert: '≈ 18,5 %', hinweis: 'ohne Pauschbetrag (0,7 × 26,375 %)' },
        ],
      },
      {
        typ: 'beispielrechnung',
        titel: 'Aktien-ETF: 2.000 € (ledig)',
        schritte: [
          { label: 'ETF-Erträge', formel: '', ergebnis: '2.000 €' },
          { label: 'Teilfreistellung (30 %)', formel: '2.000 × 30 %', ergebnis: '− 600 €' },
          { label: 'nach Teilfreistellung', formel: '2.000 − 600', ergebnis: '1.400 €' },
          { label: 'Sparerpauschbetrag (ledig)', formel: '', ergebnis: '− 1.000 €' },
          { label: 'steuerpflichtiger Ertrag', formel: '1.400 − 1.000', ergebnis: '400 €' },
          { label: 'Steuer (25 % + Soli)', formel: '400 × 26,375 %', ergebnis: '105,50 €' },
        ],
        fazit: 'Bei einem Aktien-ETF bleiben dank der 30-prozentigen Teilfreistellung von 2.000 € Ertrag schon 600 € steuerfrei. Vom Rest ziehen wir den Sparerpauschbetrag von 1.000 € ab — übrig bleiben nur 400 € steuerpflichtig. Darauf fallen 25 % Abgeltungsteuer plus Soli an, zusammen 105,50 €. Netto bleiben 1.894,50 €, der effektive Steuersatz beträgt nur 5,3 %. Genau diese Kombination aus Teilfreistellung und Pauschbetrag macht den Aktien-ETF steuerlich attraktiv — derselbe Ertrag aus Zinsen hätte 263,75 € gekostet, also mehr als das Doppelte. Wäre der Pauschbetrag bereits anderweitig ausgeschöpft, läge die Steuer bei 1.400 € × 26,375 % = 369,25 € — und der effektive Satz bei den oben genannten rund 18,5 %.',
      },
      {
        typ: 'text',
        titel: 'Warum ETF-Erträge effektiv weniger belastet werden',
        html: `<p>Der niedrige effektive Steuersatz im Beispiel entsteht durch zwei Effekte. Erstens den <strong>Sparerpauschbetrag</strong>, der die ersten 1.000 € schützt. Zweitens — und dauerhaft — die <strong>Teilfreistellung</strong>: Bei Aktienfonds und Aktien-ETFs werden nur 70 % der Erträge überhaupt besteuert. Der Grund ist ein Ausgleich: Die Unternehmen im Fonds zahlen bereits Körperschaftsteuer, die Teilfreistellung mildert diese Vorbelastung beim Anleger.</p><p>Ist der Sparerpauschbetrag bereits ausgeschöpft, zeigt sich der reine Teilfreistellungs-Effekt: Statt 26,375 % werden auf Aktien-ETF-Erträge effektiv nur rund <strong>18,5 %</strong> fällig (70 % × 26,375 %). Auf 10.000 € ETF-Gewinn ohne verbleibenden Pauschbetrag sind das etwa 1.846 € statt 2.638 € bei Zinsen. Dieser strukturelle Vorteil gilt unabhängig von der Höhe und ist einer der Gründe, warum breit streuende Aktien-ETFs auch steuerlich beliebt sind. Bei Mischfonds fällt der Effekt mit 15 % Teilfreistellung schwächer aus, bei reinen Renten- oder Geldmarktfonds entfällt er ganz. Maßgeblich ist die tatsächliche Aktienquote des Fonds — sie steht in den Anlagebedingungen und entscheidet, welche Teilfreistellung das Finanzamt anerkennt. Die Bank wendet die passende Quote in der Regel automatisch an, sodass man sich darum nicht selbst kümmern muss.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Mit Kirchensteuer: die ÷ (4 + k)-Formel',
        schritte: [
          { label: 'steuerpflichtiger Ertrag (Zinsen)', formel: '', ergebnis: '1.000 €' },
          { label: 'Abgeltungsteuer mit KiSt 9 %', formel: '1.000 ÷ (4 + 0,09)', ergebnis: '244,50 €' },
          { label: 'Solidaritätszuschlag', formel: '244,50 × 5,5 %', ergebnis: '13,45 €' },
          { label: 'Kirchensteuer', formel: '244,50 × 9 %', ergebnis: '22,00 €' },
          { label: 'Steuer gesamt', formel: '244,50 + 13,45 + 22,00', ergebnis: '279,95 €' },
        ],
        fazit: 'Kirchensteuer auf Kapitalerträge wird nicht einfach obendrauf gerechnet. Weil sie selbst die Bemessungsgrundlage mindert (§ 32d EStG), sinkt die Abgeltungsteuer leicht: Statt 250 € sind es nur 244,50 € (Formel: steuerpflichtiger Ertrag ÷ (4 + Kirchensteuersatz als Dezimalzahl), hier ÷ 4,09). Darauf kommen Soli und Kirchensteuer, zusammen 279,95 €. Eine naive Rechnung „250 € + 9 %" wäre also falsch — der Rechner nutzt die korrekte Formel automatisch. In Bayern und Baden-Württemberg (8 %) fällt die Belastung minimal geringer aus, dort lautet der Teiler 4,08. Unterm Strich erhöht die Kirchensteuer die effektive Gesamtbelastung von 26,375 % auf rund 27,82 % (8 %) bzw. 27,99 % (9 %) — spürbar, aber dank der Abzugsfähigkeit weniger als der nominale Kirchensteuersatz vermuten ließe.',
      },
      {
        typ: 'text',
        titel: 'Verlustverrechnung und Günstigerprüfung',
        html: `<p><strong>Verluste</strong> aus Kapitalanlagen werden mit Gewinnen verrechnet, aber in getrennten „Töpfen": Verluste aus <strong>direkt gehaltenen Aktien</strong> dürfen nur mit Aktien-Kursgewinnen verrechnet werden (§ 20 Abs. 6 EStG), alle übrigen Verluste (ETF, Anleihen u. a.) mit allen anderen Kapitalerträgen. Die Bank führt diese Töpfe automatisch; bei mehreren Depots braucht es eine Verlustbescheinigung (Frist 15. Dezember).</p><p>Die <strong>Günstigerprüfung</strong> lohnt für alle mit niedrigem persönlichem Steuersatz: Wer mit seinem zu versteuernden Einkommen unter etwa 18.000 € (Single) liegt, zahlt regulär weniger als 25 %. Über die Anlage KAP prüft das Finanzamt, ob der persönliche Tarif günstiger ist, und erstattet die Differenz — typisch für Studierende, Rentner und Geringverdiener. Der Antrag kostet nichts und kann nicht zum Nachteil ausfallen: Das Finanzamt wendet automatisch die für den Anleger günstigere Variante an. Ein häufiger Fehler ist, Verlustbescheinigungen über die Jahresgrenze zu verschenken: Wer Depots bei mehreren Banken hat und Verluste übergreifend verrechnen will, muss die Bescheinigung bis zum 15. Dezember beantragen — sonst bleiben die Verluste im jeweiligen Depot gefangen und lassen sich nur dort mit künftigen Gewinnen verrechnen.</p>`,
      },
      {
        typ: 'checkliste',
        titel: 'Was die Kapitalertragsteuer bestimmt',
        punkte: [
...
IT-Freelancer kommen mit 800–1.200 € Fixkosten aus (Home-Office, Cloud-Tools, Haftpflicht). Handwerker und Dienstleister mit Fahrzeug und Werkzeug rechnen mit 1.500–3.000 €. Einzelhändler und Gastronomen zahlen oft 3.000–8.000 € allein für Miete, Wareneinsatz und Personal. Vergleichen Sie Ihre Kosten regelmäßig mit Branchendurchschnitten, um Einsparpotenzial zu erkennen.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Was sind betriebliche Betriebskosten?',
        html: `<p>Mit <strong>Betriebskosten</strong> sind hier die laufenden Kosten eines Unternehmens oder Selbstständigen gemeint — also alles, was Monat für Monat anfällt, um den Betrieb am Laufen zu halten: Büro, Versicherungen, Software, Buchhaltung, Material, Marketing und der eigene Lohn. Das ist <strong>nicht zu verwechseln</strong> mit den Wohn-Nebenkosten einer Mietwohnung (Heizung, Wasser, Müll nach Betriebskostenverordnung) — dafür gibt es eigene Rechner in der Kategorie Wohnen.</p><p>Ziel dieses Rechners ist das <strong>Vollkostenbild</strong> eines Betriebs: Was kostet er pro Monat und Jahr wirklich, und welcher Umsatz beziehungsweise Stundensatz ist nötig, um kostendeckend zu arbeiten? Damit geht er über den reinen <strong>Freelancer-Stundensatz-Rechner</strong> hinaus, der nur den Stundensatz im Blick hat — hier steht die komplette Kostenstruktur im Mittelpunkt, aus der sich der Stundensatz erst ergibt. Die Eingaben sind individuell; die hier genannten Spannen dienen nur als Orientierung beim Ausfüllen und ersetzen keine Beratung. Wer mehrere Preismodelle oder Auftragslagen durchspielen will, ändert einfach die Eingaben und sieht sofort, wie sich der nötige Stundensatz verschiebt.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Fixkostenarten mit typischen Spannen',
        kopf: ['Fixkosten-Position', 'typ. Bereich €/Monat', 'Hinweis'],
        zeilen: [
          ['Miete / Büro', '0–1.500 €', 'Homeoffice oft 0, Coworking/Studio mehr'],
          ['Versicherungen', '50–400 €', 'Betriebs-/Berufshaftpflicht u. a.'],
          ['Software / Tools', '20–300 €', 'Abos für Buchhaltung, Design, Cloud'],
          ['Telefon / Internet', '30–100 €', 'geschäftlicher Anteil'],
          ['Buchhaltung / Steuerberater', '50–400 €', 'je nach Umfang und Rechtsform'],
          ['Sonstige Fixkosten', '0–300 €', 'Kammerbeiträge, Abos, Leasing'],
        ],
        fussnote: 'Richtwerte für Solo-Selbstständige und kleine Betriebe (Stand 2026); die tatsächlichen Beträge schwanken stark nach Branche, Standort und Rechtsform. Fixkosten fallen unabhängig vom Auftragsvolumen jeden Monat an — sie sind das, was der Betrieb auch ohne einen einzigen Auftrag kostet. Typische Gesamt-Fixkosten eines Freelancers liegen grob zwischen 800 und 1.500 Euro im Monat, bei einer GmbH mit eigenem Büro deutlich darüber. Der Rechner summiert diese sechs Positionen zu den gesamten Fixkosten.',
      },
      {
        typ: 'tabelle',
        titel: 'Variable Kostenarten mit typischen Spannen',
        kopf: ['Variable Position', 'typ. Bereich €/Monat', 'Hinweis'],
        zeilen: [
          ['Material / Wareneinsatz', '0–2.000 €', 'stark branchenabhängig (Handwerk hoch, Beratung null)'],
          ['Fahrtkosten', '0–400 €', 'Sprit, ÖPNV, Bahn zu Kundenterminen'],
          ['Marketing', '0–500 €', 'Website, Anzeigen, Netzwerk-Events'],
        ],
        fussnote: 'Variable Kosten steigen und fallen mit dem Auftragsvolumen und lassen sich schwerer planen als Fixkosten; ein Puffer von 10 bis 20 Prozent ist empfehlenswert. Bei reinen Dienstleistern (Beratung, Text, Design) sind die variablen Kosten oft sehr niedrig, bei Handwerk oder Handel mit hohem Wareneinsatz dagegen der größte Block. Der Rechner addiert Material, Fahrtkosten und Marketing zu den gesamten variablen Kosten. Wer projektbezogen sehr unterschiedliche Materialkosten hat, rechnet am besten mit einem Monatsdurchschnitt.',
      },
      {
        typ: 'text',
        titel: 'Unternehmerlohn — das eigene Gehalt einplanen',
        html: `<p>Der häufigste Fehler in der Kalkulation: den eigenen Lohn vergessen. Der <strong>Unternehmerlohn</strong> ist kein Gewinn, sondern das Gehalt, das Sie sich selbst zahlen — er muss Ihre privaten Lebenshaltungskosten, die Krankenversicherung und die Altersvorsorge decken. In der Vollkostenrechnung gehört er deshalb fest zu den Kosten, genau wie Miete oder Versicherung.</p><p>Wer den Unternehmerlohn weglässt, rechnet sich arm: Der Stundensatz erscheint niedrig, deckt aber nur die Sachkosten und lässt für das eigene Leben nichts übrig. Wichtig ist außerdem, dass der Unternehmerlohn das geplante <strong>Brutto-Eigengehalt</strong> ist — Einkommensteuer und Sozialabgaben gehen davon noch ab. Wer netto 2.000 Euro zum Leben braucht, sollte den Unternehmerlohn entsprechend höher ansetzen. Dieser Rechner behandelt den Unternehmerlohn als eigene Position, sodass sofort sichtbar wird, welchen Anteil er an den Gesamtkosten hat — bei vielen Solo-Selbstständigen ist er der mit Abstand größte Posten. Die saubere Trennung zwischen Unternehmerlohn und Gewinn hilft auch, Preise selbstbewusst zu verhandeln, statt sich über den eigenen Stundensatz kleinzurechnen.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Freelancer: vom Kostenbild zum Stundensatz',
        schritte: [
          { label: 'Fixkosten/Monat', formel: '500 + 200 + 100 + 60 + 150 + 100', ergebnis: '1.110 €' },
          { label: 'Variable Kosten/Monat', formel: 'Material 0 + Fahrt 100 + Marketing 200', ergebnis: '300 €' },
          { label: 'Unternehmerlohn/Monat', formel: 'geplantes Eigengehalt', ergebnis: '3.000 €' },
          { label: 'Gesamtkosten/Monat', formel: '1.110 + 300 + 3.000', ergebnis: '4.410 €' },
          { label: 'Nötiger Jahresumsatz (netto)', formel: '4.410 × 12', ergebnis: '52.920 €' },
          { label: 'Nötiger Stundensatz', formel: '52.920 ÷ 1.400 h', ergebnis: '≈ 37,80 €' },
        ],
        fazit: 'Das Beispiel rechnet einen typischen Solo-Freelancer durch: 1.110 Euro Fixkosten, 300 Euro variable Kosten und 3.000 Euro Unternehmerlohn ergeben 4.410 Euro Gesamtkosten pro Monat. Übers Jahr sind das 52.920 Euro, die als Netto-Umsatz hereinkommen müssen — mit 19 Prozent Mehrwertsteuer entspricht das rund 5.248 Euro Brutto-Umsatz pro Monat. Geteilt durch 1.400 fakturierbare Stunden im Jahr ergibt sich ein nötiger Stundensatz von etwa 37,80 Euro netto. Das ist die Untergrenze, um kostendeckend zu arbeiten und den geplanten Lohn zu erreichen — von diesem Lohn gehen Einkommensteuer und Sozialabgaben noch ab. Wer Gewinn erwirtschaften oder Rücklagen bilden will, muss den Stundensatz höher ansetzen. Alle Werte lassen sich im Rechner an die eigene Situation anpassen.',
      },
      {
        typ: 'tabelle',
        titel: 'Nötiger Stundensatz nach Jahreskosten',
        kopf: ['Jahreskosten (netto)', 'Stundensatz netto (÷ 1.400 h)', 'mit 19 % MwSt'],
        zeilen: [
          ['30.000 €', '≈ 21,43 €', '≈ 25,50 €'],
          ['40.000 €', '≈ 28,57 €', '≈ 34,00 €'],
          ['50.000 €', '≈ 35,71 €', '≈ 42,50 €'],
        ...
        fussnote: 'Nötiger Stundensatz = Jahreskosten ÷ 1.400 fakturierbare Stunden (Annahme des Rechners). Die Netto-Werte sind die Untergrenze zur Kostendeckung; die rechte Spalte zeigt den Betrag inklusive 19 Prozent Mehrwertsteuer, wie er auf der Kundenrechnung steht. Wer weniger als 1.400 Stunden abrechnet, braucht bei gleichen Jahreskosten einen höheren Satz: Bei 1.000 Stunden läge der Netto-Satz für 52.920 Euro Jahreskosten bereits bei rund 52,92 Euro statt 37,80 Euro.',
      },
      {
        typ: 'text',
        titel: 'Fakturierbare Stunden — warum nicht alle Stunden zählen',
        html: `<p>Ein Stundensatz lässt sich nur sinnvoll berechnen, wenn klar ist, wie viele Stunden im Jahr überhaupt <strong>abrechenbar</strong> sind. Ein Angestellter arbeitet rund 1.600 bis 1.700 Stunden im Jahr; bei Selbstständigen ist nur ein Teil davon fakturierbar, also direkt einem zahlenden Kunden zuzuordnen. Akquise, Angebote, Buchhaltung, Weiterbildung, Urlaub und Krankheit lassen sich nicht in Rechnung stellen.</p><p>Dieser Rechner setzt als Annahme <strong>1.400 fakturierbare Stunden pro Jahr</strong> an — das entspricht grob 35 abrechenbaren Stunden in 40 Arbeitswochen. Das ist ein realistischer, aber bewusst gewählter Richtwert, kein gesetzlicher Standard: Je nach Branche, Auslastung und Organisation kann der Wert deutlich darunter oder darüber liegen. Wer nur 1.000 Stunden abrechnet, muss denselben Jahresumsatz auf weniger Stunden verteilen und braucht entsprechend einen höheren Stundensatz. Es lohnt sich, die eigene fakturierbare Quote ehrlich zu schätzen — sie ist der größte Hebel beim Stundensatz und wird von Gründern fast immer zu hoch angesetzt. Auch unbezahlte Gewährleistung, Reisezeiten und Leerlauf zwischen Projekten zählen zu den nicht fakturierbaren Stunden und gehören in die Schätzung.</p>`,
      },
      {
        typ: 'text',
        titel: 'Vom Kostenbild zum nötigen Umsatz',
        html: `<p>Aus den Gesamtkosten ergibt sich direkt der <strong>nötige Umsatz</strong>: Was der Betrieb pro Monat kostet, muss mindestens als Netto-Umsatz hereinkommen, damit er sich trägt. Im Beispiel sind das 4.410 Euro netto im Monat. Dieser Wert ist der <strong>Break-even</strong> — die Schwelle, ab der die Arbeit kostendeckend ist; alles darüber ist Gewinn oder Rücklage.</p><p>Wichtig ist die Unterscheidung zwischen <strong>netto und brutto</strong>: Der nötige Umsatz wird zunächst netto berechnet, also ohne Mehrwertsteuer. Auf Rechnungen an Kunden kommt die Umsatzsteuer obendrauf — bei 19 Prozent entspricht der monatliche Netto-Bedarf von 4.410 Euro einem Brutto-Umsatz von rund 5.248 Euro. Die Mehrwertsteuer ist allerdings ein durchlaufender Posten, den das Unternehmen ans Finanzamt weiterreicht; sie erhöht den eigenen Verdienst nicht. Für die Preisgestaltung zählt deshalb der Netto-Umsatz, für die Rechnung an den Kunden der Brutto-Betrag. Kleinunternehmer ohne Umsatzsteuer-Ausweis rechnen direkt mit den Netto-Werten.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Geschäftsform und Kostenstruktur',
        kopf: ['Geschäftsform', 'Besonderheit der Kostenstruktur', 'Hinweis'],
        zeilen: [
          ['Freelancer / Einzelunternehmen', 'Unternehmerlohn = Privatentnahme, keine Gehaltsabrechnung', 'Einkommensteuer; ggf. Kleinunternehmerregelung'],
          ['UG (haftungsbeschränkt)', 'Geschäftsführergehalt + Rücklagenpflicht (25 % des Gewinns)', 'Körperschaftsteuer; Stammkapital ab 1 €'],
          ['GmbH', 'Geschäftsführergehalt, höhere Buchhaltungs-/Beratungskosten', 'Körperschaftsteuer; Stammkapital 25.000 €'],
        ],
        fussnote: 'Die Kostenlogik dieses Rechners ist für alle drei Formen identisch — er addiert Fix- und variable Kosten plus Unternehmerlohn und leitet daraus den nötigen Umsatz und Stundensatz ab. Die Rechtsform ändert vor allem die steuerliche Behandlung und einzelne Kostenarten (etwa Buchhaltung, Notar, Geschäftsführergehalt), nicht die Grundrechnung. Welche Form steuerlich und haftungsrechtlich passt, klärt eine Steuer- oder Rechtsberatung — das ist nicht Aufgabe dieses Rechners.',
      },
      {
        typ: 'statistik',
        titel: 'Kennzahlen für die Kalkulation',
        werte: [
          { label: 'Fakturierbare Stunden/Jahr (Annahme)', wert: '1.400 h', hinweis: '≈ 35 h × 40 Wochen, Richtwert' },
          { label: 'Typische Fixkosten Freelancer', wert: '≈ 800–1.500 €/Monat', hinweis: 'ohne Unternehmerlohn' },
          { label: 'Unternehmerlohn (Großstadt)', wert: '≈ 2.500–3.500 €/Monat', hinweis: 'Brutto-Eigengehalt, Richtwert' },
          { label: 'MwSt-Aufschlag auf Netto-Umsatz', wert: '19 %', hinweis: 'Regelsteuersatz; ermäßigt 7 % möglich' },
          { label: 'Faustregel Stundensatz', wert: 'Jahreskosten ÷ 1.400', hinweis: 'netto, vor Einkommensteuer' },
        ],
      },
      {
        typ: 'checkliste',
        titel: 'Vollständige Kostenerfassung — nichts vergessen',
        punkte: [
...
Für die meisten Arbeitnehmer ist der Minijob die attraktivste Option — 100 % netto bei null Bürokratie. Wer mehr verdienen möchte, sollte prüfen, ob ein selbstständiger Nebenjob günstiger ist als Steuerklasse VI: Durch den Wegfall der Sozialversicherung bleibt trotz höherem Steuersatz oft mehr übrig.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Was ein Nebenjob ist',
        html: `<p>Wer neben dem Hauptberuf etwas dazuverdienen möchte, hat <strong>drei Wege</strong> — und sie unterscheiden sich steuerlich erheblich. Als <strong>Minijob</strong> (bis 603 €/Monat) bleibt der Verdienst für den Arbeitnehmer abgabenfrei. Auf <strong>Steuerkarte</strong> läuft jeder weitere Job in <strong>Steuerklasse VI</strong> mit hohem Abzug. Und ein <strong>selbstständiger</strong> Nebenjob wird zum übrigen Einkommen hinzugerechnet und mit dem persönlichen Steuersatz belastet.</p><p>Welche Variante netto am meisten übrig lässt, hängt vor allem von der Höhe des Nebenverdienstes ab. Dieser Rechner stellt die Arten gegenüber und zeigt den Netto-Zuwachs neben einem bestehenden Hauptjob. Den Hauptjob selbst schätzt er vereinfacht in Steuerklasse I; die vollständige Lohnabrechnung übernimmt der Brutto-Netto-Rechner. Anders als beim Midijob geht es hier nicht um einen einzelnen Job im Übergangsbereich, sondern um die <strong>Kombination</strong> aus Haupt- und Nebenbeschäftigung. Eingegeben werden das Hauptjob-Brutto, die Art des Nebenjobs und dessen Verdienst; der Rechner zeigt dann, wie viel vom Nebenverdienst nach Steuern und Sozialabgaben übrig bleibt und wie stark das Haushaltsnetto insgesamt steigt.</p>`,
      },
      {
        typ: 'vergleich',
        titel: 'Minijob vs. Steuerkarte (Nebenjob 450 €, Hauptjob 3.500 €)',
        spalteA: 'Minijob (bis 603 €)',
        spalteB: 'Steuerkarte (Steuerklasse VI)',
        zeilen: [
          { kriterium: 'Lohnsteuer', a: '0 € (pauschal beim Arbeitgeber)', b: '112,50 € (25 %)' },
          { kriterium: 'Sozialversicherung (AN)', a: '0 €', b: '91,80 € (20,4 %)' },
          { kriterium: 'Netto vom 450-€-Nebenjob', a: '450 €', b: '245,70 €' },
          { kriterium: 'Abgabenbelastung', a: '0 %', b: '45,4 %' },
          { kriterium: 'Voraussetzung', a: 'nur EIN Minijob neben dem Hauptjob', b: 'für jeden weiteren Job' },
        ],
      },
      {
        typ: 'text',
        titel: 'Der Minijob neben dem Hauptjob',
        html: `<p>Der <strong>Minijob</strong> ist der einfachste Nebenverdienst: Bis zur Geringfügigkeitsgrenze von <strong>603 €/Monat</strong> (2026, an den Mindestlohn gekoppelt) fallen für den Arbeitnehmer <strong>keine Steuern und keine Sozialversicherungsbeiträge</strong> an. Der Arbeitgeber führt pauschale Abgaben ab; das Netto entspricht dem Brutto.</p><p>Entscheidend ist die Regel „<strong>nur ein Minijob</strong>" neben dem Hauptjob: Der erste Minijob bleibt steuerfrei, jeder weitere wird mit dem Hauptjob zusammengerechnet und wie ein Job auf Steuerkarte (Klasse VI) behandelt. Auch mehrere Minijobs ohne sozialversicherungspflichtigen Hauptjob werden zusammengezählt — überschreiten sie zusammen 603 €, entsteht ein Midijob oder eine reguläre Beschäftigung. Standardmäßig ist der Minijob rentenversicherungspflichtig (3,6 % Eigenanteil); davon kann man sich befreien lassen, verzichtet dann aber auf die kleinen Rentenansprüche. Für den Arbeitgeber ist der Minijob mit pauschalen Abgaben von rund 30 % vergleichsweise teuer — für den Arbeitnehmer ist er dafür die einzige Variante, bei der brutto gleich netto ist. Genau das macht ihn als Nebenverdienst so beliebt.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Hauptjob 3.500 € + Minijob 450 €',
        schritte: [
          { label: 'Hauptjob brutto', formel: '', ergebnis: '3.500 €' },
          { label: 'Hauptjob netto (Klasse I, geschätzt)', formel: '', ergebnis: '2.118,58 €' },
          { label: 'Minijob brutto', formel: 'bis 603 € pauschal', ergebnis: '450 €' },
          { label: 'Minijob netto', formel: 'für AN steuer- und abgabenfrei', ergebnis: '450 €' },
          { label: 'Haushaltsnetto gesamt', formel: '2.118,58 + 450', ergebnis: '2.568,58 €' },
        ],
        fazit: 'Der Minijob neben dem Hauptjob ist für den Arbeitnehmer komplett abgaben- und steuerfrei: Vom 450-€-Nebenverdienst bleiben volle 450 € — der Arbeitgeber führt nur Pauschalabgaben ab. Das Haushaltsnetto steigt um genau diesen Betrag auf 2.568,58 €. Wichtig: Pro Person ist nur EIN steuerfreier Minijob neben dem Hauptjob erlaubt; ein zweiter würde mit dem ersten zusammengerechnet und wie ein Job auf Steuerkarte (Klasse VI) behandelt. Optional bleibt der Minijob rentenversicherungspflichtig (3,6 % Eigenanteil), wovon man sich befreien lassen kann. Würde derselbe Nebenverdienst über Steuerkarte laufen, blieben statt 450 € nur 245,70 € — ein Unterschied von über 200 € im Monat, der den Minijob für kleine Nebenverdienste klar überlegen macht.',
      },
      {
        typ: 'statistik',
        titel: 'Nebenjob auf einen Blick (2026)',
        werte: [
          { label: 'Minijob-Grenze', wert: '603 €/Monat', hinweis: 'für den Arbeitnehmer abgabenfrei' },
          { label: 'Steuerklasse VI', wert: 'kein Grundfreibetrag', hinweis: 'Lohnsteuer ab dem ersten Euro' },
          { label: 'Härteausgleich (selbstständig)', wert: '410 €/Jahr', hinweis: 'bis dahin steuerfrei' },
          { label: 'Belastung SK VI (Beispiel)', wert: '≈ 45 %', hinweis: '25 % Lohnsteuer + ~20 % Sozialversicherung' },
        ],
      },
      {
        typ: 'text',
        titel: 'Steuerklasse VI: warum der Abzug so hoch ist',
        html: `<p>Sobald ein zweiter <strong>sozialversicherungspflichtiger</strong> Job dazukommt, läuft er über <strong>Steuerklasse VI</strong>. Deren Besonderheit: Es gibt <strong>keinen Grundfreibetrag und keinen Arbeitnehmer-Pauschbetrag</strong> — Lohnsteuer fällt vom ersten Euro an. Der Grund ist, dass diese Freibeträge bereits beim Hauptjob berücksichtigt werden und nicht doppelt zählen dürfen.</p><p>Dazu kommen die <strong>vollen Sozialversicherungsbeiträge</strong> (rund 20 % Arbeitnehmeranteil). In der Summe gehen von einem Steuerkarten-Nebenjob oft etwa 45 % ab. Das wirkt abschreckend, ist aber nur die halbe Wahrheit: Die Lohnsteuer in Klasse VI ist bewusst hoch angesetzt, und über die <strong>Pflicht-Steuererklärung</strong> holt man sich häufig einen Teil zurück. Trotzdem bleibt netto deutlich weniger als beim Minijob — weshalb sich bei höherem Nebenverdienst der Blick auf die selbstständige Variante lohnen kann. Steuerklasse VI ist übrigens keine Strafe, sondern nur eine Vorauszahlung: Weil das Finanzamt beim zweiten Job nicht weiß, wie hoch das Gesamteinkommen ist, hält es vorsichtshalber viel zurück. Den Ausgleich bringt die Jahresveranlagung.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Nebenjob-Netto: Minijob vs. Steuerkarte (Hauptjob 3.500 €)',
        kopf: ['Nebenjob brutto', 'als Minijob', 'auf Steuerkarte (SK VI)', 'Belastung SK VI'],
        zeilen: [
          ['450 €', '450 €', '245,70 €', '45,4 %'],
          ['600 €', '600 €', '327,60 €', '45,4 %'],
        ...
        fussnote: 'Hauptjob 3.500 €, kinderlos, ohne Kirchensteuer, Stand 2026. Der Minijob ist nur bis 603 € möglich und bleibt für den Arbeitnehmer komplett abgabenfrei. Auf Steuerkarte (Steuerklasse VI) gehen dagegen rund 45 % ab — 25 % Lohnsteuer (kein Grundfreibetrag) plus etwa 20 % Sozialversicherung. Die Lohnsteuer in Klasse VI ist häufig zu hoch angesetzt; über die Pflicht-Steuererklärung kommt oft ein Teil zurück. Die SK-VI-Werte sind eine vereinfachte Schätzung des Rechners. Auffällig ist die konstante Belastung von 45,4 %: Da Klasse VI keinen Grundfreibetrag kennt, steigt der Abzug proportional mit dem Verdienst — anders als beim Hauptjob, wo der Grundfreibetrag die ersten Einkommensteile schützt.',
      },
      {
        typ: 'vergleich',
        titel: 'Selbstständiger Nebenjob vs. Steuerkarte',
        spalteA: 'Selbstständig (Freelance)',
        spalteB: 'Anstellung (Steuerklasse VI)',
        zeilen: [
          { kriterium: 'Sozialversicherung', a: 'keine (SV nur im Hauptjob)', b: 'volle AN-Beiträge (~20,4 %)' },
          { kriterium: 'Besteuerung', a: 'Grenzsteuersatz auf die Zusatzeinkünfte', b: '25 % pauschal (Klasse VI)' },
          { kriterium: 'Netto aus 450 € (Hauptjob 3.500 €)', a: '302,17 €', b: '245,70 €' },
          { kriterium: 'Netto aus 1.000 €', a: '660,08 €', b: '546,00 €' },
          { kriterium: 'Steuerfreigrenze', a: '410 €/Jahr Härteausgleich', b: 'keine — Steuer ab dem ersten Euro' },
          { kriterium: 'Risiko', a: 'Scheinselbstständigkeit beachten', b: 'hohe Vorauszahlung, später Erstattung' },
          { kriterium: 'Pflichten', a: 'Steuererklärung + EÜR', b: 'Steuererklärung (oft Erstattung)' },
        ],
      },
      {
        typ: 'text',
        titel: 'Das Zusammenspiel mit dem Hauptjob',
        html: `<p>Der Nebenjob ändert nichts an der Abrechnung des <strong>Hauptjobs</strong> — der läuft unverändert in seiner Steuerklasse weiter. Was sich ändert, ist die <strong>Gesamtbetrachtung</strong> am Jahresende: Alle Einkünfte zusammen bestimmen den persönlichen Steuersatz, und ein Steuerkarten- oder selbstständiger Nebenjob kann zu einer Nachzahlung oder (bei Klasse VI) zu einer Erstattung führen.</p><p>Wichtig ist die <strong>Zusammenrechnung</strong> mehrerer geringfügiger Jobs: Wer zwei Minijobs neben dem Hauptjob hat, verliert beim zweiten die Steuerfreiheit. Selbstständige Nebeneinkünfte bis <strong>410 € im Jahr</strong> bleiben dank Härteausgleich steuerfrei; darüber wird die Differenz fällig. Wer regelmäßig dazuverdient, sollte die Steuererklärung von vornherein einplanen und Belege sammeln — gerade bei der selbstständigen Variante lässt sich über Betriebsausgaben die Steuerlast senken. Auch arbeitsrechtlich gibt es Grenzen: Der Hauptarbeitgeber darf einen Nebenjob nur bei direkter Konkurrenz oder bei Verstößen gegen die Arbeitszeitvorgaben untersagen, verlangt aber häufig eine Anzeige. Ein Blick in den Arbeitsvertrag lohnt sich vorab. Zu beachten ist außerdem die Arbeitszeit: Haupt- und Nebenjob zusammen dürfen die gesetzlichen Höchstgrenzen des Arbeitszeitgesetzes nicht dauerhaft überschreiten.</p>`,
      },
      {
        typ: 'text',
        titel: 'Häufige Irrtümer beim Nebenjob',
        html: `<p>Drei Missverständnisse halten sich hartnäckig. Erstens: „Ein Minijob ist immer steuerfrei." Das stimmt nur für <strong>einen</strong> Minijob neben dem Hauptjob — jeder weitere wird zusammengerechnet und ganz normal besteuert. Zweitens: „Steuerklasse VI bedeutet höhere Steuer." Tatsächlich ist die <strong>Jahressteuer</strong> dieselbe; Klasse VI hält nur unterjährig mehr zurück, der Rest kommt über die Veranlagung zurück.</p><p>Drittens: „Selbstständig lohnt sich immer mehr." Das gilt zwar oft, weil die Sozialversicherung entfällt — aber nur, solange die Tätigkeit tatsächlich selbstständig ist und nicht in eine <strong>Scheinselbstständigkeit</strong> rutscht. Wer dauerhaft weisungsgebunden für einen Auftraggeber arbeitet, kann nachträglich als Angestellter eingestuft werden, mit Beitragsnachforderungen. Im Zweifel klärt eine Statusfeststellung der Deutschen Rentenversicherung, wie die Tätigkeit einzuordnen ist. Ein vierter Irrtum betrifft die Bürokratie: Auch beim Minijob darf man nicht beliebig viele parallel haben — sobald mehrere zusammen die 603-€-Grenze sprengen, fällt die Pauschalbesteuerung weg, und es greifen die normalen Regeln.</p>`,
      },
      {
        typ: 'checkliste',
        titel: 'Welche Nebenjob-Art zur eigenen Situation passt',
        punkte: [
...
Sowohl Schenker als auch Beschenkter müssen die Schenkung innerhalb von drei Monaten beim zuständigen Finanzamt anzeigen. Notariell beurkundete Schenkungen (z. B. Immobilien) werden automatisch vom Notar gemeldet. Bei Geldschenkungen müssen Sie selbst aktiv werden. Die Anzeige ist auch dann Pflicht, wenn aufgrund des Freibetrags keine Steuer anfällt.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Was die Schenkungsteuer ist',
        html: `<p>Die <strong>Schenkungsteuer</strong> fällt an, wenn Vermögen <strong>zu Lebzeiten</strong> unentgeltlich übertragen wird. Sie beruht auf demselben Gesetz wie die Erbschaftsteuer (ErbStG) und nutzt dieselben Freibeträge, Steuerklassen und Steuersätze. Der entscheidende Unterschied: Bei einer Schenkung lassen sich die persönlichen Freibeträge <strong>alle zehn Jahre erneut</strong> ausschöpfen — das macht die Schenkung zum wichtigsten Werkzeug der Vermögensübertragung.</p><p>Wie viel Steuer anfällt, hängt vom <strong>Verwandtschaftsgrad</strong> zum Schenker und vom <strong>Wert</strong> der Schenkung ab. Versteuert wird nur der Teil über dem Freibetrag. Anders als bei der Erbschaft gibt es bei der Schenkung <strong>keinen Versorgungsfreibetrag</strong>, und Eltern bzw. Großeltern werden ungünstiger eingestuft (dazu gleich mehr). Die Berechnung deckt sich im Kern mit dem Erbschaftsteuer-Rechner — nur die schenkungsspezifischen Besonderheiten unterscheiden sich. Mit der Einkommensteuer hat beides nichts zu tun. Eingegeben werden im Rechner der Schenkungswert, der Verwandtschaftsgrad, in den letzten zehn Jahren bereits genutzte Freibeträge und ein möglicher Hausrat-Freibetrag; daraus ergibt sich die geschätzte Steuer samt effektivem Steuersatz.</p>`,
      },
      {
        typ: 'vergleich',
        titel: 'Schenkung vs. Erbschaft — die drei Unterschiede',
        spalteA: 'Schenkung (zu Lebzeiten)',
        spalteB: 'Erbschaft (von Todes wegen)',
        zeilen: [
          { kriterium: 'Freibetrag Eltern / Großeltern', a: '20.000 € (Klasse II)', b: '100.000 € (Klasse I)' },
          { kriterium: 'Versorgungsfreibetrag (§ 17)', a: 'nein', b: 'ja (Ehegatte 256.000 €, Kinder bis 52.000 €)' },
          { kriterium: 'Freibetrag wiederholbar', a: 'alle 10 Jahre neu (§ 14)', b: 'einmalig' },
          { kriterium: 'Freibeträge, Klassen, Sätze', a: 'identisch (§§ 15/16/19 ErbStG)', b: 'identisch (§§ 15/16/19 ErbStG)' },
        ],
      },
      {
        typ: 'text',
        titel: 'Die 10-Jahres-Regel (§ 14 ErbStG)',
        html: `<p>Das Herzstück der Schenkungsteuer ist die <strong>10-Jahres-Regel</strong>: Der persönliche Freibetrag steht nicht nur einmal im Leben zur Verfügung, sondern <strong>erneuert sich alle zehn Jahre vollständig</strong>. Schenkungen innerhalb eines Zehnjahreszeitraums werden zusammengerechnet (§ 14 ErbStG); ist der Zeitraum verstrichen, beginnt der Freibetrag wieder bei null.</p><p>Daraus ergibt sich die zentrale Gestaltungsmöglichkeit: Wer sein Vermögen frühzeitig und in Etappen überträgt, kann große Summen steuerfrei weitergeben. Ein Kind kann von einem Elternteil alle zehn Jahre 400.000 € steuerfrei erhalten — über dreißig Jahre also bis zu 1,2 Mio. €. Schenken beide Elternteile, verdoppelt sich der Betrag. Wichtig ist die Zehnjahresfrist ab dem Tag der jeweiligen Schenkung: Wer zu schnell hintereinander schenkt, überschreitet den Freibetrag, weil die Beträge addiert werden. Der Rechner berücksichtigt bereits genutzte Freibeträge der letzten zehn Jahre über ein eigenes Eingabefeld. Ein verbreiteter Irrtum dabei: Die Frist läuft nicht ab dem Jahreswechsel, sondern taggenau ab der jeweiligen Schenkung — eine Übertragung am 1. März 2026 ist erst am 2. März 2036 wieder vollständig „frei". Wer plant, sollte den Abstand also großzügig wählen.</p>`,
      },
      {
        typ: 'text',
        titel: 'Was überhaupt als Schenkung gilt',
        html: `<p>Nicht nur Geldgeschenke lösen Schenkungsteuer aus. Als Schenkung gilt jede <strong>unentgeltliche Zuwendung</strong>, die den Beschenkten bereichert — dazu zählen Immobilien, Wertpapiere, Unternehmensanteile und wertvolle Gegenstände, aber auch die Übernahme von Schulden oder ein <strong>zinsloses Darlehen</strong>, bei dem der ersparte Zins als Schenkung gewertet wird.</p><p>Steuerfrei bleiben dagegen <strong>Gelegenheitsgeschenke</strong> im üblichen Rahmen — etwa zu Geburtstag oder Hochzeit —, solange sie angemessen sind. Auch Unterhaltszahlungen und die Kosten einer angemessenen Ausbildung lösen keine Schenkungsteuer aus. Schwieriger wird es bei gemischten Schenkungen: Wird etwa eine Immobilie bewusst unter Wert verkauft, gilt die Differenz zwischen Verkehrswert und Kaufpreis als Schenkung. In all diesen Fällen kommt es auf den vom Finanzamt ermittelten Wert an — dieser Rechner geht vom bereits bestimmten Schenkungswert aus.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Kind: 400.000 € geschenkt — steuerfrei',
        schritte: [
          { label: 'Schenkungswert', formel: '', ergebnis: '400.000 €' },
          { label: 'persönlicher Freibetrag (Kind)', formel: '§ 16 ErbStG', ergebnis: '− 400.000 €' },
          { label: 'bereits genutzt (10 Jahre)', formel: '', ergebnis: '0 €' },
          { label: 'steuerpflichtiger Erwerb', formel: '400.000 − 400.000', ergebnis: '0 €' },
          { label: 'Schenkungsteuer', formel: '', ergebnis: '0 €' },
        ],
        fazit: 'Schenkt ein Elternteil seinem Kind 400.000 €, deckt der persönliche Freibetrag den vollen Betrag ab — es fällt keine Schenkungsteuer an. Genau dieser Freibetrag steht nach Ablauf von zehn Jahren erneut zur Verfügung. Wer rechtzeitig plant, kann über mehrere Jahrzehnte hinweg ein Vielfaches steuerfrei übertragen. Voraussetzung ist, dass in den vorangegangenen zehn Jahren keine weiteren Schenkungen den Freibetrag bereits aufgebraucht haben. Trotz Steuerfreiheit muss die Schenkung dem Finanzamt angezeigt werden — die Anzeigepflicht entfällt nicht dadurch, dass keine Steuer anfällt.',
      },
      {
        typ: 'beispielrechnung',
        titel: 'Kind: 500.000 € geschenkt (kein Vorbetrag)',
        schritte: [
          { label: 'Schenkungswert', formel: '', ergebnis: '500.000 €' },
          { label: 'persönlicher Freibetrag (Kind)', formel: '§ 16 ErbStG', ergebnis: '− 400.000 €' },
          { label: 'steuerpflichtiger Erwerb', formel: '500.000 − 400.000', ergebnis: '100.000 €' },
          { label: 'Steuerklasse / Satz', formel: 'Klasse I, bis 300.000 €', ergebnis: '11 %' },
          { label: 'Schenkungsteuer', formel: 'über Härtefall-Funktion', ergebnis: '11.000 €' },
        ],
        fazit: 'Werden in einem Zug 500.000 € geschenkt, übersteigt der Betrag den Freibetrag um 100.000 €. Darauf fallen in Klasse I 11 % an, also 11.000 € Schenkungsteuer — ein effektiver Satz von nur 2,2 % auf die Gesamtsumme, weil der große Freibetrag den Löwenanteil schützt. Hätte man stattdessen zunächst 400.000 € geschenkt und die restlichen 100.000 € erst nach Ablauf von zehn Jahren, wären beide Teilschenkungen steuerfrei geblieben. Genau hier liegt der Hebel der zeitlichen Staffelung. Wer also keine Eile hat, spart durch bloßes Abwarten der Zehnjahresfrist die gesamte Steuer — bei dringendem Bedarf kann die einmalige Zahlung von 11.000 € aber durchaus der bequemere Weg sein.',
      },
      {
        typ: 'vergleich',
        titel: '800.000 € an ein Kind: auf einmal oder gestaffelt?',
        spalteA: 'Einmal 800.000 €',
        spalteB: 'Gestaffelt 2 × 400.000 € (>10 Jahre Abstand)',
        zeilen: [
          { kriterium: 'genutzter Freibetrag', a: '400.000 € (einmal)', b: '2 × 400.000 € (zwei Zeiträume)' },
          { kriterium: 'steuerpflichtiger Erwerb', a: '400.000 €', b: '0 €' },
          { kriterium: 'Steuersatz (Klasse I)', a: '15 %', b: '—' },
          { kriterium: 'Schenkungsteuer', a: '60.000 €', b: '0 €' },
          { kriterium: 'Netto beim Kind', a: '740.000 €', b: '800.000 €' },
        ],
      },
      {
        typ: 'beispielrechnung',
        titel: 'Bereits genutzter Freibetrag wirkt nach',
        schritte: [
          { label: 'neue Schenkung an Kind', formel: '', ergebnis: '500.000 €' },
          { label: 'voller Freibetrag', formel: '§ 16 ErbStG', ergebnis: '400.000 €' },
          { label: 'vor 5 Jahren bereits geschenkt', formel: '', ergebnis: '− 200.000 €' },
          { label: 'noch verfügbarer Freibetrag', formel: '400.000 − 200.000', ergebnis: '200.000 €' },
          { label: 'steuerpflichtiger Erwerb', formel: '500.000 − 200.000', ergebnis: '300.000 €' },
          { label: 'Schenkungsteuer', formel: 'Klasse I, 11 %', ergebnis: '33.000 €' },
        ],
        fazit: 'Hat dasselbe Kind vor fünf Jahren bereits 200.000 € erhalten, ist der Freibetrag noch nicht erneuert — es stehen nur die restlichen 200.000 € zur Verfügung. Von einer neuen Schenkung über 500.000 € bleiben daher 300.000 € steuerpflichtig, die Schenkungsteuer steigt auf 33.000 €. Hätte man die zweite Schenkung bis nach Ablauf der Zehnjahresfrist aufgeschoben, stünde der volle Freibetrag wieder bereit. Das zeigt, wie wichtig der zeitliche Abstand zwischen Schenkungen ist — der Rechner bildet das über das Feld „bereits genutzte Freibeträge" ab. Wer plant, größere Beträge in Etappen zu übertragen, sollte deshalb genau festhalten, wann welche Schenkung erfolgt ist, um die Zehnjahresfristen sauber auseinanderzuhalten.',
      },
      {
        typ: 'tabelle',
        titel: 'Freibeträge und Steuerklassen bei Schenkungen (§§ 16, 15 ErbStG)',
        kopf: ['Verwandtschaft', 'Freibetrag', 'Steuerklasse'],
        zeilen: [
          ['Ehepartner / eingetr. Lebenspartner', '500.000 €', 'I'],
          ['Kind, Stief-/Adoptivkind', '400.000 €', 'I'],
          ['Enkel (Eltern verstorben)', '400.000 €', 'I'],
...
Die Kirchensteuer beträgt 9 % der ESt in 14 Bundesländern und 8 % in Baden-Württemberg und Bayern. Sie ist als Sonderausgabe im Folgejahr abzugsfähig. Ein Austritt aus der Kirche ist jederzeit möglich (Kosten: 10–60 €).`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Was das zu versteuernde Einkommen ist',
        html: `<p>Die Einkommensteuer bemisst sich nicht am Bruttoeinkommen, sondern am <strong>zu versteuernden Einkommen (zvE)</strong> — also dem, was nach Abzug von Werbungskosten, Sonderausgaben, außergewöhnlichen Belastungen und Freibeträgen übrig bleibt. Dieser Rechner setzt direkt am zvE an und wendet darauf den <strong>Einkommensteuertarif nach § 32a EStG</strong> an, um die Jahres-Einkommensteuer zu ermitteln.</p><p>Der Tarif ist <strong>progressiv</strong> und in fünf Zonen aufgebaut. Bis zum <strong>Grundfreibetrag von 12.348 Euro</strong> (Stand 2026) fällt gar keine Steuer an — diese erste Zone ist die Nullzone. Darüber steigt der Steuersatz: zunächst der Eingangssteuersatz von 14 Prozent, der innerhalb der nächsten Zonen bis auf 42 Prozent klettert, und für sehr hohe Einkommen schließlich 45 Prozent. Wichtig dabei: Der höhere Satz gilt immer nur für den Teil des Einkommens in der jeweiligen Zone, nicht rückwirkend für alles. Eingegeben wird also das fertige zvE; ob man zusätzlich Solidaritätszuschlag und Kirchensteuer berücksichtigt und ob einzeln oder mit Ehegattensplitting veranlagt wird, lässt sich im Rechner einstellen.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Die fünf Tarifzonen 2026 (§ 32a EStG)',
        kopf: ['Zone', 'zvE-Bereich', 'Grenzsteuersatz'],
        zeilen: [
        ...
        fussnote: 'Tarifzonen für das zu versteuernde Einkommen nach § 32a EStG, Stand 2026 (Grundfreibetrag 12.348 €), exakt wie im Rechner hinterlegt. „Grenzsteuersatz" meint den Satz auf den jeweils nächsten Euro: In den Zonen 2 und 3 steigt er gleitend an, in Zone 4 bleibt er konstant bei 42 Prozent. Maßgeblich für die eigene Steuer ist die amtliche Berechnung des Finanzamts; dieser Rechner bildet den Tarif nach. Die Zonengrenzen werden regelmäßig an die Inflation angepasst (zuletzt der Grundfreibetrag von 12.096 € in 2025 auf 12.348 € in 2026), weshalb es auf den jeweils aktuellen Jahresstand ankommt.',
      },
      {
        typ: 'beispielrechnung',
        titel: 'Einkommensteuer für 40.000 € zvE (Zone 3)',
        schritte: [
          { label: 'zu versteuerndes Einkommen', formel: '', ergebnis: '40.000 €' },
          { label: 'Zone', formel: '17.800 – 69.878 €', ergebnis: 'Zone 3' },
          { label: 'Zwischenwert z', formel: '(40.000 − 17.799) ÷ 10.000', ergebnis: '2,2201' },
          { label: 'Tarifformel', formel: '(173,10 · z + 2.397) · z + 1.034,87', ergebnis: '' },
          { label: 'Einkommensteuer', formel: 'abgerundet auf volle Euro', ergebnis: '7.209 €' },
        ],
        fazit: 'Ein zu versteuerndes Einkommen von 40.000 Euro fällt in Zone 3. Der Tarif rechnet hier mit einem Polynom: Aus der Differenz zum Zonenbeginn (40.000 − 17.799 = 22.201) wird der Zwischenwert z = 2,2201 gebildet und in die Formel (173,10 · z + 2.397) · z + 1.034,87 eingesetzt. Das ergibt rund 7.210 Euro, abgerundet auf volle Euro 7.209 Euro Einkommensteuer. Das entspricht einem Durchschnittssteuersatz von etwa 18 Prozent — deutlich weniger als der Grenzsteuersatz, der an dieser Stelle bereits bei rund 35 Prozent liegt. Genau diese Lücke zwischen Durchschnitt und Grenze ist der Kern der Progression. Die Polynom-Koeffizienten der Zonen 2 und 3 sind im Gesetz so gewählt, dass der Grenzsteuersatz gleitend ansteigt — anders als bei einem Stufentarif gibt es also keine harten Sprünge an den Zonengrenzen.',
      },
      {
        typ: 'text',
        titel: 'Grenzsteuersatz und Durchschnittssteuersatz',
        html: `<p>Zwei Sätze werden oft verwechselt. Der <strong>Durchschnittssteuersatz</strong> ist die gesamte Steuer geteilt durch das zvE — er sagt, welcher Anteil des Einkommens insgesamt als Steuer abfließt. Der <strong>Grenzsteuersatz</strong> dagegen ist der Satz auf den <strong>nächsten verdienten Euro</strong>. Im Beispiel der 40.000 Euro liegt der Durchschnitt bei 18 Prozent, der Grenzsatz aber bei rund 35 Prozent.</p><p>Diese Unterscheidung räumt mit einem verbreiteten Irrtum auf: Eine Gehaltserhöhung wird nie so besteuert, dass netto weniger übrig bleibt. Versteuert wird zusätzliches Einkommen mit dem Grenzsteuersatz, also nur der draufkommende Teil — der Rest bleibt unberührt. Wie sich Grenz- und Durchschnittssatz über den gesamten Einkommensverlauf entwickeln, zeigt im Detail der <strong>Steuerprogressions-Rechner</strong>; dieser hier konzentriert sich auf die Jahres-Einkommensteuer selbst. Der Eingangssteuersatz von 14 Prozent gilt direkt oberhalb des Grundfreibetrags, der höchste Grenzsteuersatz von 45 Prozent erst für Einkommensteile über 277.825 Euro — dazwischen liegt ein langer, gleitender Anstieg.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Einkommensteuer für 90.000 € zvE (Zone 4)',
        schritte: [
          { label: 'zu versteuerndes Einkommen', formel: '', ergebnis: '90.000 €' },
          { label: 'Zone', formel: '69.879 – 277.825 €', ergebnis: 'Zone 4 (42 %)' },
          { label: 'Tarifformel', formel: '0,42 · 90.000 − 11.135,63', ergebnis: '' },
          { label: 'Einkommensteuer', formel: 'abgerundet', ergebnis: '26.664 €' },
          { label: 'Durchschnittssteuersatz', formel: '26.664 ÷ 90.000', ergebnis: '≈ 29,6 %' },
        ],
      ...
      {
        typ: 'text',
        titel: 'Vom Bruttoeinkommen zum zvE',
        html: `<p>Dieser Rechner beginnt beim zu versteuernden Einkommen — doch wie kommt man dorthin? Vom <strong>Bruttoeinkommen</strong> werden zunächst die <strong>Werbungskosten</strong> abgezogen, mindestens aber der Arbeitnehmer-Pauschbetrag von <strong>1.230 Euro</strong> (§ 9a EStG). Dann folgen <strong>Sonderausgaben</strong> (etwa Vorsorgeaufwendungen, mindestens die Pauschale von 36 Euro nach § 10c EStG), außergewöhnliche Belastungen und gegebenenfalls Freibeträge.</p><p>Was übrig bleibt, ist das zvE — die Bemessungsgrundlage für den Tarif. Bei Arbeitnehmern kommen im Alltag noch die <strong>Sozialversicherungsbeiträge</strong> hinzu, die der Arbeitgeber direkt abführt; das berücksichtigt dieser reine Tarif-Rechner bewusst nicht. Wer vom Brutto-Monatslohn auf das tatsächliche Netto inklusive Sozialabgaben kommen möchte, ist beim <strong>Brutto-Netto-Rechner</strong> besser aufgehoben. Dieser Rechner zeigt isoliert, was der Einkommensteuertarif aus einem gegebenen zvE macht — nicht mehr und nicht weniger. Das macht ihn vor allem nützlich, wenn das zvE bereits feststeht (etwa aus dem letzten Steuerbescheid) und man die Steuerwirkung einer Änderung schnell überschlagen möchte.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Beispiel: zvE und zugehörige Einkommensteuer 2026',
        kopf: ['zu versteuerndes Einkommen', 'Einkommensteuer', 'Durchschnittssatz'],
        zeilen: [
          ['15.000 €', '435 €', '2,9 %'],
          ['20.000 €', '1.570 €', '7,8 %'],
          ['30.000 €', '4.217 €', '14,1 %'],

...
Der Lieferservice-Rechner macht die Kosten sichtbar und hilft Ihnen, eine informierte Entscheidung zu treffen. Niemand muss komplett auf Lieferdienste verzichten — aber wer die Zahlen kennt, kann bewusster entscheiden, wann sich eine Bestellung lohnt und wann der Griff zum Kochlöffel die bessere Wahl ist. Schon kleine Änderungen sparen über die Jahre Tausende Euro.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Was Bestellen wirklich kostet',
        html: `<p>Ein paar Klicks auf dem Smartphone, und kurze Zeit später steht das Essen vor der Tür. Lieferdienste sind bequem — doch was sie übers Jahr kosten, bleibt oft unsichtbar, weil jede einzelne Bestellung für sich harmlos wirkt. Dieser Rechner macht die Summe sichtbar: Er multipliziert die <strong>Kosten je Bestellung</strong> (Bestellwert plus Liefergebühr plus Trinkgeld) mit der wöchentlichen Bestellfrequenz und rechnet auf Monat und Jahr hoch.</p><p>Spannend wird der Blick erst im Jahresmaßstab. Eine 30-Euro-Bestellung dreimal pro Woche sind schnell mehrere Tausend Euro im Jahr — Geld, das im Alltag kaum auffällt, weil es in kleinen Häppchen abfließt. Es geht dabei nicht um ein Verbot: Bestellen darf seinen Platz haben. Der Rechner liefert nur die Zahl, mit der sich bewusster entscheiden lässt. Wer die Lieferkosten ins gesamte Monatsbudget einordnen möchte, nutzt ergänzend den <a href="/alltag/budget-rechner">Budget-Rechner</a>. So zeigt sich, welchen Anteil das Bestellen an den gesamten Lebenshaltungskosten hat — bei häufigen Bestellern ist es oft mehr, als die Miete für ein Zimmer kosten würde.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Eine typische Bestellung über das Jahr',
        schritte: [
          { label: 'Bestellwert (Speisen)', formel: '', ergebnis: '25 €' },
          { label: 'Liefergebühr', formel: '', ergebnis: '3 €' },
          { label: 'Trinkgeld', formel: '', ergebnis: '2 €' },
          { label: 'Kosten je Bestellung', formel: '25 + 3 + 2', ergebnis: '30 €' },
          { label: 'Pro Woche', formel: '30 × 3', ergebnis: '90 €' },
          { label: 'Pro Jahr', formel: '90 × 52', ergebnis: '4.680 €' },
          { label: 'Pro Monat', formel: '4.680 ÷ 12', ergebnis: '390 €' },
        ],
        fazit: 'Eine 25-Euro-Bestellung wird mit Liefergebühr und Trinkgeld schnell zur 30-Euro-Ausgabe. Dreimal pro Woche bestellt, sind das 90 € in der Woche, 390 € im Monat und 4.680 € im Jahr. Genau diese Hochrechnung überrascht die meisten, denn im Moment der Bestellung denkt niemand an die Jahressumme. Der Rechner addiert alle drei Bausteine — Bestellwert, Liefergebühr und Trinkgeld — und multipliziert sie mit Ihrer tatsächlichen Frequenz. So entsteht aus vielen kleinen Beträgen eine greifbare Zahl. Wichtig ist dabei keine Schuld: Die Bequemlichkeit hat ihren Wert. Sichtbar wird nur, an welcher Stelle sich der größte Hebel verbirgt — meist nicht beim einzelnen Preis, sondern bei der Häufigkeit.',
      },
      {
        typ: 'beispielrechnung',
        titel: 'Wie die Bestellfrequenz die Jahreskosten treibt',
        schritte: [
          { label: 'Kosten je Bestellung', formel: '25 + 3 + 2', ergebnis: '30 €' },
          { label: '1× pro Woche', formel: '30 × 52', ergebnis: '1.560 €/Jahr' },
          { label: '2× pro Woche', formel: '30 × 2 × 52', ergebnis: '3.120 €/Jahr' },
          { label: '3× pro Woche', formel: '30 × 3 × 52', ergebnis: '4.680 €/Jahr' },
          { label: 'Hebel je Bestellung/Woche', formel: '30 × 52', ergebnis: '1.560 €/Jahr' },
        ],
        fazit: 'Die Frequenz ist der eigentliche Kostentreiber. Jede zusätzliche Bestellung pro Woche schlägt bei 30 € mit rund 1.560 € im Jahr zu Buche — denn 30 € mal 52 Wochen ergeben genau diese Summe. Wer von drei auf zwei Bestellungen pro Woche geht, spart also rund 1.560 € im Jahr, ohne komplett zu verzichten. Das ist die ermutigende Botschaft hinter der Staffel: Man muss nicht aufhören zu bestellen, um spürbar zu sparen. Schon eine einzige Bestellung weniger pro Woche entspricht über das Jahr dem Preis eines Kurzurlaubs. Der Rechner zeigt diese Staffel für Ihre eigenen Werte und macht den Hebel sofort greifbar.',
      },
      {
        typ: 'vergleich',
        titel: 'Bestellen gegen Selberkochen',
        spalteA: 'Bestellen',
        spalteB: 'Selberkochen',
        zeilen: [
          { kriterium: 'Kosten je Mahlzeit/Person', a: '20–35 €', b: '3–5 € (einfach 1,50–3 €)' },
          { kriterium: 'Zusatzkosten', a: 'Liefergebühr, Servicepauschale, Trinkgeld', b: 'einmalige Grundausstattung in der Küche' },
          { kriterium: 'Zeitaufwand', a: 'gering, 30–45 Min Wartezeit', b: 'Einkauf, Kochen und Aufräumen' },
          { kriterium: 'Jahreskosten bei 3×/Woche', a: '≈ 4.680 €', b: '≈ 780 € (5 € × 3 × 52)' },
          { kriterium: 'Kontrolle über Zutaten', a: 'gering, festes Gericht', b: 'voll: Menge, Frische und Würzung selbst bestimmt' },
          { kriterium: 'Differenz pro Jahr', a: 'Referenz', b: 'rund 3.900 € weniger' },
        ],
      },
      {
        typ: 'infobox',
        variante: 'warnung',
        titel: 'Die versteckten Kosten einer Bestellung',
        text: 'Der Speisenpreis ist nur ein Teil der Rechnung. Hinzu kommen meist eine Liefergebühr von 2–5 €, in vielen Apps eine prozentuale Servicepauschale, ein Mindestbestellwert, der zu Zusatzbestellungen verleitet, sowie Trinkgeld. So wird aus einer 25-Euro-Bestellung schnell eine Ausgabe von 30 € oder mehr. Ein Grund für die höheren Preise liegt im Hintergrund: Lieferdienste behalten laut Statista 13–30 % des Bestellwerts als Provision der Gastronomie ein — diese Kosten fließen in die Endpreise ein. Deshalb sind Direktbestellung beim Restaurant und vor allem Selbstabholung oft spürbar günstiger. Wer die Nebenkosten kennt, wird beim nächsten Mindestbestellwert nicht mehr automatisch ein zusätzliches Getränk in den Warenkorb legen, nur um die Schwelle zu erreichen. Auch dynamische Liefergebühren spielen eine Rolle: Zu Stoßzeiten oder bei schlechtem Wetter steigen sie in manchen Apps spürbar an, und kurze Lieferdistanzen werden teils mit Mindestpauschalen belegt. Ein Blick auf die Aufschlüsselung vor dem Bezahlen lohnt sich daher fast immer.',
      },
      {
        typ: 'statistik',
        titel: 'Der Liefermarkt in Zahlen',
        werte: [
          { label: 'Lieferando-Datenbasis', wert: '16 Mio.', hinweis: 'Bestellprofile im Report 2024/25' },
          { label: 'Partner-Gastronomien', wert: '~38.000', hinweis: 'in über 2.000 Städten in Deutschland' },
          { label: 'Ø Bestellwert', wert: '≈ 25,80 €', hinweis: 'Just Eat Takeaway, Nordeuropa; stützt den 25–30-€-Korridor' },
          { label: 'Gastro-Provision der Lieferdienste', wert: '13–30 %', hinweis: 'Statista; erhöht die Endpreise gegenüber Direktbestellung' },
          { label: 'Selbstgekochte Mahlzeit', wert: '3–5 €/Person', hinweis: 'einfache Gerichte sogar 1,50–3 € pro Portion' },
        ],
      },
      {
        typ: 'tabelle',
        titel: 'Spar-Hebel mit typischer Ersparnis',
        kopf: ['Strategie', 'So funktioniert es', 'Ersparnis'],
        zeilen: [
        ...
        fussnote: 'Die Hebel lassen sich kombinieren, wirken aber unterschiedlich stark: Die größte Einzelersparnis bringt fast immer das Senken der Frequenz, weil sie direkt auf die Jahressumme durchschlägt. Selbstabholung und Gutscheine senken den Preis pro Bestellung, ändern aber nichts an der Häufigkeit. Ein Lieferpass lohnt sich nur, wenn die gesparten Liefergebühren die Monatsgebühr übersteigen — bei seltenen Bestellungen ist er ein Verlustgeschäft. Vorsicht ist bei Aktionen geboten: Rabattcodes senken zwar den Einzelpreis, verleiten aber leicht dazu, häufiger zu bestellen, und heben den Spareffekt damit wieder auf.',
      },
      {
        typ: 'beispielrechnung',
        titel: 'Lohnt sich ein Lieferpass? Der Break-even',
        schritte: [
          { label: 'Monatsgebühr Lieferpass', formel: '', ergebnis: 'z. B. 6,99 €' },
          { label: 'Gesparte Liefergebühr je Bestellung', formel: '', ergebnis: '≈ 3 €' },
          { label: 'Break-even', formel: '6,99 ÷ 3', ergebnis: '≈ 2,3 Bestellungen/Monat' },
          { label: 'Bei 4 Bestellungen/Monat', formel: '4 × 3 − 6,99', ergebnis: '+ 5,01 € Ersparnis' },
          { label: 'Bei 1 Bestellung/Monat', formel: '1 × 3 − 6,99', ergebnis: '− 3,99 € Verlust' },
        ],
        fazit: 'Ein Lieferpass wie Lieferando Plus rechnet sich nur ab einer bestimmten Bestellhäufigkeit. Die Logik ist einfach: Man teilt die Monatsgebühr durch die je Bestellung gesparte Liefergebühr. Bei 6,99 € Gebühr und 3 € gesparter Liefergebühr liegt der Break-even bei rund 2,3 Bestellungen im Monat. Wer viermal im Monat bestellt, spart bereits gut 5 € monatlich; wer nur einmal bestellt, zahlt mit dem Pass rund 4 € drauf. Entscheidend ist die ehrliche Einschätzung der eigenen Frequenz — und der Hinweis, dass ein Pass auch dazu verleiten kann, häufiger zu bestellen, nur um ihn auszunutzen. Genau dann kehrt sich der vermeintliche Spareffekt ins Gegenteil.',
      },
      {
        typ: 'text',
        titel: 'Der Lieferpass ist auch nur ein Abo',
        html: `<p>Ein Lieferpass mit fester Monatsgebühr ist im Kern ein <strong>Abo</strong> — und teilt dessen typische Tücke: Er läuft weiter, ob man ihn nutzt oder nicht. In Monaten, in denen seltener bestellt wird, zahlt man die Gebühr trotzdem. Deshalb lohnt es sich, den Pass wie jedes andere Abo regelmäßig zu prüfen und in bestellarmen Phasen zu pausieren oder zu kündigen.</p><p>Wer den Überblick über alle laufenden Abos behalten will — vom Streaming bis zum Lieferpass — findet im <a href="/alltag/abo-rechner">Abo-Rechner</a> das passende Werkzeug. Die gleiche Logik gilt für viele kleine Komfort-Ausgaben: Einzeln kaum spürbar, summieren sie sich über das Jahr zu festen Beträgen. Der bewusste Umgang beginnt nicht mit Verzicht, sondern mit dem Überblick darüber, was tatsächlich genutzt wird und was nur aus Gewohnheit weiterläuft. Ein praktischer Test: Wer den Pass einen Monat lang pausiert und dabei kaum etwas vermisst, braucht ihn vermutlich nicht dauerhaft.</p>`,
      },
      {
        typ: 'checkliste',
        titel: 'Bewusster bestellen — ohne Verzicht',
        punkte: [
      ...
      {
        typ: 'text',
        titel: 'Warum wir trotzdem bestellen',
        html: `<p>Die Gründe fürs Bestellen sind nachvollziehbar: Zeitmangel nach einem langen Arbeitstag, fehlende Lust oder Übung beim Kochen, die Freude an Abwechslung oder schlicht Bequemlichkeit. Nichts davon ist verkehrt — Zeit und Nerven haben ebenfalls einen Wert, und ein gelegentliches Lieblingsgericht vom Lieblingsrestaurant ist gut investiertes Geld.</p><p>Der Rechner will deshalb nicht moralisieren, sondern eine Grundlage schaffen. Wer weiß, dass eine Bestellung weniger pro Woche rund 1.560 € im Jahr ausmacht, kann selbst abwägen, wo die Grenze zwischen sinnvollem Komfort und reiner Gewohnheit verläuft. Was an Bestellungen eingespart wird, muss nicht auf dem Konto versickern: Mit dem <a href="/finanzen/sparrechner">Sparrechner</a> lässt sich durchspielen, wie aus einem regelmäßig zurückgelegten Betrag über die Jahre eine spürbare Rücklage wird. So wird aus bewusstem Bestellen ein konkreter finanzieller Vorteil, ganz ohne Verzichtsgefühl. Auch die Gesundheit profitiert oft nebenbei, weil selbst gekochte Mahlzeiten in der Regel weniger Salz, Zucker und Fett enthalten als Lieferküche — das ist aber ein willkommener Nebeneffekt, kein moralischer Maßstab.</p>`,
      },
      {
        typ: 'infobox',
        variante: 'hinweis',
        titel: 'Richtwerte statt Einzelfall',
        text: 'Die genannten Werte sind Marktdurchschnitte mit Stand 2024/2025 aus Quellen wie dem Lieferando-Report, Statista und Just Eat Takeaway. Sie dienen der Einordnung — die tatsächlichen Kosten hängen von Stadt, Anbieter, Restaurant und Ihren konkreten Bestellungen ab und können deutlich abweichen. Der Rechner bildet ausschließlich die von Ihnen eingegebenen Beträge ab. Es geht ausdrücklich nicht darum, Lieferdienste schlechtzureden — sie schaffen Komfort und unterstützen die Gastronomie. Ziel ist allein Transparenz: zu sehen, was die eigene Bestellgewohnheit übers Jahr kostet, und auf dieser Basis frei zu entscheiden. Die Beispielwerte auf dieser Seite veranschaulichen die Methodik; im Rechner zählen nur Ihre eigenen Zahlen. Auch die Jahres-Hochrechnung ist bewusst vereinfacht: Sie hält die heutigen Preise konstant und unterstellt eine gleichmäßige Bestellfrequenz, während der reale Alltag mit Urlauben, Aktionen und Preissteigerungen schwankt.',
      },
    ],
    quellen: [
      { titel: 'Lieferando Report 2024/25 (Just Eat Takeaway)', hinweis: 'Datenbasis 16 Mio. Bestellprofile bei ~38.000 Partner-Gastronomien in über 2.000 Städten; Civey-Umfrage 2.500 Befragte.' },
      { titel: 'Statista: Lieferdienst-Provisionen', hinweis: 'Lieferdienste behalten 13–30 % des Bestellwerts als Gastro-Provision ein; beeinflusst Endpreise und macht Selbstabholung günstiger.' },
      { titel: 'Just Eat Takeaway: durchschnittlicher Bestellwert', hinweis: 'Ø Bestellwert Nordeuropa ~25,80 €; stützt den typischen 25–30-€-Korridor.' },
      { titel: 'Lieferservice-Methodik', hinweis: 'Jahreskosten = Bestellungen/Woche × (Bestellwert + Liefergebühr + Trinkgeld) × 52. Selberkochen Ø 3–5 €/Person. Marktdurchschnitte, keine Anbieterempfehlung.' },
    ],
  },
  {
    slug: 'abo-rechner',
...
Der Abo-Rechner macht Ihre monatlichen Verpflichtungen sichtbar. Allein das Aufschreiben aller Abos führt bei den meisten Menschen dazu, mindestens ein oder zwei unnötige Posten zu entdecken. Nutzen Sie das Tortendiagramm, um zu sehen, welches Abo den größten Anteil hat, und das Ranking, um gezielt zu optimieren. Schon 30 € weniger im Monat sind 360 € mehr im Jahr — für die schönen Dinge im Leben.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Abos — die Fixkosten des digitalen Alltags',
        html: `<p><strong>Abonnements</strong> sind zu festen Kosten des digitalen Alltags geworden: Streaming, Musik, Cloud-Speicher, Fitnessstudio, Software und Mobilfunk werden Monat für Monat automatisch abgebucht. Jeder einzelne Betrag wirkt klein — in der Summe entsteht aber ein fester Kostenblock, der oft unbemerkt mitläuft. Dieser Rechner trägt alle laufenden Abos zusammen, bildet die <strong>Monats-, Jahres- und Jahrzehnt-Kosten</strong> und zeigt mit Tortendiagramm und Ranking, welches Abo den größten Anteil ausmacht.</p><p>Die Rechnung selbst ist denkbar einfach: Alle monatlichen Beträge werden addiert und mit zwölf multipliziert. Aufschlussreich ist erst der Gesamtblick — denn wenn alle Posten nebeneinanderstehen, fällt auf, was sich tatsächlich summiert. Wer wissen möchte, wie viele <strong>Arbeitsstunden</strong> hinter den Abo-Kosten stecken, kann das mit dem <a href="/finanzen/stundenlohn-rechner">Stundenlohn-Rechner</a> nachsehen — 972 € im Jahr entsprechen bei 20 € Netto-Stundenlohn fast einer ganzen Arbeitswoche. Es geht dabei nicht um Verzicht, sondern um Transparenz: Wer seine Abos kennt, entscheidet bewusster, wofür das Geld läuft, und behält ohne schlechtes Gewissen, was ihm wirklich etwas wert ist.</p>`,
      },
      {
        typ: 'statistik',
        titel: 'Der Abo-Markt in Zahlen',
        werte: [
          { label: 'Digitale Abos je Haushalt', wert: 'Ø 62 €/Monat', hinweis: 'BearingPoint Submix-Studie 2026, +7 € gegenüber Vorjahr' },
          { label: 'Haushalte über 100 €/Monat', wert: '19 %', hinweis: 'im Vorjahr noch 15 %' },
          { label: 'Nutzung von Bundles', wert: '29 %', hinweis: 'mehrere Dienste im Paket gebündelt' },
          { label: 'Abo-Kategorien je Haushalt', wert: 'Ø 2,3', hinweis: 'etwa Video, Musik und Cloud parallel' },
          { label: 'Hochrechnung auf das Jahr', wert: '≈ 744 €', hinweis: '62 € × 12, allein für digitale Abos' },
          { label: 'Hochrechnung auf zehn Jahre', wert: '≈ 7.440 €', hinweis: '62 € × 120, ohne künftige Preissteigerungen gerechnet' },
        ],
      },
      {
        typ: 'beispielrechnung',
        titel: 'Beispiel: vier Abos über Monat, Jahr und Jahrzehnt',
        schritte: [
          { label: 'Netflix (Video-Streaming)', formel: '', ergebnis: '14 €' },
          { label: 'Spotify (Musik)', formel: '', ergebnis: '12 €' },
          { label: 'Fitnessstudio', formel: '', ergebnis: '30 €' },
          { label: 'Handytarif', formel: '', ergebnis: '25 €' },
          { label: 'Summe pro Monat', formel: '14 + 12 + 30 + 25', ergebnis: '81 €' },
          { label: 'Pro Jahr', formel: '81 × 12', ergebnis: '972 €' },
          { label: 'In zehn Jahren', formel: '81 × 120', ergebnis: '9.720 €' },
        ],
        fazit: 'Vier alltägliche Abos — Streaming, Musik, Fitnessstudio und Handytarif — kommen zusammen auf 81 € im Monat. Das wirkt überschaubar, ergibt über das Jahr aber bereits 972 € und über ein Jahrzehnt 9.720 €. Genau diese Hochrechnung macht den Unterschied sichtbar: Einzeln betrachtet entscheidet man bei jedem Abo locker, in der Summe geht es um vierstellige Jahresbeträge. Der Rechner addiert beliebig viele Posten, multipliziert mit zwölf für die Jahreskosten und mit 120 für die Zehn-Jahres-Sicht. Wichtig ist dabei kein Spar-Zwang: Wer ein Abo bewusst und gern nutzt, behält es. Sichtbar wird vor allem, welche Posten man fast vergessen hatte — und genau dort lohnt der zweite Blick.',
      },
      {
        typ: 'tabelle',
        titel: 'Typische Abo-Kategorien und Preisspannen',
        kopf: ['Kategorie', 'Beispiele', 'Preis pro Monat'],
        zeilen: [
        ...
        fussnote: 'Die Spannen sind Orientierungswerte aus dem deutschen Markt 2025/2026; der konkrete Preis hängt von Tarif, Nutzerzahl und Werbeoptionen ab. Werbefinanzierte Einstiegstarife liegen am unteren Rand, werbefreie Premium- oder 4K-Stufen am oberen. Auffällig ist, dass mehrere kleine Posten (Cloud, eine App, ein VPN) einzeln kaum ins Gewicht fallen, zusammen aber schnell 20 bis 30 € im Monat ergeben — und gerade diese kleinen Beträge sind es, die in der Kontoübersicht untergehen. Wer seine Abos in solche Kategorien sortiert, erkennt rasch, wo sich gleichartige Dienste überschneiden: etwa zwei Streaming-Anbieter mit ähnlichem Filmangebot oder eine Cloud, die der Handytarif ohnehin schon mitliefert. Die Kategorien-Sicht ist damit der erste Schritt, um Doppelungen aufzulösen.',
      },
      {
        typ: 'infobox',
        variante: 'warnung',
        titel: 'Abo-Fallen, die leicht übersehen werden',
        text: 'Nicht der einzelne Preis ist das Problem, sondern die Masse und die Unsichtbarkeit. Drei Fallen tauchen besonders häufig auf: Erstens Gratis-Testphasen, die nach Ablauf automatisch in ein kostenpflichtiges Abo übergehen, ohne dass eine Erinnerung kommt. Zweitens doppelte Dienste — mehrere Streaming-Anbieter oder zwei Cloud-Speicher nebeneinander, von denen einer genügen würde. Drittens kleine App-Store- und Play-Store-Abos, die monatlich abgebucht werden und in der Kontoübersicht leicht untergehen. Hinzu kommt das klassische „irgendwann kündige ich das mal", das oft nie passiert. Tückisch ist außerdem, dass viele Abos bei Vertragsabschluss als „kostenlos" aktivierte Zusatzoptionen starten und erst nach der Testphase Geld kosten. Hilfreich ist eine feste Routine: ein fixer Termin pro Quartal, an dem alle wiederkehrenden Abbuchungen durchgesehen werden. Schon das bloße Auflisten deckt bei den meisten Menschen ein bis zwei vergessene Posten auf. Ein zweiter Blick lohnt sich besonders bei Abos, die über einen App-Store statt direkt beim Anbieter abgerechnet werden — sie tauchen in der normalen Vertragsübersicht oft gar nicht auf.',
      },
      {
        typ: 'text',
        titel: 'Streaming — der größte Kostentreiber',
        html: `<p>Den stärksten Schub bei den Abo-Kosten liefert das <strong>Streaming</strong>. Wo früher ein einzelner Dienst genügte, verteilen sich gefragte Filme, Serien und Sportrechte heute auf viele Anbieter — wer „alles" sehen will, bucht schnell drei oder vier Abos parallel. Laut der Simon-Kucher-Streaming-Studie 2025 ist das durchschnittliche Streaming-Budget binnen eines Jahres von 23 € auf rund <strong>30 € im Monat</strong> gestiegen, ein Plus von etwa 30 %. Gleichzeitig sagen 34 % der Befragten, ihre Streaming-Ausgaben seien zu hoch — unter den unter 39-Jährigen sind es sogar 48 %.</p><p>Der Hebel liegt hier weniger im Verzicht als im bewussten Wechseln: Wer Dienste gezielt für ein bis zwei Monate bucht, alles Interessante schaut und danach kündigt, zahlt deutlich weniger als bei vier Dauerabos. Hilfreich ist auch, Familien- oder Duo-Tarife zu prüfen, die mehrere Nutzer auf ein günstigeres Abo bringen. Wer das eingesparte Geld stattdessen langfristig anlegen möchte, kann mit dem <a href="/finanzen/etf-sparplanrechner">ETF-Sparplanrechner</a> durchspielen, was aus einem kleinen monatlichen Betrag über die Jahre werden kann.</p>`,
      },
      {
        typ: 'statistik',
        titel: 'Wie Haushalte ihre Abos nutzen',
        werte: [
          { label: 'Haushalte mit Videostreaming-Abo', wert: '76 %', hinweis: 'EY Digital Household Study' },
          { label: 'Abos je Haushalt (Durchschnitt)', wert: 'Ø 2,5', hinweis: 'Deloitte Media Consumer Survey 2024; 64 % mit mindestens einem Bezahl-Abo' },
          { label: 'Erwägen Kündigung wegen Preiserhöhung', wert: '31 %', hinweis: 'EY Digital Household Study' },
          { label: 'Finden Streaming-Ausgaben zu hoch', wert: '34 %', hinweis: 'Simon-Kucher 2025; bei unter 39-Jährigen sogar 48 %' },
          { label: 'Nutzen mehr Dienste als nötig', wert: '26 %', hinweis: 'Simon-Kucher 2025; bewusste Mehrfachnutzung' },
          { label: 'Vom Überangebot frustriert', wert: '58 %', hinweis: 'EY Digital Household Study; Suche und Auswahl als Belastung' },
        ],
      },
      {
        typ: 'vergleich',
        titel: 'Monatsabo gegen Jahresabo — am Beispiel Musik-Streaming',
        spalteA: 'Monatsabo',
        spalteB: 'Jahresabo',
        zeilen: [
          { kriterium: 'Zahlweise', a: 'monatlich, jederzeit kündbar', b: 'einmal im Voraus für zwölf Monate' },
          { kriterium: 'Preis (Beispiel)', a: '12 €/Monat = 144 €/Jahr', b: 'rund 120 €/Jahr (≈ 10 €/Monat)' },
          { kriterium: 'Ersparnis', a: 'keine', b: 'etwa 15–20 % gegenüber dem Monatsabo' },
          { kriterium: 'Flexibilität', a: 'hoch — sofort beendbar', b: 'gering — Vorauszahlung ist gebunden' },
          { kriterium: 'Risiko', a: 'zahlt auch in ungenutzten Monaten', b: 'Geld gebunden, wenn man früher aufhört' },
          { kriterium: 'Kündigung', a: 'meist zum Monatsende möglich', b: 'erst zum Ende der bezahlten Laufzeit' },
          { kriterium: 'Liquidität', a: 'gleichmäßige kleine Beträge', b: 'einmalige größere Vorauszahlung' },
          { kriterium: 'Geeignet für', a: 'wer den Dienst nur zeitweise nutzt', b: 'wer den Dienst ganzjährig sicher nutzt' },
        ],
      },
      {
        typ: 'checkliste',
        titel: 'Abo-Audit — die Routine gegen stille Abbuchungen',
        punkte: [
      ...
      {
        typ: 'text',
        titel: 'Abos als leichtester Fixkosten-Hebel',
        html: `<p>Bei der Haushaltsplanung gelten Abos als <strong>Fixkosten</strong> — wiederkehrende Beträge, die unabhängig vom täglichen Verhalten anfallen. Anders als Miete, Versicherungen oder ein Kredit lassen sie sich aber besonders leicht verändern: Ein unnötiges Abo ist mit wenigen Klicks gekündigt, während große Fixkosten oft nur mit Aufwand zu senken sind. Genau deshalb sind Abos der bequemste Hebel, um schnell Spielraum zu schaffen.</p><p>In der bekannten 50/30/20-Orientierung zählen viele Abos zu den Wünschen, manche (Mobilfunk, beruflich genutzte Software) eher zu den Bedürfnissen. Wer den Gesamtüberblick sucht, ordnet seine Abos am besten in ein vollständiges Haushaltsbudget ein — dafür eignet sich der <a href="/alltag/budget-rechner">Budget-Rechner</a>. Und was am Abo gespart wird, lässt sich mit dem <a href="/finanzen/sparrechner">Sparrechner</a> als wachsende Rücklage weiterdenken. Schon 30 € weniger im Monat sind 360 € mehr im Jahr — Geld, das ohne Einschnitt beim Lebensstandard frei wird, weil es zuvor in kaum genutzte Dienste floss. Genau das macht Abos zum dankbarsten Einstieg, wenn das Budget einmal Luft braucht.</p>`,
      },
      {
        typ: 'statistik',
        titel: 'Sparverhalten — so reagieren Haushalte',
        werte: [
          { label: 'Abo aus finanziellen Gründen beendet', wert: '17 %', hinweis: 'Zattoo TV-Streaming-Report 2025' },
          { label: 'Zu Gratis-Diensten gewechselt', wert: '20 %', hinweis: 'etwa Joyn Free, ARD/ZDF-Mediathek' },
          { label: 'Buchen Abos nur noch temporär', wert: '25 %', hinweis: 'gezieltes Rotieren statt dauerhaftem Abo' },
          { label: 'Nutzen Super-Bundles', wert: '41 %', hinweis: 'Simon-Kucher 2025; mehrere Dienste im Paket gebündelt' },
          { label: 'Ø Bezahl-Abos je Person', wert: 'Ø 2,8', hinweis: 'Simon-Kucher 2025; leicht über dem Haushaltsschnitt' },
          { label: 'Wechsel zu temporären Buchungen', wert: 'steigend', hinweis: 'Dienst gezielt für ein bis zwei Monate, dann kündigen' },
        ],
      },
      {
        typ: 'infobox',
        variante: 'hinweis',
        titel: 'Richtwerte statt Einzelfall',
        text: 'Die genannten Zahlen sind Marktdurchschnitte aus aktuellen Studien (2024–2026) und dienen nur der Einordnung — die tatsächlichen Kosten hängen von den konkret gebuchten Diensten, der Nutzerzahl und der gewählten Zahlweise ab. Der Rechner bildet ausschließlich die eingegebenen Beträge ab und gibt keine Empfehlung, welches Abo behalten oder gekündigt werden sollte; das bleibt eine persönliche Entscheidung. Auch die Hochrechnung auf zehn Jahre ist bewusst vereinfacht: Sie hält die heutigen Beträge konstant, während reale Abopreise sich über die Zeit verändern. Eine Beratung zu Verträgen, Kündigungsfristen oder Geldanlage ersetzt dieses Werkzeug nicht. Es schafft Transparenz über die Summe Ihrer laufenden Abos — die Bewertung, was davon den Preis wert ist, treffen Sie selbst. Ein Abo, das Freude bereitet oder beruflich gebraucht wird, ist gut investiertes Geld; es geht allein darum, die stillen und vergessenen Posten sichtbar zu machen. Wer regelmäßig hinschaut, behält die Kontrolle, ohne sich etwas zu verbieten — und genau das ist der eigentliche Zweck dieses Rechners.',
      },
    ],
    quellen: [
      { titel: 'BearingPoint Submix-Studie 2026', hinweis: 'Ø 62 €/Monat für digitale Abos je Haushalt; 19 % zahlen über 100 €/Monat; rund 2,3 Abo-Kategorien je Haushalt; Befragung in DE/FR/UK.' },
      { titel: 'Simon-Kucher Streaming-Studie 2025', hinweis: 'Ø Streaming-Budget 30 €/Monat (+30 %); 34 % empfinden die Ausgaben als zu hoch (unter 39-Jährige 48 %); Ø 2,8 Bezahl-Abos; 41 % nutzen Super-Bundles.' },
      { titel: 'EY Digital Household Study', hinweis: '76 % der Haushalte mit Videostreaming-Abo; 31 % erwägen Kündigung wegen Preiserhöhungen.' },
      { titel: 'Deloitte Media Consumer Survey 2024', hinweis: '64 % mit kostenpflichtigem Abo; Ø 2,5 Abos je Haushalt.' },
      { titel: 'Zattoo TV-Streaming-Report 2025', hinweis: '17 % beendeten ein Abo aus finanziellen Gründen; 20 % wechselten zu Gratis-Diensten; 25 % buchen Abos nur noch temporär.' },
      { titel: 'Abo-Kosten-Methodik', hinweis: 'Jahreskosten = Summe der Monatsbeträge × 12; Jahrzehnt = × 120. Marktdurchschnitte als Orientierung, individuelle Kosten variieren.' },
    ],
  },
  {
...
Der Preis pro Gigabyte ist eine gute Kennzahl, um Tarife zu vergleichen. In Deutschland lag der Durchschnittspreis 2026 bei etwa 1,50 bis 2,50 Euro pro GB. Tarife mit großem Datenvolumen (20+ GB) bieten oft einen günstigeren GB-Preis von unter 1 Euro. Wenn Ihr Kosten-pro-GB-Wert deutlich über 3 Euro liegt, lohnt sich ein Tarifwechsel. Zum Vergleich: In anderen EU-Ländern wie Finnland oder Polen liegt der GB-Preis bei unter 0,50 Euro.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Echte gegen scheinbare Handykosten',
        html: `<p>Was ein Handy wirklich im Monat kostet, lässt sich selten an einer einzigen Zahl ablesen. Neben dem reinen <strong>Tarifpreis</strong> stecken in den Gesamtkosten oft eine versteckte <strong>Geräterate</strong>, kostenpflichtige Zusatzoptionen und einmalige Gebühren. Erst wenn man diese Bausteine zusammenrechnet, wird die effektive Monatsbelastung sichtbar.</p><p>Dieser Rechner macht genau das: Er addiert den Tarif, die Zusatzoptionen und den auf die Laufzeit verteilten Gerätepreis zu den <strong>effektiven Monatskosten</strong> und rechnet sie aufs Jahr hoch. So wird vergleichbar, was sonst hinter „nur 1 Euro Zuzahlung"-Angeboten verschwimmt. Es geht dabei nicht um Verzicht, sondern um Klarheit: Wer seine echten Kosten kennt, erkennt schnell, ob ein Tarif zum eigenen Nutzungsverhalten passt. Wie viele <strong>Arbeitsstunden</strong> hinter dem Handyvertrag stehen, zeigt ergänzend der <a href="/finanzen/stundenlohn-rechner">Stundenlohn-Rechner</a> — eine überraschend greifbare Perspektive auf laufende Fixkosten. Gerade weil die Beträge klein wirken, lohnt der Blick auf die Jahressumme: 45 € im Monat sind über zwei Jahre bereits mehr als 1.000 €, oft mehr als das Gerät neu gekostet hat.</p>`,
      },
      {
        typ: 'vergleich',
        titel: 'Laufzeitvertrag gegen Prepaid',
        spalteA: 'Laufzeitvertrag',
        spalteB: 'Prepaid',
        zeilen: [
          { kriterium: 'Zahlung', a: 'feste Monatsrate, meist 24 Monate', b: 'Guthaben aufladen, keine Bindung' },
          { kriterium: 'Kosten', a: 'ab ca. 10–20 €/Monat als SIM-only', b: '5–10 €/Monat für Wenignutzer' },
          { kriterium: 'Preis pro GB', a: 'große Pakete günstiger pro GB', b: 'kleine Pakete, teurer pro GB' },
          { kriterium: 'Kostenkontrolle', a: 'feste monatliche Rechnung, aber Vertragsbindung', b: 'voll im Griff, da nur aufgeladenes Guthaben ausgegeben wird' },
          { kriterium: 'Flexibilität', a: 'gering; monatlich kündbare Tarife als Mittelweg', b: 'hoch, jederzeit wechselbar' },
          { kriterium: 'Aufladen/Abbuchen', a: 'automatisch per monatlicher Lastschrift', b: 'manuell oder per Auto-Aufladung frei wählbar' },
          { kriterium: 'Geeignet für', a: 'Vielnutzer mit hohem, regelmäßigem Datenbedarf', b: 'Wenignutzer, Zweitkarte oder Kinderhandy' },
        ],
      },
      {
        typ: 'beispielrechnung',
        titel: 'Effektive Monatskosten Schritt für Schritt',
        schritte: [
          { label: 'Tarifpreis', formel: '', ergebnis: '15 €' },
          { label: 'Geräterate', formel: '600 € ÷ 24 Monate', ergebnis: '25 €' },
          { label: 'Auslandsoption', formel: '', ergebnis: '5 €' },
          { label: 'Effektive Monatskosten', formel: '15 + 25 + 5', ergebnis: '45 €' },
          { label: 'Pro Jahr', formel: '45 × 12', ergebnis: '540 €' },
          { label: 'Über die Laufzeit', formel: '45 × 24', ergebnis: '1.080 €' },
        ],
        fazit: 'Der reine Tarif von 15 € wirkt günstig — doch mit der auf 24 Monate verteilten Geräterate (600 € ÷ 24 = 25 €) und einer Auslandsoption von 5 € liegen die effektiven Monatskosten bei 45 €, also 540 € im Jahr. Über die volle Laufzeit summiert sich das auf 1.080 €. Genau diese Aufteilung macht den Unterschied sichtbar: Das Gerät kostet effektiv mehr als der Tarif selbst. Wichtig ist, die Geräterate nur einmal zu zählen — sie steckt entweder im höheren Monatspreis eines Bündelangebots oder im einmaligen Kaufpreis beim Separatkauf, nie in beidem. Der Rechner trennt diese Bausteine sauber und zeigt, welcher Posten den größten Anteil ausmacht.',
      },
      {
        typ: 'vergleich',
        titel: 'Gebündelt gegen getrennt gekauft',
        spalteA: 'Gerät im Tarif gebündelt',
        spalteB: 'Gerät separat gekauft',
        zeilen: [
          { kriterium: 'Tarif pro Monat', a: 'höher, z. B. 45 €', b: 'SIM-only, z. B. 12 €' },
          { kriterium: 'Gerät', a: 'im Monatspreis versteckt', b: 'einmalig zum Marktpreis, z. B. 540 €' },
          { kriterium: 'Summe über 24 Monate', a: '45 × 24 = 1.080 €', b: '12 × 24 + 540 = 828 €' },
          { kriterium: 'Ersparnis', a: 'keine', b: '≈ 252 € (rund ein Viertel)' },
          { kriterium: 'Verivox-Schnitt', a: 'Referenz', b: 'Ø 25 %, in der Spitze bis 37 % günstiger' },
          { kriterium: 'Wichtig', a: 'Geräterate läuft oft auch nach voller Abzahlung weiter', b: 'Gerätepreis fällt nur einmal an, keine versteckte Doppelrate' },
        ],
      },
      {
        typ: 'statistik',
        titel: 'Mobilfunkmarkt 2025/2026 in Zahlen',
        werte: [
          { label: 'Ø Preis pro GB in Deutschland', wert: '1,80 €', hinweis: 'tefficient 2025; europäische Spitzengruppe' },
          { label: 'Günstigster DE-Tarif mit 10 GB', wert: '18,92 €', hinweis: 'EU-Ø 11,64 € — rund 63 % über dem Durchschnitt' },
          { label: 'Tarife im 2. Vertragsjahr teurer', wert: '40 %', hinweis: 'Verivox 2025; höherer Preis bei unveränderter Leistung' },
          { label: 'Ø mobiler Datenverbrauch', wert: '< 5 GB/Monat', hinweis: 'Bundesnetzagentur Jahresbericht 2024; viele 20-GB-Tarife sind überdimensioniert' },
          { label: 'Ersparnis durch Getrenntkauf', wert: 'Ø 25 %', hinweis: 'Verivox 25.11.2025; in der Spitze bis 37 %' },
          { label: '5-GB-Allnet-Flat beim Discounter', wert: 'oft < 10 €/Monat', hinweis: 'für die meisten Alltagsnutzer ausreichend' },
        ],
      },
      {
        typ: 'infobox',
        variante: 'warnung',
        titel: 'Versteckte Kosten im Handyvertrag',
        text: 'Nicht jede Position steht groß auf dem Werbeplakat. Häufige Zusatzkosten sind: eine einmalige Anschlussgebühr (oft 25–40 €), Roaming-Gebühren außerhalb der EU, teure Sonderrufnummern (0900er, 0180er) sowie Zusatzdienste, die bei Vertragsabschluss „kostenlos" aktiviert werden und nach der Testphase Geld kosten. Auch eine zweite SIM (MultiSIM oder eSIM) schlägt monatlich zu Buche. Besonders tückisch ist die automatische Vertragsverlängerung: Wer die Kündigungsfrist verpasst, bleibt oft zu schlechteren Konditionen gebunden. Verivox hat 2025 gezeigt, dass rund 40 % der Tarife ab dem zweiten Jahr teurer werden — bei unveränderter Leistung. Hinzu kommen Kosten, wenn das Datenvolumen überschritten wird: Manche Tarife drosseln dann nur die Geschwindigkeit, andere buchen kostenpflichtig nach. Ein Blick auf die monatliche Rechnung, ein bewusst gewähltes Datenpaket und ein notierter Kündigungstermin schützen vor solchen stillen Aufschlägen — und kosten nichts außer ein paar Minuten im Quartal. Wer einen Preisanstieg im Anschreiben des Anbieters bemerkt, hat häufig ein Sonderkündigungsrecht und kann zum Wechselzeitpunkt ein besseres Angebot mitnehmen.',
      },
      {
        typ: 'tabelle',
        titel: 'Wie viel Datenvolumen braucht welcher Nutzungstyp?',
        kopf: ['Nutzungstyp', 'Typische Aktivitäten', 'Datenbedarf/Monat'],
        zeilen: [
        ...
        fussnote: 'Laut Bundesnetzagentur liegt der durchschnittliche mobile Datenverbrauch in Deutschland noch unter 5 GB pro Monat. Viele gebuchte Tarife mit 20 GB oder mehr sind damit deutlich überdimensioniert — und teurer als nötig. Wer den eigenen Verbrauch in den Smartphone-Einstellungen prüft, findet oft heraus, dass ein kleineres Paket völlig ausreicht, zumal das meiste Datenvolumen ohnehin im heimischen oder beruflichen WLAN anfällt. Ein zu großes Paket ist kein Sicherheitspuffer, sondern meist nur ein dauerhaft zu hoher Festpreis. Wer viel unterwegs streamt oder den Anschluss als Tethering für den Laptop nutzt, liegt natürlich höher — für diese Fälle lohnt ein größeres Paket. Entscheidend ist, die eigene Realität ein bis zwei Monate lang zu messen, statt nach Gefühl ein üppiges Volumen zu buchen.',
      },
      {
        typ: 'vergleich',
        titel: 'Deutschland gegen den EU-Durchschnitt',
        spalteA: 'Deutschland',
        spalteB: 'EU-Vergleich',
        zeilen: [
          { kriterium: 'Ø Preis pro GB', a: '≈ 1,80 €', b: 'Baltikum 0,25 €, Polen 0,35 €' },
          { kriterium: 'Günstigster 10-GB-Tarif', a: '18,92 €', b: 'EU-Ø 11,64 €' },
          { kriterium: '50-GB-Tarif', a: '28,88 €', b: 'rund 45 % über EU-Ø' },
          { kriterium: '20-GB-Tarif', a: '19,88 €', b: 'rund 23 % über EU-Ø' },
          { kriterium: 'Einordnung', a: 'europäische Spitzengruppe (teuer)', b: 'Nord- und Osteuropa deutlich günstiger' },
          { kriterium: 'Folge für Nutzer', a: 'Vergleichen lohnt sich hier besonders', b: 'die günstigsten Tarife gibt es oft nur über einen Anbieterwechsel' },
          { kriterium: 'Grund', a: 'hohe Netzausbau-Kosten, vergleichsweise wenig Preiskampf', b: 'dichtere Märkte mit deutlich mehr Wettbewerb' },
          { kriterium: 'Roaming', a: 'EU-weit zu Inlandskonditionen', b: 'außerhalb der EU oft deutlich teurer' },
        ],
      },
      {
        typ: 'checkliste',
        titel: 'Handykosten senken — die wichtigsten Hebel',
        punkte: [
      ...
      {
        typ: 'text',
        titel: 'Gerätelebensdauer als stärkster Hebel',
        html: `<p>Der wirksamste Stellhebel bei den Handykosten ist nicht der Tarif, sondern die <strong>Nutzungsdauer des Geräts</strong>. Da der Gerätepreis auf die Monate verteilt wird, sinkt die effektive Rate mit jedem zusätzlichen Nutzungsjahr. Ein Smartphone für 600 € kostet über 2 Jahre 25 € im Monat, über 4 Jahre nur noch 12,50 € — die effektiven Gerätekosten halbieren sich, ohne dass man auf irgendetwas verzichtet.</p><p>Moderne Geräte erhalten heute oft fünf oder mehr Jahre Sicherheitsupdates, und ein Akkutausch kostet einen Bruchteil eines Neugeräts. Wer sein Handy bewusst länger nutzt, spart über die Jahre dreistellige Beträge und schont nebenbei die Umwelt, weil weniger Elektroschrott anfällt. Ein gebraucht oder generalüberholt gekauftes Vorjahresmodell senkt die effektive Rate zusätzlich, ohne spürbare Einbußen im Alltag. Der Handytarif ist letztlich ein Abo wie viele andere — wer den Überblick über alle laufenden Verträge behalten will, nutzt dafür den <a href="/alltag/abo-rechner">Abo-Rechner</a>, und für die Einordnung ins gesamte Monatsbudget den <a href="/alltag/budget-rechner">Budget-Rechner</a>.</p>`,
      },
      {
        typ: 'text',
        titel: 'Warum viele Tarife überdimensioniert sind',
        html: `<p>Große Datenpakete wirken wie ein Schnäppchen, weil der Preis pro Gigabyte sinkt — doch das nützt wenig, wenn das Volumen ungenutzt verfällt. Bei einem Durchschnittsverbrauch von unter 5 GB zahlen viele Haushalte dauerhaft für 20 GB oder mehr, die sie nie ausschöpfen. Der vermeintlich günstige GB-Preis verleitet so zu einem insgesamt zu teuren Tarif.</p><p>Sinnvoller ist es, vom realen Verbrauch auszugehen und einen kleinen Puffer einzuplanen, statt sich vom Pro-GB-Preis leiten zu lassen. Eine 5-GB-Allnet-Flat gibt es beim Discounter oft für unter 10 € im Monat — für die meisten Alltagsnutzer völlig ausreichend. Was dadurch frei wird, lässt sich mit dem <a href="/finanzen/sparrechner">Sparrechner</a> als wachsende Rücklage weiterdenken: Schon 15 € weniger im Monat sind 180 € im Jahr, die an anderer Stelle mehr Wirkung entfalten. Der Pro-GB-Preis ist also nur dann eine sinnvolle Kennzahl, wenn man das Volumen auch tatsächlich nutzt — sonst vergleicht man den Preis für etwas, das ungenutzt verfällt. Ehrlicher ist die Frage nach dem Gesamtpreis für das Volumen, das man wirklich braucht.</p>`,
      },
      {
        typ: 'infobox',
        variante: 'hinweis',
        titel: 'Richtwerte statt Einzelfall',
        text: 'Die genannten Preise sind Marktdurchschnitte mit Stand 2025/2026 aus Quellen wie Verivox, tefficient, der EU-Kommission und der Bundesnetzagentur. Sie dienen der Einordnung — der konkrete Tarif hängt von Anbieter, Netz, Datenvolumen und gewählten Optionen ab und ändert sich laufend. Der Rechner bildet ausschließlich die eingegebenen Beträge ab und spricht bewusst keine Empfehlung für einen bestimmten Anbieter oder Tarif aus. Er ersetzt keine individuelle Vertragsberatung, sondern schafft Transparenz über die effektiven Gesamtkosten Ihres Handys. Roaming-, Auslands- und Sonderrufnummern-Tarife sind nicht abgebildet und können im Einzelfall stark abweichen. Innerhalb der EU gelten seit der Roaming-Verordnung die Inlandskonditionen, außerhalb können jedoch hohe Gebühren anfallen. Welcher Tarif am Ende der richtige ist, entscheiden Sie selbst — am besten nach einem aktuellen Vergleich. Auch die Beispielwerte auf dieser Seite dienen nur der Veranschaulichung; im Rechner zählen ausschließlich Ihre eigenen Eingaben zu Tarif, Gerät und Optionen. So entsteht ein realistisches Bild Ihrer persönlichen Handykosten, das Sie jederzeit mit neuen Angeboten gegenrechnen können.',
      },
    ],
    quellen: [
      { titel: 'Verivox-Preisanalyse Smartphone + Tarif (Stand 25.11.2025)', hinweis: 'Getrenntkauf Ø 25 %, bis 37 % günstiger als gebündeltes Angebot; Modellfälle Durchschnitts- und Premiumnutzer.' },
      { titel: 'Verivox-Tarifanalyse September 2025', hinweis: '40 % aller Mobilfunktarife werden ab dem 2. Vertragsjahr teurer bei gleicher Leistung; nach Mindestlaufzeit monatlich kündbar.' },
      { titel: 'tefficient / TK-Wettbewerb: Mobilfunkkosten 2025', hinweis: 'Ø Umsatz pro GB in Deutschland ~1,80 €; europäische Spitzengruppe. Günstigste Länder Baltikum/Polen/Finnland.' },
      { titel: 'EU-Kommission: Mobilfunkpreise im Vergleich', hinweis: 'Günstigster DE-Tarif 10 GB 18,92 € (EU-Ø 11,64 €); deutsche Mobilfunkpreise signifikant über EU27-Durchschnitt.' },
      { titel: 'Bundesnetzagentur Jahresbericht 2024', hinweis: 'Ø mobiler Datenverbrauch in DE unter 5 GB/Monat; Grundlage für Tarif-Dimensionierung.' },
      { titel: 'Handykosten-Methodik', hinweis: 'Effektive Monatskosten = Tarif + Zusatzoptionen + Gerätepreis ÷ Laufzeit; Jahreskosten × 12. Marktdurchschnitte, keine Anbieterempfehlung.' },
    ],
  },
  {
    ...
    beispiel: '60 m², 50 km, 2. OG → 2. OG, Umzugsfirma: 1.500 € Basis + 300 € Etage = 1.800 € | Selbst: ca. 325 € (Differenz 1.475 €).',
...
Bei einem berufsbedingten Umzug können Sie die Kosten als Werbungskosten von der Steuer absetzen. Der Umzug gilt als berufsbedingt, wenn sich Ihr Arbeitsweg dadurch um mindestens 30 Minuten verkürzt, Sie einen neuen Job antreten oder versetzt werden. Absetzbar sind: Transportkosten, doppelte Miete (max. 6 Monate), Maklerkosten für die neue Wohnung und eine Umzugskostenpauschale für sonstige Ausgaben (ab 01.03.2024, unverändert für 2025 und 2026: **964 Euro** für den Umziehenden, plus **643 Euro** pro weitere Person im Haushalt). Bei privatem Umzug können Handwerker- und Transportkosten als haushaltsnahe Dienstleistungen geltend gemacht werden (20% der Arbeitskosten, max. 4.000 Euro/Jahr).
...
Tipp: Umzüge am Monatsanfang oder unter der Woche sind oft günstiger als am Monatsende oder Wochenende. Weitere hilfreiche Rechner: Mit dem [Mietrechner](/wohnen/mietrechner) können Sie die Mietbelastung für die neue Wohnung prüfen und der [Nebenkostenrechner](/wohnen/nebenkosten-rechner) hilft bei der Einschätzung der Betriebskosten.`,
    faq: [
      ...
      },
      {
        ...
        antwort: 'Bei berufsbedingtem Umzug ja — als Werbungskosten. Der Umzug gilt als berufsbedingt, wenn sich Ihr Arbeitsweg um mindestens 30 Minuten verkürzt. Absetzbar sind Transportkosten, doppelte Miete (max. 6 Monate), Makler und eine Pauschale (964 € plus 643 € pro weitere Person). Bei privatem Umzug können Handwerkerkosten als haushaltsnahe Dienstleistungen geltend gemacht werden.',
      },
      {
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Wovon die Umzugskosten abhängen',
        html: `<p>Was ein Umzug kostet, lässt sich nicht pauschal sagen — der Preis ergibt sich aus mehreren Faktoren: der <strong>Wohnungsgröße</strong> (mehr Quadratmeter bedeuten mehr Volumen und Arbeitszeit), der <strong>Entfernung</strong> zwischen alter und neuer Adresse, der <strong>Etage</strong> samt Aufzug oder Treppe, der <strong>Jahreszeit</strong> und vor allem der Frage, ob eine Umzugsfirma beauftragt oder selbst organisiert wird.</p><p>Dieser Rechner schätzt beide Wege: Für die <strong>Umzugsfirma</strong> rechnet er Wohnfläche mal einen entfernungsabhängigen Quadratmeterpreis plus Etagenzuschlag und gewählte Zusatzleistungen. Für den <strong>Selbstumzug</strong> summiert er Transportermiete, Kilometerkosten, Verpackungsmaterial und Verpflegung der Helfer. So wird die Spanne zwischen bequem und günstig sichtbar. Die Ergebnisse sind Richtwerte zur Orientierung, kein verbindliches Angebot — für eine belastbare Zahl holt man am Ende immer mehrere Angebote ein. Wer die neue Mietbelastung gleich mitdenken will, ordnet die Umzugskosten am besten ins gesamte Haushaltsbudget ein, etwa mit dem <a href="/alltag/budget-rechner">Budget-Rechner</a>; was vor dem Umzug zurückgelegt wird, lässt sich mit dem <a href="/finanzen/sparrechner">Sparrechner</a> planen. So bleibt der Umzug auch in den Monaten danach bezahlbar, wenn Kaution und neue Einrichtung zusammenkommen.</p>`,
      },
      {
        typ: 'checkliste',
        titel: 'Umzugs-Zeitplan — was wann zu tun ist',
        punkte: [
      ...
      {
        typ: 'beispielrechnung',
        titel: 'Firma gegen Selbstumzug — 60 m², 50 km',
        schritte: [
          { label: 'Basiskosten Firma', formel: '60 m² × 25 €/m²', ergebnis: '1.500 €' },
          { label: 'Etagenzuschlag', formel: '1.500 × 4 Etagen × 5 %', ergebnis: '300 €' },
          { label: 'Umzugsfirma gesamt', formel: '1.500 + 300', ergebnis: '1.800 €' },
          { label: 'Selbst: Transporter + km', formel: '120 + 35', ergebnis: '155 €' },
          { label: 'Selbst: Verpackung + Verpflegung', formel: '120 + 50', ergebnis: '170 €' },
          { label: 'Selbstumzug gesamt', formel: '155 + 170', ergebnis: '325 €' },
          { label: 'Differenz', formel: '1.800 − 325', ergebnis: '1.475 €' },
        ],
        fazit: 'Für eine 60-m²-Wohnung über 50 km mit jeweils zweitem Obergeschoss veranschlagt der Rechner rund 1.800 € für die Umzugsfirma — 1.500 € Basis (60 m² × 25 €/m²) plus 300 € Etagenzuschlag. Der Selbstumzug kommt dagegen auf etwa 325 €: ein 3,5-Tonner für 120 €, 35 € Kilometerkosten, 120 € Verpackung und 50 € Verpflegung. Die Differenz von 1.475 € ist der Preis für Bequemlichkeit, Haftung und gesparte Zeit. Hinzu kommen unabhängig vom Weg rund 300 € Renovierung und 30 € für den Nachsendeauftrag. Welche Variante passt, hängt von Budget, Möbeln und verfügbaren Helfern ab.',
      },
      {
        typ: 'tabelle',
        titel: 'Richtpreise nach Wohnungsgröße und Entfernung',
        kopf: ['Umzug', 'Mit Firma', 'In Eigenregie'],
        zeilen: [
          ['1-Zimmer, lokal', '400–800 €', '150–300 €'],
          ['2-Zimmer (60 m²), lokal', '800–1.500 €', '250–400 €'],
          ['3-Zimmer, lokal', '1.200–2.000 €', '300–500 €'],
          ['Fernumzug ab 500 km', '2.000–4.000 €', '500–900 €'],
        ],
        fussnote: 'Die Werte sind Richtgrößen aus dem deutschen Markt und schwanken regional sowie nach Saison erheblich. In der Hauptsaison von Mai bis September liegen die Firmenpreise oft 20–30 % höher als im Winterhalbjahr. Zusatzleistungen wie Einpackservice, Möbelmontage oder ein Klaviertransport kommen extra hinzu. Der Selbstumzug ist fast immer günstiger, kostet aber Zeit und Kraft — und bei Schäden haftet man selbst. Bei Fernumzügen relativiert sich der Preisvorteil zudem, weil Sprit, längere Mietzeiten des Transporters und oft eine Übernachtung dazukommen. Für eine belastbare Zahl gilt unverändert: mindestens drei Angebote einholen und genau prüfen, welche Leistungen enthalten sind — Festpreis oder Stundenbasis, Versicherung und mögliche Aufschläge für An- und Abfahrt.',
      },
      {
        typ: 'vergleich',
        titel: 'Umzugsfirma gegen Selbstumzug',
        spalteA: 'Umzugsfirma',
        spalteB: 'Selbst organisiert',
        zeilen: [
          { kriterium: 'Kosten', a: 'höher, dafür planbar', b: 'deutlich günstiger' },
          { kriterium: 'Zeit & Kraft', a: 'gering, Profis packen und tragen', b: 'hoch, eigene Arbeit und Helfer nötig' },
          { kriterium: 'Haftung bei Schäden', a: 'über die Firma versichert', b: 'man haftet selbst' },
          { kriterium: 'Schwere Möbel / Klavier', a: 'fachgerecht erledigt', b: 'Risiko und Aufwand beim Tragen' },
          { kriterium: 'Planbarkeit', a: 'fester Termin und Festpreis möglich', b: 'abhängig von Helfern und Transporter-Verfügbarkeit' },
          { kriterium: 'Geeignet bei', a: 'großer Wohnung, Fernumzug, wertvollen Möbeln', b: 'kleiner Wohnung, kurzer Strecke, knappem Budget' },
          { kriterium: 'Kompromiss', a: 'Teilleistung: nur Transport buchen', b: 'selbst packen, Profis fahren' },
        ],
      },
      {
        typ: 'infobox',
        variante: 'tipp',
        titel: 'Beruflicher Umzug: Werbungskosten und Pauschale',
        text: 'Ist ein Umzug beruflich veranlasst, lassen sich die Kosten als Werbungskosten absetzen (§ 9 EStG, R 9.9 LStR). Als beruflich veranlasst gilt er unter anderem, wenn sich der Arbeitsweg um mindestens eine Stunde pro Tag (rund 30 Minuten je Richtung) verkürzt, bei einem Jobwechsel oder bei einer Versetzung. Für sonstige Umzugsauslagen gibt es eine Pauschale ohne Einzelnachweis: ab dem 01.03.2024 — und unverändert für 2025 und 2026 — 964 € für die umziehende Person plus 643 € je weitere Person im Haushalt; wer vorher und nachher keine eigene Wohnung hatte, erhält 193 €. Eine Familie mit zwei weiteren Personen kommt so auf 964 + 2 × 643 = 2.250 € allein an Pauschale, zusätzlich zu Transport, doppelter Miete (max. 6 Monate) und Maklerkosten für die neue Wohnung. Die Pauschale deckt Kleinkram wie Trinkgelder, Schönheitsreparaturen oder das Ummelden ab — wer höhere sonstige Auslagen einzeln nachweist, kann statt der Pauschale auch die tatsächlichen Kosten ansetzen.',
      },
      {
        typ: 'infobox',
        variante: 'hinweis',
        titel: 'Privater Umzug: § 35a EStG nutzen',
        text: 'Auch ein privater Umzug bringt einen Steuervorteil — allerdings über einen anderen Weg. Nach § 35a EStG lassen sich 20 % der Arbeitskosten haushaltsnaher Dienstleistungen und Handwerkerleistungen direkt von der Steuerschuld abziehen, höchstens 4.000 € pro Jahr. Begünstigt sind die reinen Lohn- und Fahrtkosten der Umzugsfirma, nicht jedoch Materialkosten wie Kartons oder Verpackung. Zwei Bedingungen sind zwingend: Es muss eine ordnungsgemäße Rechnung vorliegen, und die Zahlung muss unbar per Überweisung erfolgen — Barzahlung erkennt das Finanzamt nicht an. Wer also ohnehin privat umzieht, sollte die Rechnung der Umzugsfirma aufheben und keinesfalls bar zahlen, um diesen Abzug nicht zu verlieren. Der Höchstbetrag von 4.000 € gilt pro Haushalt und Jahr und umfasst alle haushaltsnahen Dienstleistungen zusammen — wer im selben Jahr noch andere Handwerker beauftragt, sollte die Grenze im Blick behalten.',
      },
      {
        typ: 'checkliste',
        titel: 'Spar-Checkliste für den Umzug',
        punkte: [
      ...
      {
        typ: 'statistik',
        titel: 'Faustregeln rund um den Umzug',
        werte: [
          { label: 'Saisonzuschlag Hauptsaison', wert: '+10–20 %', hinweis: 'April bis September, teils bis +30 %' },
          { label: 'Volumen-Faustregel', wert: '3–4 m³', hinweis: 'Transportvolumen je 10 m² Wohnfläche' },
          { label: 'Renovierung alte Wohnung', wert: '~5 €/m²', hinweis: 'grober Richtwert für Schönheitsreparaturen' },
          { label: 'Transporter bis 30 m²', wert: 'Sprinter', hinweis: 'rund 12 m³ Laderaum' },
          { label: 'Transporter 30–60 m²', wert: '3,5-t-LKW', hinweis: 'rund 20 m³; ab 3,5 t Führerschein C1' },
          { label: 'Transporter 60–90 m²', wert: '7,5-t-LKW', hinweis: 'rund 35 m³ Laderaum' },
          { label: 'Kostenpuffer einplanen', wert: '15–20 %', hinweis: 'auf die geschätzte Gesamtsumme' },
        ],
      },
      {
        typ: 'text',
        titel: 'Nebenkosten, die leicht vergessen werden',
        html: `<p>Die reinen Transportkosten sind nur ein Teil der Rechnung. Hinzu kommt häufig die <strong>Kaution</strong> für die neue Wohnung in Höhe von bis zu drei Nettokaltmieten, die zunächst gebunden ist. Dazu kommen die <strong>Renovierung</strong> der alten Wohnung (grob 5 €/m² für Schönheitsreparaturen), eine mögliche <strong>Doppelmiete</strong> im Übergangsmonat, der Nachsendeauftrag der Post sowie die Ummeldung des Autos mit rund 30 €.</p><p>Wer all diese Posten von Anfang an einplant, erlebt keine böse Überraschung — und legt sinnvollerweise einen Puffer von 15–20 % auf die geschätzte Summe. Ob die neue Wohnung dauerhaft ins Budget passt, lässt sich vorab mit dem <a href="/wohnen/mietrechner">Mietrechner</a> prüfen, und die laufenden Betriebskosten schätzt der <a href="/wohnen/nebenkosten-rechner">Nebenkosten-Rechner</a> ein. So wird aus dem einmaligen Umzug eine durchdachte Entscheidung, bei der auch die Folgekosten von Anfang an im Blick sind. Besonders die Kaution bindet schnell mehrere Tausend Euro, die erst nach dem Auszug aus der alten Wohnung zurückfließen — wer beide Mieten und die Kaution kurzzeitig parallel stemmen muss, plant das am besten als kurzfristige Rücklage ein.</p>`,
      },
      {
        typ: 'checkliste',
        titel: 'Steuer-Checkliste: Belege richtig sammeln',
        punkte: [
      ...
      },
      {
        typ: 'infobox',
        variante: 'hinweis',
        titel: 'Richtwerte und Stand der Angaben',
        text: 'Die genannten Preise sind Marktdurchschnitte und Richtwerte; die tatsächlichen Kosten hängen von Region, Anbieter, Saison und individuellem Aufwand ab und können deutlich abweichen. Der Rechner liefert eine erste Schätzung, kein verbindliches Angebot — verlassen Sie sich für die endgültige Planung auf eingeholte Firmenangebote. Die steuerlichen Angaben (Umzugskostenpauschale 964 €/643 €/193 €, § 9 EStG, § 35a EStG) entsprechen dem Stand 2026 nach dem BMF-Schreiben vom 28.12.2023 und können sich durch neue Verwaltungsanweisungen ändern. Sie ersetzen keine individuelle Steuerberatung: Ob ein Umzug im Einzelfall als beruflich veranlasst gilt und welche Posten absetzbar sind, klärt im Zweifel das Finanzamt oder eine Steuerberatung. Auch die berechnete Umzugskostenschätzung dient nur der Orientierung — sie ist weder ein Kostenvoranschlag noch eine Zusage und kann die individuelle Besichtigung durch eine Umzugsfirma nicht ersetzen. Maßgeblich sind am Ende immer das schriftliche Angebot der gewählten Firma und die geltenden Steuervorschriften zum Zeitpunkt Ihres Umzugs.',
      },
    ],
    quellen: [
      { titel: 'BMF-Schreiben vom 28.12.2023 (IV C 5 – S 2353/20/10004 :003)', hinweis: 'Pauschbeträge für sonstige Umzugsauslagen ab 01.03.2024: 964 € berechtigte Person, 643 € je weitere Person, 193 € ohne eigene Wohnung. Unverändert für 2025/2026.' },
      { titel: '§ 10 Bundesumzugskostengesetz (BUKG)', hinweis: 'Rechtsgrundlage der Umzugskostenpauschale für sonstige Umzugsauslagen bei beruflich veranlasstem Umzug.' },
      { titel: '§ 9 EStG / R 9.9 LStR', hinweis: 'Beruflich veranlasster Umzug als Werbungskosten; berufliche Veranlassung u. a. bei Arbeitsweg-Verkürzung von mind. 1 Std./Tag.' },
      { titel: '§ 35a EStG', hinweis: 'Privater Umzug: 20 % der Arbeitskosten haushaltsnaher Dienstleistungen, max. 4.000 € pro Jahr; unbare Zahlung erforderlich.' },
      { titel: 'Umzugskosten-Methodik', hinweis: 'Firma: Wohnfläche × €/m² (entfernungsabhängig) + Etagenzuschlag. Selbst: Transporter + km + Verpackung + Verpflegung. Richtwerte, kein verbindliches Angebot.' },
    ],
  },
  {
...
**Weitere Rechner:** Für Ihr eigenes Lebensalter und wie viele Tage Sie schon leben nutzen Sie den Lebenszeit-Rechner. Für Geburtstage den Geburtstag-Rechner. Für Tage zwischen zwei Daten den Tagerechner.`,
  ...
  },
  {
    ...
    metaDescription: 'D-Mark kostenlos in Euro umrechnen zum unwiderruflich festgelegten Kurs 1 € = 1,95583 DM — plus 20 weitere Altwährungen der Eurozone.',
...
- City-Cards für öffentliche Verkehrsmittel und Sehenswürdigkeiten.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Was alles in ein Reisebudget gehört',
        html: `<p>Ein realistisches Reisebudget besteht aus weit mehr als dem Flug- oder Hotelpreis. Die fünf großen Blöcke sind <strong>Anreise</strong> (Sprit und Maut beim Auto oder Ticketpreis bei Bahn und Flug), <strong>Unterkunft</strong> pro Nacht, <strong>Verpflegung</strong>, <strong>Aktivitäten</strong> samt Eintritten und eine eventuelle <strong>Reiseversicherung</strong>. Dazu kommt ein Puffer für Unvorhergesehenes. Erst wenn alle Posten zusammenstehen, wird sichtbar, was eine Reise tatsächlich kostet.</p><p>Dieser Rechner führt diese Bausteine zusammen und zeigt die Kosten als Gesamtsumme, pro Person und pro Tag — mit einer Aufteilung der einzelnen Blöcke. So lässt sich das Urlaubsbudget vorab planen, statt am Ende der Reise überrascht zu werden. Wichtig: Es geht hier um die <strong>private Urlaubsplanung</strong>, nicht um steuerliche Reisekosten oder Dienstreisen. Wer die Reise in seine gesamten Monatsausgaben einordnen möchte, nutzt ergänzend den <a href="/alltag/budget-rechner">Budget-Rechner</a> und plant die Rücklage rechtzeitig ein. So wird aus einer groben Schätzung im Kopf eine belastbare Zahl, mit der sich Ziel, Dauer und Komfort der Reise bewusst abwägen lassen.</p>`,
      },
      {
        typ: 'tabelle',
      ...
      {
        typ: 'beispielrechnung',
        titel: 'Wie die Anreisekosten mit dem Auto entstehen',
        schritte: [
      ...
      {
        typ: 'tabelle',
        titel: 'Was ein Haupturlaub je nach Ziel kostet',
        kopf: ['Reiseziel', 'Ø Kosten pro Person', 'Einordnung'],
        zeilen: [
          ['Inland (Deutschland)', '1.170 €', 'günstigster Schnitt'],
          ['Österreich', '1.183 €', 'preiswertes Nachbarland'],
          ['Kroatien', '1.303 €', 'beliebtes Mittelmeerziel'],
          ['Italien', '1.672 €', 'oberes Mittelfeld'],
          ['Türkei', '1.766 €', 'oft als Pauschalreise'],
          ['Griechenland', '1.872 €', 'teuerstes Mittelmeerziel'],
          ['Fernreise', '2.673 €', 'höchste Kosten je Person'],
        ],
        fussnote: 'Die Werte stammen aus der 42. Deutschen Tourismusanalyse 2026 und beziehen sich auf den Haupturlaub pro Person, inklusive Anreise, Unterkunft und Verpflegung. Sie zeigen, dass das Reiseziel den größten Einzelhebel auf die Gesamtkosten hat: Zwischen einem Inlandsurlaub und einer Fernreise liegen im Schnitt mehr als 1.500 € pro Person. Innerhalb Europas ist die Spanne kleiner, aber spürbar — wer flexibel beim Ziel ist, kann allein durch die Wahl des Landes mehrere Hundert Euro sparen, ohne beim Komfort Abstriche zu machen. Zu beachten ist, dass diese Durchschnitte über alle Reisestile mitteln — ein Sparurlaub in Griechenland kann günstiger ausfallen als eine Komfortreise nach Österreich.',
      },
      {
        typ: 'statistik',
        titel: 'Der deutsche Reisemarkt in Zahlen',
        werte: [
          { label: 'Ø Haupturlaub 2025', wert: '1.636 €/Person', hinweis: 'Rekordwert, +100 € gegenüber 2024' },
          { label: 'Tageskosten im Schnitt', wert: '130 €/Person', hinweis: '2015 noch 88 €; Fernreise 141 €' },
          { label: 'Durchschnittliche Reisedauer', wert: '~13 Tage', hinweis: 'seit Jahren stabil' },
          { label: 'Mindestens eine 5-tägige Reise', wert: '64 %', hinweis: 'der Befragten 2025' },
          { label: 'Mehrfach verreist', wert: '44 %', hinweis: 'mehr als eine längere Reise im Jahr' },
          { label: 'Reiseziel im Inland', wert: '35 %', hinweis: 'beliebtestes Einzelziel der Deutschen' },
          { label: 'Reisen außerhalb der EU', wert: '17,4 %', hinweis: 'höhere Anreise- und Nebenkosten' },
        ],
      },
      {
        typ: 'vergleich',
        titel: 'Anreise mit dem Auto gegen Bahn oder Flug',
        spalteA: 'Auto',
        spalteB: 'Bahn / Flug',
        zeilen: [
          { kriterium: 'Kostenlogik', a: 'Sprit + Maut, unabhängig von der Personenzahl', b: 'fester Preis pro Person' },
          { kriterium: '1 Person', a: 'voller Spritpreis allein', b: 'oft günstiger, vor allem mit Sparpreis' },
          { kriterium: '2–4 Personen', a: 'Kosten teilen sich, meist am günstigsten', b: 'Preis vervielfacht sich pro Kopf' },
          { kriterium: 'Flexibilität', a: 'hoch, jederzeit losfahren, Gepäck frei', b: 'an Fahrplan und Gepäckgrenzen gebunden' },
          { kriterium: 'Vor Ort', a: 'Wagen verfügbar, aber Parkkosten', b: 'Mietwagen oder Nahverkehr nötig' },
          { kriterium: 'Zeit & Komfort', a: 'lange Strecken anstrengend', b: 'schnell und entspannter, kein Fahren' },
        ],
      },
      {
        typ: 'infobox',
        variante: 'warnung',
        titel: 'Zusatzkosten, die das Budget sprengen',
        text: 'Die Hauptposten sind schnell kalkuliert — die Überraschungen lauern im Kleingedruckten. Häufig vergessen werden: eine Reiserücktritts- und Auslandskrankenversicherung (zusammen oft 30–80 €), die Kurtaxe an vielen Urlaubsorten (1–4 € pro Person und Tag), Parkgebühren am Flughafen oder Hotel, Roaming-Kosten außerhalb der EU, die Kaution und Vollkasko beim Mietwagen sowie Trinkgelder, die in manchen Ländern fest erwartet werden. Auch Gepäck- und Sitzplatzgebühren bei Billigflügen und die Wechselkurs-Aufschläge beim Geldabheben im Ausland summieren sich. Wer einen Puffer von 10–15 % auf die Gesamtsumme einplant, fängt diese Posten ab und muss im Urlaub nicht knausern. Es lohnt sich, die typischen Zusatzkosten des konkreten Ziels vorab kurz zu recherchieren — gerade Kurtaxe, Roaming und Mietwagen-Selbstbeteiligung werden oft erst vor Ort sichtbar. Eine gute Reisekreditkarte ohne Fremdwährungsgebühr spart außerhalb der Eurozone zusätzlich bares Geld.',
      },
      {
        typ: 'tabelle',
        titel: 'Tagesbudget je nach Reisestil',
        kopf: ['Reisestil', 'Pro Person und Tag', 'Typisch dafür'],
        zeilen: [
          ['Sparreise', '~70 €', 'Hostel, Selbstverpflegung, kostenlose Highlights'],
          ['Mittelklasse', '~130 €', 'Budget-Hotel, Mischung aus Kochen und Restaurant'],
          ['Komfort', '200 €+', 'gutes Hotel, Restaurants, viele Aktivitäten'],
        ],
        fussnote: 'Das Tagesbudget umfasst Unterkunft, Verpflegung und Aktivitäten, aber nicht die einmalige Anreise. Der Mittelklasse-Richtwert von rund 130 € deckt sich mit dem Durchschnitt der Tourismusanalyse. Nach oben ist die Spanne offen — in teuren Städten oder bei gehobenem Anspruch sind auch 250 € und mehr schnell erreicht. Nach unten lässt sich mit Ferienwohnung, Selbstverpflegung und kostenlosen Sehenswürdigkeiten viel bewegen. Der größte Unterschied entsteht meist bei der Verpflegung: Wer überwiegend selbst kocht statt auswärts zu essen, halbiert diesen Posten oft. Auch innerhalb desselben Ziels lässt sich der Reisestil frei wählen — ein Sparreisender und ein Komfortreisender können im selben Land Welten an Tagesbudget auseinanderliegen.',
      },
      {
        typ: 'checkliste',
        titel: 'Reisekosten senken — ohne Verzicht auf Urlaub',
        punkte: [
          'In der Nebensaison reisen — je nach Ziel sind 20–40 % günstiger als in der Hauptsaison drin.',
          'Flüge und Hotels früh buchen, idealerweise drei bis sechs Monate vorher, und flexible Reisedaten nutzen.',
          'Ferienwohnung statt Hotel wählen, gerade für Familien und Gruppen — mit Küche sinken die Essenskosten deutlich.',
          'Bei der Autoanreise Mitfahrende einplanen, um die Spritkosten pro Kopf zu senken.',
          'Lokale Supermärkte und Märkte statt Touristenrestaurants nutzen, zumindest für einen Teil der Mahlzeiten.',
          'Pauschalreise und Einzelbuchung gegenrechnen — mal ist das Paket günstiger, mal die freie Kombination.',
          'City-Cards für Nahverkehr und Sehenswürdigkeiten prüfen, wenn viele Eintritte geplant sind.',
          'Eine Reisekreditkarte ohne Fremdwährungsgebühr nutzen, um beim Bezahlen im Ausland nicht draufzuzahlen.',
        ],
      },
      {
        typ: 'text',
        titel: 'Anreise und Fremdwährung clever planen',
        html: `<p>Zwei Posten lassen sich mit etwas Vorbereitung gut steuern. Bei der <strong>Anreise mit dem Auto</strong> hängen die Spritkosten direkt von Strecke, Verbrauch und Spritpreis ab — wer die echte Distanz und einen realistischen Literpreis ansetzt, plant genauer. Die reinen Spritkosten für eine Strecke lassen sich vorab mit dem <a href="/auto/spritkosten-rechner">Spritkosten-Rechner</a> abschätzen und dann im Reisebudget berücksichtigen.</p><p>Bei Reisen außerhalb der Eurozone kommt die <strong>Fremdwährung</strong> ins Spiel. Wechselkurse und die Gebühren beim Abheben oder Bezahlen im Ausland können mehrere Prozent ausmachen. Wer den ungefähren Betrag in Landeswährung kennt, vermeidet böse Überraschungen — eine schnelle Umrechnung liefert der <a href="/alltag/waehrungsrechner">Währungsrechner</a>. So bleibt das Urlaubsbudget auch dann belastbar, wenn vor Ort in einer anderen Währung bezahlt wird, und man behält den Überblick über die tatsächlichen Ausgaben. Ein guter Richtwert: Statt am Flughafen zu schlechten Kursen zu wechseln, hebt man besser direkt vor Ort am Geldautomaten ab — am günstigsten mit einer Karte ohne Fremdwährungsgebühr.</p>`,
      },
      {
        typ: 'text',
        titel: 'Mit Budget-Disziplin entspannt verreisen',
        html: `<p>Ein geplantes Reisebudget wirkt am besten, wenn es vor der Buchung steht — nicht erst, wenn die Kreditkartenabrechnung kommt. Sinnvoll ist, einen Gesamtbetrag festzulegen und ihn auf die Posten und Reisetage herunterzubrechen. Eine einfache <strong>Tageskasse</strong> vor Ort hilft, den Rahmen zu halten, ohne ständig nachrechnen zu müssen.</p><p>Damit der Urlaub das übrige Budget nicht aus der Bahn wirft, lohnt sich eine <strong>Urlaubsrücklage</strong>, die übers Jahr verteilt aufgebaut wird. Schon ein fester Monatsbetrag summiert sich: Wer den Ø-Haupturlaub von gut 1.600 € pro Person anpeilt, legt dafür rund 135 € im Monat zurück. Wie eine solche Rücklage anwächst, lässt sich mit dem <a href="/finanzen/sparrechner">Sparrechner</a> durchspielen. So wird die Reise schon bezahlt, bevor sie beginnt — und der Urlaub bleibt frei von finanziellem Nachklang. Wer den Sparbetrag per Dauerauftrag automatisiert, merkt die Belastung kaum und steht im Sommer mit gefüllter Reisekasse da, ganz ohne Kreditkartenstress im Herbst.</p>`,
      },
      {
        typ: 'infobox',
        variante: 'hinweis',
        titel: 'Richtwerte statt Festpreis',
        text: 'Die genannten Durchschnitte stammen aus der 42. Deutschen Tourismusanalyse 2026 und dienen der Einordnung. Die tatsächlichen Reisekosten variieren stark nach Ziel, Saison, Komfortanspruch und Buchungszeitpunkt — derselbe Urlaub kann je nach Woche und Anbieter mehrere Hundert Euro auseinanderliegen. Der Rechner bildet ausschließlich die von Ihnen eingegebenen Werte ab und versteht sich als Planungshilfe, nicht als Reiseangebot oder Preisgarantie. Es geht um die private Urlaubsplanung, nicht um steuerlich absetzbare Reisekosten, Verpflegungsmehraufwand oder Dienstreisepauschalen — dafür gelten eigene Regeln und eigene Pauschbeträge, die dieser Rechner bewusst nicht abbildet. Verbindlich sind am Ende immer die konkreten Preise von Unterkunft, Transport und Anbietern zum Zeitpunkt Ihrer Buchung. Sehen Sie die berechnete Summe daher als Orientierungsrahmen, an dem Sie Angebote messen, und nicht als feste Reisekasse — ein Puffer für Spontanes gehört bei jeder Reise dazu.',
      },
    ],
    quellen: [
      { titel: '42. Deutsche Tourismusanalyse 2026 (BAT-Stiftung für Zukunftsfragen)', hinweis: 'Ø Haupturlaub 1.636 €/Person (2025), Inland 1.170 €, Fernreise 2.673 €, Tageskosten Ø 130 €. Repräsentative Befragung >3.000 Personen.' },
      { titel: 'Tourismusanalyse: Reisekosten nach Zielen 2025', hinweis: 'Pro-Person-Kosten u. a. Griechenland 1.872 €, Türkei 1.766 €, Italien 1.672 €, Kroatien 1.303 €, Österreich 1.183 €.' },
      { titel: 'Reisekosten-Methodik', hinweis: 'Gesamt = Anreise (Sprit hin+rück + Maut) + Unterkunft × Nächte + (Verpflegung + Aktivitäten) × Personen × Tage + Versicherung. Tage = Nächte + 1. Richtwerte, kein Reiseangebot.' },
    ],
  },
  {
...
Wenn Ihre Bedürfnisse über 50 % liegen, prüfen Sie zunächst die größten Posten: Lohnt ein Umzug in eine günstigere Wohnung? Können Sie den Stromanbieter wechseln? Gibt es eine günstigere Versicherung? Wenn Ihre Wünsche über 30 % liegen, schauen Sie auf Abos und Streaming-Dienste — oft laufen vergessene Abonnements weiter.`,
    faq: [
      ...
      },
      {
        ...
        antwort: 'Prüfen Sie zuerst die großen Posten: Miete (Umzug?), Versicherungen (Vergleich?), Mobilität (ÖPNV statt Auto?). Dann die kleinen: Abos kündigen, Einkäufe mit Liste planen, Stromanbieter wechseln. Ein Haushaltsbuch über 3 Monate zeigt, wo versteckte Ausgaben liegen. Bei dauerhaft nicht gedeckten Ausgaben hilft eine gemeinnützige Schuldnerberatung weiter.',
      },
    ],
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Was ein Haushaltsbudget zeigt',
        html: `<p>Ein <strong>Haushaltsbudget</strong> stellt alle monatlichen Einnahmen den Ausgaben gegenüber. Es zeigt auf einen Blick, wie viel am Monatsende übrig bleibt, wofür das Geld verwendet wird und wo Spielraum entsteht. Dieser Rechner teilt die Ausgaben in zehn Kategorien, bildet den <strong>Überschuss</strong> (Einnahmen minus Ausgaben) und prüft, wie die Verteilung zur bekannten 50/30/20-Regel passt. Schon das bloße Aufschreiben verschafft vielen Haushalten zum ersten Mal einen klaren Überblick.</p><p>Der Überschuss ist das Geld, das nach allen Ausgaben für das Sparen oder Anlegen zur Verfügung steht. Aus ihm leitet der Rechner die <strong>Sparquote</strong> ab — den Anteil des Einkommens, der nicht ausgegeben wird. Wer diese Zahlen kennt, kann in Ruhe und ohne Druck entscheiden, wo eine Anpassung sinnvoll wäre und wo bereits alles im grünen Bereich liegt. Es geht dabei nicht um ein gutes oder schlechtes Budget, sondern um Klarheit über die eigene Lage. Ein erster Überschuss lässt sich später etwa mit dem <a href="/finanzen/zinsrechner">Zinsrechner</a> über mehrere Jahre hochrechnen.</p>`,
      },
      {
        typ: 'checkliste',
        titel: 'Haushaltsbudget aufstellen — Schritt für Schritt',
        punkte: [
      ...
      {
        typ: 'vergleich',
        titel: '50/30/20-Regel und Umschlagmethode im Vergleich',
        spalteA: '50/30/20-Regel',
        spalteB: 'Umschlagmethode',
        zeilen: [
          { kriterium: 'Grundidee', a: 'Einkommen in drei feste Anteile aufteilen', b: 'Bargeld pro Kategorie in getrennte Umschläge legen' },
          { kriterium: 'Aufwand', a: 'gering — einmal aufteilen, dann beobachten', b: 'höher — jeden Einkauf einem Umschlag zuordnen' },
          { kriterium: 'Stärke', a: 'schneller Überblick über die grobe Verteilung', b: 'hartes Limit, weil leerer Umschlag = kein Geld mehr' },
          { kriterium: 'Schwäche', a: 'sagt nichts über einzelne Posten', b: 'unpraktisch bei Karten- und Online-Zahlung' },
          { kriterium: 'Geeignet für', a: 'Einstieg und groben Rahmen', b: 'wer variable Kosten strikt deckeln möchte' },
          { kriterium: 'Kontrolle', a: 'monatlicher Soll-Ist-Abgleich genügt', b: 'tägliche Sichtkontrolle am Umschlag-Inhalt' },
        ],
      },
      {
        typ: 'text',
        titel: 'Weitere Methoden und der Notgroschen',
        html: `<p>Neben der 50/30/20-Regel und der Umschlagmethode gibt es das <strong>Zero-Based-Budgeting</strong>: Hier wird jedem Euro des Einkommens vorab eine Aufgabe gegeben, bis am Ende rechnerisch null übrig bleibt — auch das Sparen ist dabei ein fester Posten. Das Verfahren ist genauer, aber aufwändiger und passt zu Menschen, die ihr Geld bis ins Detail steuern wollen. Welche Methode die richtige ist, hängt allein vom eigenen Stil ab; keine ist objektiv besser, und ein Wechsel ist jederzeit möglich.</p><p>Vor dem Anlegen steht bei den meisten Empfehlungen der <strong>Notgroschen</strong>: eine Reserve von etwa drei bis sechs Netto-Monatsgehältern auf einem jederzeit verfügbaren Konto, etwa Tagesgeld. Er federt unerwartete Ausgaben wie eine Autoreparatur oder eine kaputte Waschmaschine ab, ohne dass dafür ein Kredit nötig wird. Wie groß die Reserve sein sollte, hängt von der Sicherheit des Einkommens ab: Bei festem Job reichen oft drei Monatsgehälter, bei schwankendem Einkommen sind sechs ratsam. Wie ein angesparter Betrag mit Zinsen wächst, zeigt der <a href="/finanzen/sparrechner">Sparrechner</a>.</p>`,
      },
      {
        typ: 'statistik',
        titel: 'Typische Ausgabenverteilung in Deutschland',
        werte: [
          { label: 'Wohnen (Miete, Energie)', wert: 'rund 36 %', hinweis: 'meist der größte Einzelposten' },
          { label: 'Ernährung', wert: 'rund 15 %', hinweis: 'Lebensmittel und Getränke' },
          { label: 'Mobilität', wert: 'rund 14 %', hinweis: 'Auto, ÖPNV, Kraftstoff' },
          { label: 'Freizeit und Kultur', wert: 'rund 11 %', hinweis: 'Hobbys, Ausgehen, Reisen' },
          { label: 'Sparquote (Durchschnitt)', wert: 'rund 11 %', hinweis: 'Anteil des nicht ausgegebenen Einkommens' },
          { label: 'Bekleidung', wert: 'rund 4 %', hinweis: 'Kleidung und Schuhe' },
          { label: 'Notgroschen (Faustregel)', wert: '3–6 Netto', hinweis: 'verfügbare Reserve in Monatsgehältern' },
        ],
      },
      {
        typ: 'checkliste',
        titel: 'Reserve und Sparen aufbauen — eine sinnvolle Reihenfolge',
        punkte: [

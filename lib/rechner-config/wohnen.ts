...
Die Grundsteuer ist nach der **Betriebskostenverordnung** umlagefähig auf Mieter und fließt somit in die [Nebenkostenabrechnung](/wohnen/nebenkosten-rechner). Sie wird quartalsweise an die Gemeinde gezahlt (15.02., 15.05., 15.08., 15.11.). Für die Steuererklärung kann die Grundsteuer bei **vermieteten Objekten** als Werbungskosten bei Einkünften aus Vermietung und Verpachtung angesetzt werden. Selbstnutzer können die Grundsteuer nicht steuerlich absetzen.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Die neue Grundsteuer seit 2025',
        html: `<p>Seit dem 1. Januar 2025 gilt in Deutschland die <strong>reformierte Grundsteuer</strong>. Auslöser war ein Urteil des Bundesverfassungsgerichts von 2018, das die jahrzehntealten Einheitswerte für verfassungswidrig erklärte, weil sie längst nicht mehr die realen Wertverhältnisse abbildeten. Seither werden alle rund 36 Millionen Grundstücke neu bewertet — entweder nach dem bundesweiten <strong>Bundesmodell</strong> oder nach einem der fünf abweichenden Landesmodelle.</p><p>Die Grundsteuer fällt — anders als die einmalige <a href="/wohnen/grunderwerbsteuer-rechner">Grunderwerbsteuer</a> beim Kauf — Jahr für Jahr an und gehört in jede Kostenplanung, etwa neben der <a href="/wohnen/baufinanzierung-rechner">Baufinanzierung</a>. Dieser Rechner bildet die drei wichtigsten Modelle ab: das Bundesmodell, das bayerische Flächenmodell und das Bodenwertmodell aus Baden-Württemberg. Welches für Sie gilt, hängt allein vom Bundesland ab, in dem das Grundstück liegt — nicht von Ihrem Wohnsitz oder vom Finanzamt, das den Bescheid erlässt.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Bundesmodell Schritt für Schritt',
        schritte: [
          { label: 'Bodenwert', formel: '400 m² × 200 €/m²', ergebnis: '80.000 €' },
          { label: 'Gebäudewert (Baujahr 1990)', formel: '120 m² × 7,50 € × 12 × 15', ergebnis: '162.000 €' },
          { label: 'Grundsteuerwert', formel: '80.000 € + 162.000 €', ergebnis: '242.000 €' },
          { label: 'Steuermessbetrag', formel: '242.000 € × 0,031 %', ergebnis: '75,02 €' },
          { label: 'Jahres-Grundsteuer', formel: '75,02 € × 500 % Hebesatz', ergebnis: '375,10 €' },
        ],
        fazit: 'Beim Bundesmodell setzt sich der Grundsteuerwert aus Boden- und Gebäudewert zusammen. Der Bodenwert ist die Grundstücksfläche mal Bodenrichtwert (400 m² × 200 € = 80.000 €). Der Gebäudewert entsteht im vereinfachten Ertragswertverfahren: Wohnfläche mal einer fiktiven Nettokaltmiete je Quadratmeter, die sich nach Baujahr richtet (hier 7,50 €), über zwölf Monate und einen Kapitalisierungsfaktor von 15 — das ergibt 162.000 €. Auf den Grundsteuerwert von 242.000 € wird die Steuermesszahl von 0,031 % angewandt, und der Messbetrag von 75,02 € mal dem kommunalen Hebesatz von 500 % ergibt 375,10 € Grundsteuer im Jahr. Bei einem höheren Hebesatz von etwa 700 % läge dieselbe Wohnung schon bei rund 525 € — der Hebesatz wirkt also linear auf das Ergebnis.',
      },
      {
        typ: 'vergleich',
        titel: 'Wertabhängig oder wertunabhängig?',
        spalteA: 'Bundesmodell (wertabhängig)',
        spalteB: 'Eigenmodelle (Fläche/Boden)',
        zeilen: [
          { kriterium: 'Grundlage', a: 'Bodenrichtwert + Miete + Baujahr', b: 'Fläche (Bayern) bzw. Bodenwert (BW)' },
          { kriterium: 'Gebäude zählt', a: 'ja, über den Ertragswert', b: 'Bayern ja (Fläche), BW nein' },
          { kriterium: 'Lagevorteil', a: 'wirkt voll', b: 'Bayern gar nicht, BW stark' },
          { kriterium: 'Verbreitung', a: '11 Länder', b: 'Bayern, BW, Hamburg, Hessen, Niedersachsen' },
          { kriterium: 'Tendenz', a: 'Toplagen teurer', b: 'Bayern lageneutral, BW grundstücksabhängig' },
        ],
      },
      {
        typ: 'infobox',
        variante: 'hinweis',
        titel: 'Welches Bundesland nutzt welches Modell?',
        text: 'Elf Länder rechnen nach dem Bundesmodell: Berlin, Brandenburg, Bremen, Mecklenburg-Vorpommern, Nordrhein-Westfalen, Rheinland-Pfalz, Sachsen, Sachsen-Anhalt, Saarland, Schleswig-Holstein und Thüringen. Fünf Länder haben über die sogenannte Öffnungsklausel eigene Wege gewählt: Bayern ein reines Flächenmodell, Baden-Württemberg ein Bodenwertmodell, Hamburg ein Wohnlagemodell, Hessen ein Flächen-Faktor-Modell und Niedersachsen ein Flächen-Lage-Modell. Wichtig für die Nutzung dieses Rechners: Abgebildet sind nur die drei verbreitetsten Varianten — Bundesmodell, Bayern und Baden-Württemberg. Die Eigenheiten der Modelle in Hamburg, Hessen und Niedersachsen (Lage-Faktoren, Wohnlagezuschläge) sind nicht hinterlegt; für Grundstücke in diesen Ländern liefert der Rechner daher keine passende Schätzung. Den maßgeblichen Wert entnehmen Sie in diesen Fällen immer dem Bescheid des zuständigen Finanzamts; die Landesfinanzverwaltungen stellen zudem eigene Erläuterungen und teils eigene Online-Hilfen bereit.',
      },
      {
        typ: 'text',
        titel: 'Die Bausteine des Bundesmodells',
        html: `<p>Der <strong>Grundsteuerwert</strong> im Bundesmodell besteht aus zwei Teilen. Der <strong>Bodenwert</strong> ist schlicht die Grundstücksfläche multipliziert mit dem Bodenrichtwert. Diesen Wert legt der Gutachterausschuss der Gemeinde fest; er lässt sich kostenlos über das Portal boris.de beziehungsweise die Bodenrichtwert-Portale der Länder abrufen.</p><p>Der <strong>Gebäudewert</strong> entsteht im vereinfachten Ertragswertverfahren über eine fiktive Nettokaltmiete: Die Wohnfläche wird mit einem gesetzlich festgelegten Mietwert je Quadratmeter multipliziert, der sich nach dem Baujahr staffelt (von rund 6,50 € für Altbauten bis 8,50 € für jüngere Gebäude), und mit einem Kapitalisierungsfaktor hochgerechnet. Dieser Rechner nutzt eine vierstufige Baujahres-Tabelle; die im Gesetz vorgesehenen Mietniveaustufen je Gemeinde (§ 254 BewG) und die Restnutzungsdauer (§ 256 BewG) sind dabei vereinfacht. Bodenrichtwert und Hebesatz geben Sie selbst ein. Das Ergebnis ist deshalb eine gute Näherung für die Größenordnung, ersetzt aber nicht die amtliche Bewertung — bei stark abweichenden Werten lohnt der Abgleich mit dem Bescheid.</p>`,
      },
      {
        typ: 'vergleich',
        titel: 'Bayern-Flächenmodell gegen Bundesmodell',
        spalteA: 'Bayern (Flächenmodell)',
        spalteB: 'Bundesmodell',
        zeilen: [
          { kriterium: 'Berechnung', a: 'Grundfläche × 0,04 € + Wohnfläche × 0,50 €', b: 'Bodenwert + Gebäudeertragswert' },
          { kriterium: 'Wohnermäßigung', a: '−30 % (Faktor 0,70)', b: 'Steuermesszahl 0,031 %' },
          { kriterium: 'Rolle des Werts', a: 'keine — nur Fläche zählt', b: 'Bodenrichtwert und Miete entscheidend' },
          { kriterium: 'Gleiche Fläche, Toplage', a: 'gleicher Beitrag wie einfache Lage', b: 'deutlich höher' },
          { kriterium: 'Charakter', a: 'einfach, lageneutral', b: 'wertorientiert, aufwändiger' },
        ],
      },
      {
        typ: 'vergleich',
        titel: 'BW-Bodenwertmodell gegen Bundesmodell',
        spalteA: 'Baden-Württemberg (Bodenwert)',
        spalteB: 'Bundesmodell',
        zeilen: [
          { kriterium: 'Berechnung', a: 'Grundfläche × Bodenrichtwert', b: 'Boden- plus Gebäudewert' },
          { kriterium: 'Messzahl Wohnen', a: '0,91 ‰ (1,30 ‰ − 30 %)', b: '0,031 %' },
          { kriterium: 'Gebäude zählt', a: 'nein, nur Grund und Boden', b: 'ja, über den Ertragswert' },
          { kriterium: 'Großes Grundstück', a: 'teuer, unabhängig vom Haus', b: 'moderater, weil Gebäude mitzählt' },
          { kriterium: 'Toplage', a: 'stark steigend', b: 'steigend, aber gedämpfter' },
        ],
      },
      {
        typ: 'infobox',
        variante: 'hinweis',
        titel: 'Der Hebesatz — der kommunale Stellhebel',
        text: 'Den letzten und oft entscheidenden Faktor bestimmt nicht das Land, sondern die Gemeinde: den Hebesatz. Er wird in Prozent auf den Steuermessbetrag angewandt und jährlich im Haushalt der Kommune beschlossen. Bundesweit liegt er im Schnitt bei rund 500 %, in vielen Großstädten zwischen 600 und 900 %, mit Spitzen über 1.000 % in einzelnen Städten, während ländliche Gemeinden teils unter 400 % bleiben. Die Reform sollte für die Kommunen aufkommensneutral sein — die Gesamteinnahmen also gleich bleiben; ob die einzelne Gemeinde diesen Maßstab eingehalten hat, lässt sich an ihrem alten und neuen Hebesatz ablesen. Auf der Ebene der einzelnen Eigentümer führt sie aber zu deutlichen Verschiebungen: Wer früher über einen niedrigen Einheitswert begünstigt war, zahlt heute oft mehr, während mancher in der Toplage profitiert. Den Hebesatz Ihrer Gemeinde finden Sie auf deren Website oder im aktuellen Haushaltsplan. Weil er sich jährlich ändern kann, lohnt vor einem Kauf der Blick auf die Hebesatz-Entwicklung der vergangenen Jahre.',
      },
      {
        typ: 'text',
        titel: 'Gewinner und Verlierer der Reform',
        html: `<p>Die Reform sollte die Grundsteuer gerechter machen, indem sie wieder an aktuellen Werten ansetzt. Für den einzelnen Eigentümer bedeutet das aber Bewegung in beide Richtungen. <strong>Tendenziell teurer</strong> wird es für Grundstücke in begehrten, stark im Wert gestiegenen Lagen — vor allem im Bundesmodell und im baden-württembergischen Bodenwertmodell, wo hohe Bodenrichtwerte voll durchschlagen. <strong>Tendenziell günstiger</strong> kann es für Eigentümer einfacher Lagen oder kleinerer Grundstücke werden, die früher über veraltete Einheitswerte überdurchschnittlich belastet waren.</p><p>Weil die Gemeinden ihre Hebesätze zugleich anpassen konnten, lässt sich die endgültige Belastung erst aus dem Zusammenspiel von Bewertung und Hebesatz ablesen. Ein höherer Grundsteuerwert führt nicht zwingend zu einer höheren Steuer, wenn die Gemeinde den Hebesatz gesenkt hat — und umgekehrt. Erst der konkrete Bescheid zeigt das tatsächliche Ergebnis. Ein Vergleich der Steuer vor und nach der Reform ist deshalb nur dann aussagekräftig, wenn man Bewertung und Hebesatz zusammen betrachtet.</p>`,
      },
      {
        typ: 'text',
        titel: 'Rechtsstand 2026: Ist das Bundesmodell verfassungsgemäß?',
        html: `<p>Das Bundesmodell stand juristisch auf dem Prüfstand. Am 10. Dezember 2025 entschied der <strong>Bundesfinanzhof</strong>, dass es verfassungskonform ist, und wies drei Revisionen aus Nordrhein-Westfalen, Sachsen und Berlin ab (II R 25/24, II R 31/24, II R 3/25); eine Vorlage an das Bundesverfassungsgericht lehnte er ab. Die Urteilsbegründungen wurden am 22. Januar 2026 veröffentlicht.</p><p>Damit ist das letzte Wort aber noch nicht gesprochen: Gegen eine der Entscheidungen ist seit dem 9. März 2026 eine <strong>Verfassungsbeschwerde beim Bundesverfassungsgericht</strong> anhängig (1 BvR 472/26), getragen vom Bund der Steuerzahler und von Haus & Grund. Zu den Ländermodellen steht eine höchstrichterliche Klärung noch aus; eine erste mündliche Verhandlung zum baden-württembergischen Modell wurde für etwa April 2026 erwartet. Wer einen hohen Bescheid hat, kann zur Sicherheit Einspruch einlegen und das Verfahren offenhalten.</p><p>Für die Praxis heißt das: Die neue Grundsteuer ist seit 2025 zu zahlen, auch während offene Verfahren laufen — ein Einspruch sichert lediglich die Möglichkeit einer späteren Korrektur.</p>`,
      },
      {
        typ: 'checkliste',
        titel: 'Bescheid prüfen und Einspruch einlegen',
        punkte: [
      ...
      {
        typ: 'text',
        titel: 'Grundsteuer A, B und C — und die Umlage auf Mieter',
        html: `<p>Die Grundsteuer kennt drei Arten. <strong>Grundsteuer A</strong> betrifft land- und forstwirtschaftliche Betriebe, <strong>Grundsteuer B</strong> bebaute und unbebaute Grundstücke — der Standardfall für Wohnimmobilien. Neu seit der Reform ist die <strong>Grundsteuer C</strong>: Gemeinden dürfen für baureife, aber unbebaute Grundstücke einen erhöhten Hebesatz festlegen, um Spekulation zu bremsen und Bauland zu mobilisieren.</p><p>Für Vermieter wichtig: Die Grundsteuer B ist nach der Betriebskostenverordnung in voller Höhe auf die Mieter umlagefähig und fließt in die <a href="/wohnen/nebenkosten-rechner">Nebenkostenabrechnung</a> ein. Gezahlt wird sie quartalsweise zum 15. Februar, Mai, August und November, auf Antrag auch jährlich zum 1. Juli. Bei vermieteten Objekten lässt sie sich als Werbungskosten absetzen; Selbstnutzer können das nicht. In die Renditebetrachtung einer Kapitalanlage gehört sie ebenfalls — der <a href="/wohnen/mietrendite-rechner">Mietrendite-Rechner</a> hilft dabei.</p>`,
      },
      {
        typ: 'checkliste',
        titel: 'Grundsteuer im Blick behalten',
        punkte: [

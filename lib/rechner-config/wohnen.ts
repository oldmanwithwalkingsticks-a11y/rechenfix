    ...
    contentBloecke: [
      {
        ...
        html: `<p>Die jährlichen Heizkosten folgen einer überraschend einfachen Grundgleichung: <strong>Wohnfläche × spezifischer Verbrauch × Energiepreis</strong>. Der spezifische Verbrauch wird in Kilowattstunden pro Quadratmeter und Jahr (kWh/m²) angegeben und beschreibt, wie viel Heizenergie ein Quadratmeter Wohnfläche im Jahr benötigt. Multipliziert man ihn mit der Fläche, erhält man den Gesamtverbrauch in kWh; multipliziert mit dem Energiepreis in Cent pro kWh ergibt das die Jahreskosten. Dieser Rechner setzt für jeden Energieträger einen typischen Marktwert ein, den man durch den eigenen, vom Zähler oder aus der Abrechnung abgelesenen Wert ersetzen sollte.</p><p>Der entscheidende Punkt: Es gibt <strong>zwei voneinander unabhängige Stellschrauben</strong>. Die erste ist der Verbrauch — er hängt fast ausschließlich vom Gebäude ab: Dämmung, Fenster, Baujahr und Heizverhalten. Die zweite ist der Preis pro Kilowattstunde — er hängt vom Energieträger und vom Tarif ab. Ein sanierter Altbau mit Gasheizung kann denselben Euro-Betrag kosten wie ein unsanierter mit Pelletheizung, obwohl der eine über den Preis und der andere über den Verbrauch spart. Wer Heizkosten senken will, muss deshalb wissen, welche der beiden Schrauben in der eigenen Situation überhaupt drehbar ist.</p><p>Ein zweiter, oft übersehener Aspekt ist die <strong>Vergleichbarkeit der Energieträger</strong>. Gas, Öl, Fernwärme, Pellets und der Strom einer Wärmepumpe lassen sich nicht einfach über den Preis pro Kilowattstunde vergleichen, weil sie unterschiedlich effizient in nutzbare Wärme umgesetzt werden. Eine Wärmepumpe zieht aus einer Kilowattstunde Strom rund drei bis vier Kilowattstunden Wärme — ihr scheinbar hoher Strompreis relativiert sich dadurch deutlich. Genau deshalb arbeitet dieser Rechner pro Energieträger mit eigenen Verbrauchswerten in kWh/m² statt mit einem Einheitswert für alle.</p><p>Hilfreich ist außerdem, die berechnete Jahressumme vom <strong>monatlichen Abschlag</strong> zu unterscheiden. Versorger ziehen über das Jahr einen festen monatlichen Betrag ein, der auf einer Schätzung des Vorjahresverbrauchs beruht. Weicht der tatsächliche Verbrauch ab — etwa durch einen kalten Winter, gestiegene Preise oder einen neuen Bewohner — entsteht am Jahresende eine <strong>Nachzahlung oder Gutschrift</strong>. Wer den eigenen Verbrauch mit diesem Rechner gegen den Abschlag prüft, erkennt früh, ob der Abschlag zu niedrig angesetzt ist, und kann ihn anpassen lassen, statt im Frühjahr von einer hohen Nachforderung überrascht zu werden. Eine grobe Faustregel zur Plausibilität: Liegen die hochgerechneten Jahreskosten deutlich über der Summe der zwölf Abschläge, ist eine Nachzahlung wahrscheinlich.</p><p>Bei fossilen Energieträgern lohnt schließlich der Blick nach vorn. Seit 2021 wird auf Erdgas und Heizöl ein nationaler <strong>CO₂-Preis</strong> erhoben, der schrittweise steigt und beide Brennstoffe Jahr für Jahr verteuert — 2026 bewegt er sich im unteren Bereich eines gesetzlich festgelegten Preiskorridors und schlägt rechnerisch grob mit gut einem Cent pro Kilowattstunde bei Gas und etwas mehr bei Heizöl zu Buche. In den Folgejahren ist nach derzeitiger Gesetzeslage ein weiterer Anstieg vorgesehen. Für die langfristige Kostenrechnung bedeutet das: Wer heute zwischen einer fossilen Heizung und einer Wärmepumpe abwägt, sollte nicht nur die aktuellen Jahreskosten vergleichen, sondern auch die absehbare Verteuerung von Gas und Öl einpreisen. Genau diese Dynamik verbessert die Wirtschaftlichkeit erneuerbarer Heizsysteme mit jedem Jahr ein Stück weiter.</p>`,
      },
      {
        typ: 'vergleich',
        ...
        zeilen: [
          ...
          { kriterium: 'CO₂-Ausstoß 100 m²/Jahr', a: 'ca. 2,8 t (fossil)', b: 'ca. 1,5 t (Strommix), nahe 0 mit Ökostrom' },
      ...
      },
      {
        ...
        fussnote: 'Werte sind Marktdurchschnitte 2026 und die Standard-Annahmen des Rechners. Der niedrige kWh/m²-Wert der Wärmepumpe ist kein Sparzauber, sondern der bereits durch die Jahresarbeitszahl (JAZ ~3,5) geteilte Strombedarf: Aus 140 kWh Heizwärmebedarf werden rund 40 kWh Strom. Heizöl liegt beim Verbrauch höher, weil Kessel- und Lagerverluste eingerechnet sind, Fernwärme niedriger wegen effizienter Wärmeauskopplung. Die Reihenfolge der Jahreskosten ist deshalb kein fester Rang: Sie verschiebt sich, sobald man eigene Verbrauchs- und Preiswerte einsetzt. Pellets und Wärmepumpe liegen hier vorn, doch bei schlecht gedämmtem Altbau mit hoher Vorlauftemperatur (niedrige JAZ) kann die Wärmepumpe teurer werden, und bei stark gestiegenem Pelletpreis schmilzt auch deren Vorsprung. Die Tabelle ist ein Startpunkt für den Vergleich, kein endgültiges Urteil.',
      },
      {
        typ: 'beispielrechnung',
        titel: 'Gasheizung, 100 m² Wohnfläche: Schritt für Schritt',
        schritte: [
        ...
        fazit: 'Für die 100-m²-Gaswohnung ergeben sich rund 1.680 € im Jahr, also 140 € monatlicher Abschlag und 16,80 € pro Quadratmeter. Der Quadratmeterwert ist die nützlichste Vergleichsgröße: Liegt er deutlich über 16–18 €/m², deutet das auf schwache Dämmung, eine alte Anlage oder hohen Warmwasseranteil hin — und damit auf ein konkretes Sparpotenzial. Rechnet man dieselbe Wohnung mit einem anderen Energieträger durch, ändert sich nur die letzte Multiplikation: Mit Pellets (130 kWh/m², 8 ct) wären es rund 1.040 €, mit Fernwärme (120 kWh/m², 14 ct) rund 1.680 €. So macht die einfache Grundformel jeden Energieträger unmittelbar vergleichbar.',
      },
      {
        typ: 'text',
        titel: 'Was den Verbrauch bestimmt: Dämmung, Baujahr, Heizverhalten',
        html: `<p>Während der Energiepreis vorgegeben ist, entscheidet vor allem das Gebäude über den Verbrauch — und die Spanne ist enorm. Ein nach KfW-Effizienzhaus-Standard gebauter oder kernsanierter Neubau kommt mit <strong>30 bis 50 kWh/m²</strong> im Jahr aus. Ein modernisierter Altbau liegt bei <strong>80 bis 120 kWh/m²</strong>, ein unsanierter Altbau aus den 1960er- bis 1980er-Jahren bei <strong>150 bis 250 kWh/m²</strong>. Zwischen bestem und schlechtestem Fall liegt also der Faktor fünf bis acht: Bei gleicher Fläche und gleichem Energieträger kann der eine Haushalt 600 € und der andere 4.000 € im Jahr zahlen.</p><p>Den größten Hebel hat die <strong>Gebäudehülle</strong>. Ungedämmte Außenwände, ein nicht gedämmtes Dach und alte Einfachverglasung lassen Wärme ungebremst entweichen; eine Fassadendämmung, neue Fenster und eine gedämmte oberste Geschossdecke senken den Bedarf oft um 30 bis 50 Prozent. Innerhalb eines Gebäudes spielen zudem die Lage der Wohnung (Mittelgeschoss ist günstiger als Dach- oder Erdgeschoss) und die Zahl der Außenwände eine Rolle.</p><p>Der zweite große Faktor ist das <strong>Heizverhalten</strong>. Jedes Grad weniger Raumtemperatur spart rund sechs Prozent Heizenergie — der Unterschied zwischen 23 und 20 Grad im Wohnzimmer macht also fast ein Fünftel aus. Richtiges Stoßlüften statt dauerhaft gekippter Fenster, das Absenken der Temperatur nachts und bei Abwesenheit über programmierbare Thermostate sowie freie, nicht von Möbeln oder Vorhängen verdeckte Heizkörper wirken zusätzlich. Auch der oft übersehene <strong>Warmwasseranteil</strong> von 15 bis 25 Prozent gehört dazu: Sparsame Armaturen und eine bedarfsgerechte Speichertemperatur senken ihn spürbar.</p><p>Den eigenen <strong>realen Verbrauch</strong> sollte man nicht schätzen, sondern ablesen. Drei Quellen liefern belastbare Werte: die <strong>Heizkostenabrechnung</strong> der letzten ein bis zwei Jahre (am besten mehrere Jahre mitteln, um Witterungsschwankungen auszugleichen), der <strong>Energieausweis</strong> des Gebäudes, der den Endenergiebedarf in kWh/m² ausweist, und bei eigener Anlage der direkte Blick auf den <strong>Zählerstand</strong> von Gas- oder Stromzähler über ein volles Jahr. Wichtig ist, Heizung und Warmwasser sauber zu trennen und bei fossilen Anlagen den <strong>Wirkungsgrad</strong> mitzudenken: Eine alte Gasheizung macht aus 100 kWh Brennstoff nur etwa 80 kWh nutzbare Wärme, ein moderner Brennwertkessel dagegen 95 bis 98 kWh. Wer mit dem reinen Brennstoffverbrauch rechnet, überschätzt bei alten Anlagen leicht den nutzbaren Wärmeertrag und unterschätzt damit das Sparpotenzial einer Modernisierung.</p>`,
      },
      {
        typ: 'vergleich',
      ...
      },
      {
        ...
        text: 'Die voreingestellten Verbrauchs- und Preiswerte sind typische Marktdurchschnitte für 2026 und dienen nur als Startpunkt. Den genauen Verbrauch liefert die Heizkostenabrechnung der letzten ein bis zwei Jahre oder der Energieausweis (Endenergiebedarf in kWh/m² Jahr); den genauen Preis findet man auf der eigenen Jahresrechnung. Beide Werte schwanken je nach Region, Tarif und Gebäude erheblich — gerade Öl- und Gaspreise bewegen sich im Jahresverlauf um 20 bis 35 Prozent. Mit den eigenen Zahlen wird aus der Schätzung eine belastbare Hochrechnung. Auch der Wärmepumpen-Preis ist ein Sonderfall: Die voreingestellten 28 ct/kWh gelten für einen separaten Wärmepumpen-Spezialtarif mit eigenem Zähler; wer die Wärmepumpe über den normalen Haushaltsstrom betreibt, sollte stattdessen rund 33 bis 37 ct/kWh ansetzen. Das verändert das Ergebnis deutlich und ist beim Vergleich mit Gas oder Öl entscheidend.',
      },
      {
        typ: 'checkliste',
        ...
        punkte: [
          ...
          'Energieberatung nutzen: Die KfW trägt einen erheblichen Teil der Kosten einer Vor-Ort-Beratung; ein individueller Sanierungsfahrplan zeigt, welche Maßnahme das beste Verhältnis aus Aufwand und Ersparnis hat.',
          'Tarif regelmäßig prüfen: Über Vergleichsportale lassen sich Gas- und Stromtarife jährlich gegenchecken — ein Anbieterwechsel senkt den Preis pro Kilowattstunde oft, ohne dass man am Gebäude etwas ändern muss.',
        ],
      },
    ],
    quellen: [

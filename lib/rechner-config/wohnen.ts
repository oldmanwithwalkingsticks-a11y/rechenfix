...
Für den gesamten Haushaltsverbrauch nutzen Sie unseren [Stromkosten-Rechner](/wohnen/stromkosten-rechner), der mit Personenzahl und Haushaltsgröße arbeitet. Wer den Verbrauch selbst produzieren will, findet im [Photovoltaik-Rechner](/wohnen/photovoltaik-rechner) die passende Dimensionierung für die eigene Dachanlage.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Was der Energiekosten-Rechner macht',
        html: `<p>Dieser Rechner zeigt, was einzelne <strong>Elektrogeräte</strong> an Strom kosten — und summiert mehrere Geräte zu den gesamten Stromkosten eines Haushalts. Für jedes Gerät geben Sie die Leistung in Watt, die tägliche Nutzungsdauer und die Nutzungstage pro Woche ein; daraus berechnet der Rechner den Jahresverbrauch in Kilowattstunden und die Kosten pro Tag, Monat und Jahr. So sieht man auf einen Blick, welches Gerät der größte Stromfresser ist.</p><p>Er ergänzt damit zwei verwandte Rechner: Der <strong>Stromkosten-Rechner</strong> betrachtet den gesamten Haushaltsverbrauch pauschal über die Jahres-Kilowattstunden von der Stromrechnung, der <strong>Stromverbrauch-Rechner</strong> ein einzelnes Gerät isoliert. Dieser Energiekosten-Rechner liegt dazwischen: Er addiert mehrere Geräte zu einem Gesamtbild und zeigt deren Anteile. Gerechnet wird ausschließlich mit <strong>Strom</strong> — Gas oder Heizöl gehören in die jeweils eigenen Heizkosten-Rechner. Die hinterlegten Preise sind Richtwerte; den eigenen Strompreis übernehmen Sie am besten von Ihrer Abrechnung. So entsteht aus einzelnen Geräten Schritt für Schritt ein realistisches Bild der gesamten Stromrechnung.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Typischer Jahresverbrauch und Stromkosten je Gerät',
        kopf: ['Gerät', 'typ. Jahresverbrauch', 'ca. €/Jahr (37 ct)'],
        zeilen: [
          ['Kühlschrank (modern, Klasse A)', '100–150 kWh', '37–56 €'],
          ['Gefriertruhe', '200–300 kWh', '74–111 €'],
          ['Waschmaschine (3–4×/Woche)', '~150 kWh', '~56 €'],
          ['Wäschetrockner', '~300 kWh', '~111 €'],
          ['Spülmaschine', '~250 kWh', '~93 €'],
          ['Fernseher (50″, 4 h/Tag)', '120–150 kWh', '44–56 €'],
          ['Gaming-PC (6 h/Tag)', '~300 kWh', '~111 €'],
          ['WLAN-Router (24/7)', '~90 kWh', '~33 €'],
          ['LED-Lampe (10 W, 5 h/Tag)', '~18 kWh', '~7 €'],
        ],
        fussnote: 'Typische Jahresverbräuche moderner Geräte als Orientierung (Quellen: Umweltbundesamt, BDEW), Kosten bei 37 ct/kWh (BDEW-Mittel 2026). Wichtig: Bei Kühl- und Gefriergeräten überschätzt die reine Rechnung „Watt-Aufdruck × 24 Stunden" den Verbrauch deutlich, weil der Kompressor nur etwa 30 bis 50 Prozent der Zeit läuft — hier am besten die Herstellerangabe in kWh/Jahr verwenden. Geräte, die im Betrieb konstant Strom ziehen (PC, Fernseher, Beleuchtung), lassen sich dagegen direkt über Watt × Stunden rechnen. Die Spannen in der Tabelle decken neue und ältere Modelle ab; ein 15 Jahre altes Kühlgerät kann den oberen Wert deutlich überschreiten.',
      },
      {
        typ: 'text',
        titel: 'Anschlussleistung, Verbrauch und die Formel',
        html: `<p>Die Berechnung folgt einer einfachen Logik: <strong>Leistung (Watt) × Nutzungsdauer (Stunden) = Energie (Wattstunden)</strong>. Geteilt durch 1.000 ergibt das Kilowattstunden (kWh) — die Einheit auf der Stromrechnung. Mal dem Strompreis ergibt sich der Geldbetrag. Über die Nutzungstage pro Woche und 52 Wochen rechnet der Rechner auf das Jahr hoch.</p><p>Ein wichtiger Stolperstein: Die auf dem Gerät aufgedruckte Watt-Zahl ist die <strong>maximale Anschlussleistung</strong>, nicht der Dauerverbrauch. Geräte mit Kompressor — Kühlschrank, Gefriertruhe, Wärmepumpe — laufen nur etwa 30 bis 50 Prozent der Zeit unter Last. Wer hier stur „Watt × 24 Stunden" rechnet, überschätzt den Verbrauch massiv. Für solche Dauerläufer nimmt man besser die Herstellerangabe in kWh pro Jahr oder die effektive Laufzeit. Geräte, die im Betrieb konstant ziehen (PC, Fernseher, Lampen, Wasserkocher), lassen sich dagegen direkt über Watt × Stunden berechnen. Im Zweifel ist die Herstellerangabe in kWh pro Jahr immer der verlässlichere Ausgangswert als der Watt-Aufdruck.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Was kostet der Homeoffice-PC?',
        schritte: [
          { label: 'Leistung', formel: '', ergebnis: '200 W' },
          { label: 'Nutzung', formel: '6 h/Tag, 5 Tage/Woche', ergebnis: '' },
          { label: 'Verbrauch pro Jahr', formel: '200 × 6 × 5 × 52 ÷ 1.000', ergebnis: '312 kWh' },
          { label: 'Strompreis', formel: 'BDEW-Mittel 2026', ergebnis: '37 ct/kWh' },
          { label: 'Kosten pro Jahr', formel: '312 × 37 ÷ 100', ergebnis: '115,44 €' },
          { label: 'Pro Monat', formel: '115,44 ÷ 12', ergebnis: '≈ 9,62 €' },
        ],
        fazit: 'Ein Homeoffice-PC mit 200 Watt, sechs Stunden an fünf Arbeitstagen pro Woche, kommt auf 312 Kilowattstunden im Jahr. Bei 37 Cent je Kilowattstunde sind das 115,44 Euro jährlich oder rund 9,60 Euro im Monat — nur für den Arbeitsrechner. Der Rechenweg ist immer derselbe: Watt mal Stunden ergibt die Energie pro Tag, hochgerechnet über die Nutzungstage und 52 Wochen den Jahresverbrauch, mal Strompreis die Kosten. Gibt man mehrere Geräte ein, summiert der Rechner sie zur gesamten Stromrechnung und zeigt, welcher Posten wie viel ausmacht. So wird sichtbar, ob sich ein effizienteres Gerät oder weniger Laufzeit lohnt. Beim PC hilft schon, ihn in den Ruhezustand statt in den Dauerbetrieb zu schicken. Läuft derselbe Rechner an sieben statt fünf Tagen, steigen Verbrauch und Kosten proportional auf rund 437 kWh und gut 161 Euro im Jahr — die Nutzungstage sind also ein ebenso großer Hebel wie der Strompreis.',
      },
      {
        typ: 'tabelle',
        titel: 'Strompreis-Profile (Stand 04/2026)',
        kopf: ['Tarif-Typ', 'ct/kWh', 'Bedeutung'],
        zeilen: [
          ['BDEW-Mittelwert (alle Tarife)', '37', 'Durchschnitt, Default des Rechners'],
          ['Festpreis-Neukundentarif', '33', 'günstiger bei aktivem Anbieterwechsel'],
          ['Grundversorgung', '40', 'Worst Case, ohne aktiven Vertrag'],
          ['Wärmepumpenstrom (eigener Zähler)', '28', 'Spezialtarif, separater Zähler'],
        ],
        fussnote: 'Arbeitspreise für Strom in Deutschland, Stand 04/2026 (Quellen: BDEW-Strompreisanalyse, Finanztip, ADAC). Der Rechner nutzt standardmäßig den BDEW-Mittelwert von 37 ct/kWh; den eigenen Preis findet man auf der Stromrechnung und sollte ihn dort übernehmen. Zusätzlich zum Arbeitspreis je kWh erhebt jeder Versorger einen monatlichen Grundpreis, der hier nicht enthalten ist — er fällt unabhängig vom Verbrauch an und steht ebenfalls auf der Jahresabrechnung.',
      },
      {
        typ: 'text',
        titel: 'Die größten Stromfresser im Haushalt',
        html: `<p>Nicht jedes Gerät wiegt gleich schwer. Den größten Anteil an der Stromrechnung haben meist die <strong>Kühl- und Gefriergeräte</strong> (rund 20 bis 30 Prozent), weil sie rund um die Uhr laufen — ein altes Gerät kann über 400 kWh im Jahr ziehen, ein modernes der besten Effizienzklasse nur noch 80 bis 150. Dahinter folgen <strong>Waschen, Trocknen und Spülen</strong>, wobei der Wäschetrockner der größte Einzelposten ist.</p><p>Auch <strong>Unterhaltungselektronik und IT</strong> summieren sich: großer Fernseher, Spiele-PC und mehrere Streaming-Geräte. <strong>Beleuchtung</strong> fällt mit LED kaum noch ins Gewicht, gegenüber alten Glühbirnen spart sie rund 85 Prozent. Oft unterschätzt wird der <strong>Stand-by-Verbrauch</strong>: Geräte, die scheinbar aus sind, ziehen weiter Strom — über alle Geräte zusammen schnell 50 bis 100 Euro im Jahr. Wer wissen will, wo das Geld hingeht, trägt seine größten Verbraucher in den Rechner ein und sieht die Anteile sofort. Genau dort lohnt sich das Sparen am meisten — ein einzelner großer Fresser bringt mehr als das Optimieren vieler Kleinverbraucher.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Dauerlast und Stand-by: was rund-um-die-Uhr kostet',
        kopf: ['Dauerlast', 'kWh/Jahr (24/7)', 'ca. €/Jahr (37 ct)'],
        zeilen: [
          ['1 W', '~8,8 kWh', '~3,24 €'],
          ['5 W', '~44 kWh', '~16 €'],
          ['10 W (WLAN-Router)', '~88 kWh', '~32 €'],
          ['20 W (altes Steckernetzteil)', '~175 kWh', '~65 €'],
          ['50 W (Stand-by mehrerer Geräte)', '~438 kWh', '~162 €'],
        ],
        fussnote: 'Dauerlast bedeutet rund um die Uhr (8.760 Stunden im Jahr). Faustregel: 1 Watt Dauerlast kostet bei 37 ct/kWh rund 3,24 Euro im Jahr. Unsichtbare Dauerläufer wie Router, Ladegeräte und Stand-by-Verbraucher summieren sich über das Jahr erheblich — eine abschaltbare Steckdosenleiste spart hier oft 50 bis 100 Euro jährlich, ohne dass man auf etwas verzichtet. Im Rechner bildet man Dauerläufer ab, indem man als Nutzungsdauer 24 Stunden an 7 Tagen pro Woche einträgt; für Geräte, die wirklich nur im Stand-by sind, nutzt man deren niedrige Stand-by-Leistung von oft nur 1 bis 5 Watt.',
      },
      {
        typ: 'text',
        titel: 'Was die Energieeffizienzklasse bringt',
        html: `<p>Seit 2021 gilt die neue EU-Energielabel-Skala von <strong>A bis G</strong> — die alten Pluszeichen (A+, A++, A+++) sind weggefallen, und die Anforderungen wurden verschärft, sodass anfangs kaum ein Gerät die Bestklasse A erreichte. Das Label zeigt neben der Klasse auch den genormten Jahresverbrauch in Kilowattstunden, der sich direkt mit dem Strompreis verrechnen lässt.</p><p>Die Unterschiede sind erheblich: Ein Kühlgerät der oberen Klassen verbraucht oft nur halb so viel wie ein 10 bis 15 Jahre altes Modell. Über die lange Nutzungsdauer eines Großgeräts — Kühlschränke laufen gut 15 Jahre — kann sich ein effizienteres Gerät trotz höherem Kaufpreis lohnen. Eine einfache Rechnung hilft: Verbrauchsdifferenz in Kilowattstunden mal Strompreis mal erwartete Nutzungsjahre ergibt die Stromersparnis über die Lebensdauer. Liegt sie über dem Mehrpreis, ist das sparsamere Gerät unterm Strich günstiger. Genau diese Jahresverbräuche kann man im Rechner gegenüberstellen, indem man beide Geräte mit ihren kWh-Werten einträgt.</p>`,
      },
      {
        typ: 'statistik',
        ...
        werte: [
          ...
          { label: 'Faustregel Dauerlast', wert: '1 W ≈ 3,24 €/Jahr', hinweis: 'rund um die Uhr, bei 37 ct' },
          { label: 'Ø Stromverbrauch (1 Person)', wert: '≈ 1.500 kWh/Jahr', hinweis: 'ohne elektrisches Warmwasser/Heizen' },
          { label: 'Ø Stromverbrauch (4 Personen)', wert: '≈ 4.000 kWh/Jahr', hinweis: 'Richtwert' },
          { label: 'Anteil Kühlen/Gefrieren', wert: '≈ 20–30 %', hinweis: 'läuft 24/7' },
        ],
      },
      {
        typ: 'checkliste',
        titel: 'Stromkosten senken',
        punkte: [
          'Die größten Dauerläufer zuerst prüfen: Kühl- und Gefriergeräte laufen 24/7.',
          'Beim Neukauf auf die EU-Energieeffizienzklasse achten (Skala A bis G seit 2021).',
          'Alte Glühbirnen durch LED ersetzen — rund 85 Prozent weniger Strom.',
          'Stand-by vermeiden: abschaltbare Steckdosenleisten für TV, PC und Ladegeräte.',
          'Den Wäschetrockner sparsam nutzen — der Wäscheständer spart schnell 100 €/Jahr.',
          'Für genaue Werte ein Verbrauchsmessgerät zwischen Steckdose und Gerät stecken.',
          'Den eigenen Strompreis aus der Abrechnung in den Rechner eintragen.',
          'Den Stromtarif vergleichen — die Grundversorgung ist meist der teuerste Tarif.',
        ],
      },
      {
        typ: 'infobox',
        variante: 'hinweis',
        titel: 'Strompreise schwanken — eigenen Preis einsetzen',
        text: 'Die hinterlegten Strompreise sind Richtwerte mit Stand 04/2026 (BDEW-Mittel 37 ct/kWh) und können sich rasch ändern — Strompreise schwanken mit dem Großhandelsmarkt, dem Tarif und der Region erheblich. Die Grundversorgung liegt oft über 40 ct, ein Festpreis-Neuvertrag teils unter 33 ct. Maßgeblich ist immer Ihr eigener Arbeitspreis, den Sie auf der Stromrechnung finden und im Rechner eintragen sollten. Beachten Sie zusätzlich den monatlichen Grundpreis Ihres Vertrags: Er fällt unabhängig vom Verbrauch an und ist in dieser Geräte-Rechnung nicht enthalten. Für die reine Frage „Was kostet mich dieses Gerät?" ist aber der Arbeitspreis je Kilowattstunde die entscheidende Größe. Wer den Grundpreis und mehrere Verbraucher gemeinsam betrachten will, nutzt ergänzend den Stromkosten-Rechner für den gesamten Haushalt.',
      },
      {
        typ: 'infobox',
        variante: 'tipp',
        titel: 'Verbrauch aus Herstellerangabe oder Messung übernehmen',
        text: 'Den genauesten Wert bekommen Sie nicht über den Watt-Aufdruck, sondern über die tatsächliche Jahres-Kilowattstundenzahl. Bei größeren Geräten steht sie auf dem EU-Energielabel oder im Datenblatt (kWh/Jahr) — diesen Wert können Sie direkt mit Ihrem Strompreis multiplizieren. Noch genauer misst ein günstiges Verbrauchsmessgerät (Steckdosen-Strommesser), das man zwischen Steckdose und Gerät steckt und einige Tage laufen lässt; es zeigt den realen Verbrauch inklusive Stand-by. Gerade bei Kühlgeräten, die ständig takten, ist die Messung aussagekräftiger als jede Überschlagsrechnung. Mit dem gemessenen oder abgelesenen kWh-Wert liefert der Rechner dann ein verlässliches Ergebnis. Ein solches Messgerät kostet nur wenige Euro und macht die größten Stromfresser im Haushalt schnell sichtbar.',
      },
    ],
    quellen: [
      ...
      { titel: 'Methodik der Berechnung', hinweis: 'Jahresverbrauch = Leistung (W) × Stunden/Tag × Nutzungstage/Woche × 52 ÷ 1.000; Kosten = kWh × Arbeitspreis (ct/kWh) ÷ 100. Voreingestellter Strompreis 37 ct/kWh (BDEW-Mittel 2026), eigene Eingabe maßgeblich.' },
    ],
  },
  {

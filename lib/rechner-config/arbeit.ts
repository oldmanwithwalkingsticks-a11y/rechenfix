...
Bei einem Unfall unter Alkoholeinfluss verschärfen sich die Strafen erheblich. Bereits ab 0,3 ‰ kann bei einem Unfall eine Straftat vorliegen. Die Kfz-Versicherung kann bei Alkohol am Steuer die Leistung kürzen oder ganz verweigern.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Wie funktioniert der Promillerechner?',
        html: `<p>Der Promillerechner schätzt mit der <strong>Widmark-Formel</strong> den Blutalkoholgehalt (BAK) aus der getrunkenen Menge, dem Körpergewicht, dem Geschlecht und der vergangenen Zeit. Er zeigt, wie hoch der Wert nach dem Trinken etwa ist und wie lange der Abbau bis 0,0 ‰ dauert.</p><p><strong>Wichtig vorweg:</strong> Das Ergebnis ist nur eine grobe Orientierung. Individuelle Faktoren wie Mageninhalt, Lebergesundheit, Medikamente, Tagesform oder Genetik können den tatsächlichen Wert deutlich verschieben — auch nach oben. Der Rechner ersetzt keine amtliche Messung und ist kein Werkzeug, um eine „noch erlaubte" Fahrt zu planen. Der einzig sichere Wert hinter dem Steuer ist <strong>0,0 ‰</strong>. Im Zweifel gilt immer: das Auto stehen lassen. Sinnvoll ist der Rechner vor allem, um ein Gefühl dafür zu bekommen, wie wenig Alkohol nötig ist, um in den strafbaren Bereich zu rutschen, und wie lange der Körper für den Abbau tatsächlich braucht — meist deutlich länger, als man erwartet.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Beispiel: BAK nach zwei Bier',
        schritte: [
          { label: 'Person', formel: 'Mann, 80 kg', ergebnis: 'Reduktionsfaktor 0,68' },
          { label: 'Getränke', formel: '2 × 0,5 L Bier à 5 %', ergebnis: '40 g Alkohol' },
          { label: 'BAK maximal', formel: '40 g ÷ (80 kg × 0,68)', ergebnis: '0,74 ‰' },
          { label: 'Abbau nach 2 Std.', formel: '2 h × 0,15 ‰/h', ergebnis: '−0,30 ‰' },
          { label: 'BAK aktuell', formel: '0,74 ‰ − 0,30 ‰', ergebnis: 'rund 0,44 ‰' },
        ],
        fazit: 'Nach zwei Bier liegt der Mann rechnerisch bei rund 0,44 ‰ — über der 0,3-‰-Schwelle, ab der bei Ausfallerscheinungen bereits eine Straftat vorliegen kann, und nicht weit unter der 0,5-‰-Ordnungswidrigkeitsgrenze. Schon dieses Alltagsbeispiel zeigt, wie schnell kritische Werte erreicht sind — und die tatsächliche BAK kann höher liegen als die Schätzung.',
      },
      {
        typ: 'text',
        titel: 'Die Widmark-Formel im Detail',
        html: `<p>Die Berechnung läuft in zwei Schritten. Zuerst die Alkoholmenge: <strong>Alkohol (g) = Liter × Volumenprozent × 0,8 × 10</strong> — die 0,8 ist die Dichte von Alkohol. Dann die Blutalkoholkonzentration: <strong>BAK (‰) = Alkohol (g) ÷ (Körpergewicht in kg × Reduktionsfaktor)</strong>. Der Reduktionsfaktor beträgt <strong>0,68 bei Männern und 0,55 bei Frauen</strong> und bildet den Anteil des Körperwassers ab, in dem sich der Alkohol verteilt.</p><p>Weil Frauen im Schnitt einen geringeren Körperwasseranteil haben, erreichen sie bei gleicher Trinkmenge und gleichem Gewicht höhere Promillewerte als Männer. Auch das Körpergewicht wirkt direkt: Je schwerer die Person, desto größer das Verteilungsvolumen und desto niedriger die Konzentration. Wer seinen Körperbau einordnen will, kann den <a href="/gesundheit/bmi-rechner">BMI-Rechner</a> nutzen; dass Alkohol nebenbei rund 7 kcal pro Gramm liefert, zeigt der <a href="/gesundheit/kalorienrechner">Kalorienrechner</a>. Beachten Sie: Die Formel geht von vollständig aufgenommenem Alkohol aus und berücksichtigt weder das sogenannte Resorptionsdefizit noch den Mageninhalt — sie liefert deshalb tendenziell einen Maximalwert, der im Einzelfall aber auch überschritten werden kann. Eine exakte Bestimmung ist nur über eine Blut- oder Atemalkoholmessung möglich.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Promille je Getränk (Maximalwert ohne Abbau)',
        kopf: ['Getränk', 'Menge', 'Mann (80 kg)', 'Frau (60 kg)'],
        zeilen: [
          ['Bier (5 %)', '0,5 L', '0,37 ‰', '0,61 ‰'],
          ['Wein (12 %)', '0,2 L', '0,35 ‰', '0,58 ‰'],
          ['Sekt (11 %)', '0,1 L', '0,16 ‰', '0,27 ‰'],
          ['Schnaps (40 %)', '0,02 L', '0,12 ‰', '0,19 ‰'],
          ['Cocktail (15 %)', '0,3 L', '0,66 ‰', '1,09 ‰'],
          ['2 Bier', '1,0 L', '0,74 ‰', '1,21 ‰'],
          ['3 Bier', '1,5 L', '1,10 ‰', '1,82 ‰'],
        ],
        fussnote: 'Maximalwerte direkt nach dem Trinken, ohne Berücksichtigung des Abbaus. Sie gelten für einen 80 kg schweren Mann und eine 60 kg schwere Frau und sind grobe Schätzungen nach Widmark — der reale Wert kann abweichen. Schon ein Cocktail oder zwei Bier bringen viele Menschen in die Nähe der 0,5-‰-Grenze.',
      },
      {
        typ: 'text',
        titel: 'Alkoholabbau: langsam und nicht zu beschleunigen',
        html: `<p>Der Körper baut Alkohol nur langsam und mit nahezu konstanter Geschwindigkeit ab — rund <strong>0,15 ‰ pro Stunde</strong> (je nach Person zwischen 0,10 und 0,20 ‰). Dieser Abbau findet fast ausschließlich in der Leber statt und lässt sich durch nichts beschleunigen.</p><p>Weder <strong>Kaffee, kalte Duschen, frische Luft, Sport noch das Trinken von Wasser</strong> verkürzen die Abbauzeit — sie machen bestenfalls wacher, senken aber den Promillewert nicht. Ein einzelnes Standardgetränk braucht grob ein bis zwei Stunden, bis es abgebaut ist. Wer abends viel trinkt, sollte deshalb großzügig rechnen: Bis ein hoher Wert vollständig verschwunden ist, vergehen schnell viele Stunden — oft bis weit in den nächsten Tag hinein. „Wach" oder „fit" zu sein bedeutet nicht, nüchtern zu sein. Als grobe Faustregel gilt: Für jedes Bier oder jedes Glas Wein sollte man rund zwei Stunden bis zum vollständigen Abbau einplanen — und selbst diese Schätzung ist nach oben offen.</p>`,
      },
      {
        typ: 'infobox',
        variante: 'warnung',
        titel: 'Restalkohol am Morgen unterschätzt man leicht',
        text: 'Eine der häufigsten Ursachen für Trunkenheitsfahrten ist der Restalkohol am Morgen danach. Wer um zwei Uhr nachts noch bei 1,5 ‰ liegt, ist bei einem Abbau von 0,15 ‰ pro Stunde erst nach rund zehn Stunden — also gegen Mittag — wieder bei 0,0 ‰. Wer dann morgens um acht ins Auto steigt, hat noch deutlich über 0,5 ‰ im Blut und begeht eine Ordnungswidrigkeit oder sogar eine Straftat, ohne sich betrunken zu fühlen. Ausgeschlafen zu sein heißt eben nicht, nüchtern zu sein, denn der Abbau läuft im Schlaf nicht schneller. Besonders tückisch ist das nach Feiern, die bis in die frühen Morgenstunden gehen: Der Berufsverkehr am nächsten Morgen fällt oft mitten in die Phase, in der noch erhebliche Restwerte vorhanden sind. Planen Sie nach einem langen Abend den nächsten Morgen bewusst ohne Auto.',
      },
      {
        typ: 'tabelle',
        titel: 'Promille-Grenzwerte im Straßenverkehr',
        kopf: ['Grenze', 'Bedeutung', 'Rechtsgrundlage'],
        zeilen: [
...
Mit diesen Strategien reduzieren Sie Ihre Beiträge: Kombinieren Sie mehrere Bausteine — Kombi-Pakete sind meist günstiger als einzelne Bausteine. Wählen Sie eine angemessene Selbstbeteiligung (150–250 Euro). Zahlen Sie jährlich statt monatlich — das spart 3–5 Prozent. Vergleichen Sie regelmäßig die Angebote verschiedener Versicherer. Prüfen Sie, ob Ihr Arbeitgeber eine Gruppen-Rechtsschutzversicherung anbietet. Und: Nutzen Sie bestehende Mitgliedschaften — viele Gewerkschaften und der ADAC bieten ihren Mitgliedern vergünstigten Rechtsschutz.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Was ist eine Rechtsschutzversicherung?',
        html: `<p>Eine <strong>Rechtsschutzversicherung</strong> übernimmt die Kosten eines Rechtsstreits — Anwalts- und Gerichtsgebühren, Gutachter, Zeugen und im Fall einer Niederlage auch die gegnerischen Kosten. So lässt sich das eigene Recht durchsetzen, ohne das volle Prozesskostenrisiko allein zu tragen.</p><p>Der Schutz ist <strong>modular</strong> aufgebaut: Man kombiniert die Bausteine, die zur eigenen Lebenssituation passen — etwa Berufs-, Verkehrs-, Miet- oder Privatrechtsschutz. Der Beitrag richtet sich nach diesen Bausteinen, der gewählten Selbstbeteiligung, der Zahlweise und dem Berufsstatus. Dieser Rechner schätzt daraus einen realistischen Monats- und Jahresbeitrag. <strong>Wichtig:</strong> Das Ergebnis ist eine grobe Orientierung und kein verbindliches Angebot — die tatsächlichen Tarife unterscheiden sich je nach Versicherer, Leistungsumfang und Region zum Teil deutlich. Eine Rechtsschutzversicherung ist damit vor allem eine Absicherung gegen das schwer kalkulierbare Kostenrisiko eines Rechtsstreits: Sie verschafft die finanzielle Freiheit, das eigene Recht auch dann durchzusetzen, wenn der Gegner über mehr Mittel verfügt.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Beispiel: Beitrag für einen Single',
        schritte: [
          { label: 'Bausteine', formel: 'Privat 15 € + Beruf 8 € + Verkehr 5 €', ergebnis: '28 €/Monat' },
          { label: 'Berufsstatus', formel: 'angestellt', ergebnis: '× 1,00' },
          { label: 'Selbstbeteiligung 150 €', formel: '− 10 % Rabatt', ergebnis: '× 0,90' },
          { label: 'Zahlweise monatlich', formel: 'kein Rabatt', ergebnis: '× 1,00' },
          { label: 'Monatsbeitrag', formel: '28 € × 1,00 × 0,90', ergebnis: '25,20 €/Monat' },
          { label: 'Jahresbeitrag', formel: '25,20 € × 12', ergebnis: '302,40 €/Jahr' },
        ],
        fazit: 'Ein alleinstehender Angestellter mit Privat-, Berufs- und Verkehrsrechtsschutz und 150 € Selbstbeteiligung zahlt rund 25 € im Monat. Wer jährlich statt monatlich zahlt, spart zusätzlich 5 %. Die Werte sind eine Schätzung — echte Angebote können je nach Versicherer höher oder niedriger ausfallen.',
      },
      {
        typ: 'text',
        titel: 'Wie sich der Beitrag zusammensetzt',
        html: `<p>Der Rechner bildet die übliche Tarifkalkulation nach. Ausgangspunkt ist die <strong>Summe der gewählten Bausteine</strong>. Darauf wirken drei Faktoren: der <strong>Berufsstatus</strong> (Selbstständige zahlen wegen des höheren Streitrisikos rund 15 % mehr, Rentner etwa 5 %, Angestellte den Normalsatz), die <strong>Selbstbeteiligung</strong> (je höher der vereinbarte Eigenanteil, desto größer der Beitragsrabatt) und die <strong>Zahlweise</strong> (jährliche Zahlung bringt meist 5 % Nachlass).</p><p>Diese Stellschrauben erklären, warum zwei Haushalte mit demselben Bausteinpaket sehr unterschiedliche Beiträge zahlen können. Wer die Faktoren kennt, kann den eigenen Tarif gezielt gestalten — etwa eine mittlere Selbstbeteiligung wählen und jährlich zahlen, ohne am Leistungsumfang zu sparen. Die hier hinterlegten Werte sind Modellwerte; reale Versicherer rechnen mit eigenen Tabellen und zusätzlichen Merkmalen wie Wohnort oder Schadenfreiheit.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Die vier Rechtsschutz-Bausteine',
        kopf: ['Baustein', 'Deckt ab', 'Single', 'Familie'],
        zeilen: [
          ['Privat', 'Alltag, Kauf, Internet, Nachbarn', '15 €', '22 €'],
          ['Beruf', 'Kündigung, Abmahnung, Gehalt, Zeugnis', '8 €', '8 €'],
          ['Verkehr', 'Unfall, Bußgeld, Führerschein', '5 €', '7 €'],
          ['Miete', 'Vermieter, Nebenkosten, Kaution', '6 €', '8 €'],
        ],
        fussnote: 'Monatliche Richtbeiträge je Baustein, modellhaft und ohne Rabatte. Die Bausteine lassen sich frei kombinieren; je mehr gebündelt werden, desto günstiger ist meist der Gesamttarif. Die tatsächlichen Preise variieren je nach Versicherer und Leistungsumfang. Der Berufsbaustein kostet im Familientarif gleich viel wie im Single-Tarif, weil er sich auf die antragstellende erwerbstätige Person bezieht — Verkehr und Privat steigen dagegen mit der Zahl der mitversicherten Personen.',
      },
      {
        typ: 'vergleich',
        titel: 'Streitfall mit und ohne Rechtsschutz',
        spalteA: 'Mit Rechtsschutz',
        spalteB: 'Ohne Rechtsschutz',
        zeilen: [
          { kriterium: 'Anwaltskosten', a: 'übernimmt die Versicherung', b: 'voll selbst zu tragen' },
          { kriterium: 'Gerichtskosten', a: 'gedeckt (nach Wartezeit)', b: 'Vorschuss aus eigener Tasche' },
          { kriterium: 'Kosten bei Niederlage', a: 'auch gegnerische Kosten gedeckt', b: 'beide Seiten selbst zu zahlen' },
          { kriterium: 'Eigenanteil', a: 'nur die Selbstbeteiligung', b: 'volles Kostenrisiko' },
          { kriterium: 'Zugang zum Recht', a: 'unabhängig vom Streitwert', b: 'oft Verzicht aus Kostenangst' },
          { kriterium: 'Kostenrisiko', a: 'auf die Selbstbeteiligung begrenzt', b: 'ein Prozess kostet schnell das Vielfache des Jahresbeitrags' },
        ],
      },
      {
        typ: 'vergleich',
        titel: 'Selbstbeteiligung: niedrig oder hoch?',
        spalteA: 'Niedrige SB (0–150 €)',
        spalteB: 'Hohe SB (250–500 €)',
        zeilen: [
          { kriterium: 'Monatsbeitrag', a: 'höher (0 € SB = voller Preis)', b: 'günstiger (500 € = −25 %)' },
          { kriterium: 'Eigenanteil je Fall', a: 'gering oder keiner', b: '250–500 € pro Streitfall' },
          { kriterium: 'Geeignet für', a: 'wer öfter mit Streit rechnet', b: 'wer selten Fälle erwartet' },
          { kriterium: 'Planbarkeit', a: 'kaum Eigenkosten im Fall', b: 'niedrige feste Prämie' },
          { kriterium: 'Empfehlung', a: '150–250 € als Kompromiss (−10 bis −18 %)', b: 'nur bei sehr geringem Streitrisiko sinnvoll' },
        ],
      },
      {
        typ: 'text',
        titel: 'Wann lohnt sich der Schutz?',
        html: `<p>Ob sich Rechtsschutz lohnt, ist eine einfache Abwägung: Der Jahresbeitrag von rund 300 € steht einem möglichen Streitwert gegenüber, der schnell ein Vielfaches beträgt. Eine <strong>Kündigungsschutzklage</strong> kann je nach Gehalt 3.000 bis 8.000 € kosten, ein Mietstreit 1.000 bis 3.000 €. Schon ein einziger ernsthafter Streitfall kann damit teurer werden als zehn Jahre Beitrag.</p><p>Besonders sinnvoll ist der Schutz für <strong>Arbeitnehmer</strong> (etwa bei Streit um Kündigung, Abfindung oder Zeugnis — siehe <a href="/arbeit/abfindungsrechner">Abfindungs-Rechner</a> und <a href="/arbeit/kuendigungsfrist-rechner">Kündigungsfrist-Rechner</a>), für <strong>Mieter</strong> (zum Beispiel bei Streit um Nebenkosten oder die <a href="/wohnen/mietpreisbremse-rechner">Mietpreisbremse</a>) und für <strong>Vielfahrer</strong>. Wer dagegen kaum rechtliche Risiken hat, kann auf einzelne Bausteine verzichten und so sparen.</p>`,
      },
      {
        typ: 'text',
        titel: 'Typische Fälle aus der Praxis',
        html: `<p>Wofür Rechtsschutz konkret einspringt, zeigen Alltagsbeispiele. Im <strong>Berufsrechtsschutz</strong> sind es vor allem Kündigungsschutzklagen, Streit um Abmahnungen, ausstehendes Gehalt oder ein fehlerhaftes Arbeitszeugnis. Der <strong>Mietrechtsschutz</strong> greift bei überhöhten Nebenkostenabrechnungen, Streit um die Kaution oder Mängeln in der Wohnung.</p><p>Im <strong>Verkehrsrechtsschutz</strong> geht es um Bußgeldbescheide, die Schadensregulierung nach einem Unfall oder den drohenden Entzug des Führerscheins. Der <strong>Privatrechtsschutz</strong> deckt typische Verbraucherfälle ab — etwa Gewährleistung beim Autokauf, Ärger mit Online-Händlern oder Nachbarschaftsstreit. Diese Bandbreite macht deutlich, warum die Bausteine einzeln wählbar sind: Nicht jeder braucht jeden Bereich, und genau das hält den Beitrag schlank. Wer etwa kein Auto besitzt, kann den Verkehrsbaustein weglassen; wer im Eigenheim wohnt, braucht den Mietrechtsschutz nicht. Die richtige Kombination ergibt sich aus der eigenen Lebenssituation und sollte bei Veränderungen — Umzug, Jobwechsel, Familiengründung — neu überprüft werden.</p>`,
      },
      {
        typ: 'infobox',
        variante: 'hinweis',
        titel: 'Wartezeiten beachten',
        text: 'Die meisten Rechtsschutzbausteine haben eine Wartezeit von rund drei Monaten: Erst danach besteht voller Schutz. Eine Ausnahme ist vor allem der Verkehrsrechtsschutz, der häufig sofort ohne Wartezeit greift. Entscheidend ist, die Versicherung abzuschließen, bevor ein Konflikt entsteht — denn für bereits laufende oder absehbare Streitigkeiten zahlt keine Rechtsschutzversicherung. Das ist einer der häufigsten Ablehnungsgründe: Wer erst nach der Kündigung oder mitten im Mietstreit abschließt, geht leer aus. Rechtsschutz ist Vorsorge, kein nachträglicher Kostenersatz. Manche Tarife verzichten beim Wechsel von einem bestehenden Vertrag auf die erneute Wartezeit (sogenannte Vorversicherungs-Anrechnung) — ein Punkt, der sich beim Anbieterwechsel zu erfragen lohnt. Wer akut Streit absehen kann, sollte also nicht zögern, sondern den Schutz frühzeitig einrichten.',
      },
      {
        typ: 'vergleich',
        titel: 'Single- oder Familientarif?',
        spalteA: 'Single-Tarif',
        spalteB: 'Familien-Tarif',
        zeilen: [
          { kriterium: 'Versicherte', a: 'nur die antragstellende Person', b: 'Partner und Kinder mitversichert' },
          { kriterium: 'Privat-Baustein', a: 'ca. 15 €/Monat', b: 'ca. 22 €/Monat' },
          { kriterium: 'Kinder', a: 'nicht abgedeckt', b: 'unverheiratete Kinder meist bis Ausbildungsende' },
          { kriterium: 'Sinnvoll für', a: 'Alleinstehende', b: 'Paare und Familien im selben Haushalt' },
          { kriterium: 'Kostenvorteil', a: 'ein eigener Vertrag pro Person nötig', b: 'oft günstiger als mehrere Einzelverträge' },
        ],
      },
      {
        typ: 'text',
        titel: 'Was die Versicherung nicht abdeckt',
        html: `<p>Eine Rechtsschutzversicherung deckt längst nicht jeden Streit. Zu den typischen <strong>Ausschlüssen</strong> gehören vorsätzlich begangene Straftaten, Streitigkeiten rund um den <strong>Hausbau</strong> und Baurisiken, <strong>Kapitalanlagen und Spekulationsgeschäfte</strong> sowie bereits vor Vertragsschluss bestehende Konflikte.</p><p>Auch <strong>familienrechtliche Verfahren</strong> sind meist nur eingeschränkt abgedeckt: Eine Scheidung wird in der Regel nur als anwaltliche Erstberatung übernommen, nicht das gesamte Verfahren — die tatsächlichen Kosten zeigt der <a href="/arbeit/scheidungskosten-rechner">Scheidungskosten-Rechner</a>. Vor dem Abschluss lohnt deshalb ein genauer Blick in die Leistungsbeschreibung: Welche Bereiche sind eingeschlossen, welche ausgeschlossen, und gibt es Höchstgrenzen je Fall? Diese Details entscheiden im Ernstfall über die Deckung. Auch Wartezeiten und sogenannte Vorerstreckungsklauseln, die zeitlich vor dem Vertrag liegende Ursachen ausschließen, sind hier geregelt — wer sie übersieht, erlebt im Schadensfall böse Überraschungen.</p>`,

      },
      {
        typ: 'text',
        titel: 'Freie Anwaltswahl und Gutachterverfahren',
        html: `<p>Ein zentrales Recht der Versicherten ist die <strong>freie Anwaltswahl</strong>. Nach § 127 VVG dürfen Sie den Anwalt Ihres Vertrauens selbst aussuchen — die Versicherung darf Ihnen keinen bestimmten Anwalt vorschreiben. Das sichert eine unabhängige Vertretung Ihrer Interessen.</p><p>Bei Meinungsverschiedenheiten darüber, ob ein Fall hinreichende Aussicht auf Erfolg hat, sieht § 128 VVG ein <strong>Gutachterverfahren</strong> (Stichentscheid) vor: Ein unabhängiger Anwalt beurteilt die Erfolgsaussichten, wenn die Versicherung die Deckung ablehnt. Viele Tarife bieten zusätzlich eine kostenlose telefonische Erstberatung, die nicht auf die Selbstbeteiligung angerechnet wird — eine niedrigschwellige Möglichkeit, eine erste Einschätzung zu bekommen, bevor ein teures Verfahren beginnt. Gerade dieser frühe, unverbindliche Rat hilft oft, einen Streit ohne Gericht beizulegen oder die eigenen Erfolgsaussichten realistisch einzuschätzen.</p>`,
      },
      {
        typ: 'infobox',
        variante: 'tipp',
        titel: 'So sparen Sie beim Beitrag',
        text: 'Mehrere Stellschrauben senken den Beitrag, ohne den Schutz zu schwächen. Bündeln Sie die benötigten Bausteine in einem Kombi-Paket — das ist meist günstiger als einzelne Verträge. Eine Selbstbeteiligung von 150 bis 250 € reduziert die Prämie deutlich, hält den Eigenanteil im Streitfall aber überschaubar. Wer jährlich statt monatlich zahlt, bekommt häufig rund 5 % Rabatt. Vergleichen Sie Tarife regelmäßig, denn die Angebote ändern sich laufend. Und prüfen Sie, ob ein Gruppen- oder Verbandsrechtsschutz über Gewerkschaft, Automobilclub oder Mieterverein günstiger ist als ein eigener Vertrag. Gewerkschaftsmitglieder etwa haben für arbeitsrechtliche Streitigkeiten oft bereits kostenlosen Rechtsschutz und brauchen den Berufsbaustein dann gar nicht. Ein letzter Hebel ist die Vertragslaufzeit: Kurze Laufzeiten mit jährlicher Kündigungsmöglichkeit halten Sie flexibel, falls ein günstigeres Angebot auftaucht.',
      },
      {
        typ: 'checkliste',
        titel: 'Checkliste vor dem Abschluss',
        punkte: [
...
Kalkulieren Sie Ihren Stundensatz großzügig: Es ist einfacher, einen Rabatt zu geben, als den Satz nachträglich zu erhöhen. Bauen Sie einen Puffer von 10 bis 15 Prozent für unvorhergesehene Kosten ein. Erhöhen Sie Ihren Stundensatz jährlich mindestens um die Inflationsrate. Und vor allem: Kommunizieren Sie Ihren Wert, nicht nur Ihre Zeit. Ein erfahrener Freelancer löst Probleme oft schneller als ein günstigerer Kollege — der höhere Stundensatz bedeutet nicht zwangsläufig höhere Projektkosten.`,
    ...
    contentBloecke: [
      {
        typ: 'text',
        titel: 'Warum der richtige Stundensatz entscheidend ist',
        html: `<p>Der Stundensatz ist die wichtigste Stellschraube jeder selbstständigen Tätigkeit — und zugleich die am häufigsten unterschätzte. Der typische Fehler: Wer aus dem Angestelltenverhältnis kommt, teilt sein bisheriges Bruttogehalt durch die Monatsstunden und landet bei einem scheinbar fairen Satz. Diese Rechnung blendet aus, dass ein Freelancer Krankenversicherung, Altersvorsorge, Steuern und alle Betriebskosten allein trägt und nur einen Teil seiner Arbeitszeit überhaupt in Rechnung stellen kann.</p><p>Dieser Rechner dreht die Logik um: Er startet beim gewünschten Netto-Einkommen und addiert Schritt für Schritt alle Kosten, bis der Satz feststeht, den Sie wirklich brauchen — pro Stunde und als Tagessatz. So sehen Sie, ob Ihr Wunschpreis am Markt durchsetzbar ist. Das Ergebnis ist eine Orientierung für die eigene Kalkulation, keine Steuer- oder Honorarberatung. Wer den Vergleich zum <a href="/finanzen/stundenlohn-rechner">Stundenlohn als Angestellter</a> sucht, sieht den Unterschied sofort.</p>`,
      },
      {
        typ: 'beispielrechnung',
        titel: 'Vom Wunsch-Netto zum Stundensatz',
        schritte: [
          { label: 'Wunsch-Netto', formel: 'gewünschtes Netto-Einkommen', ergebnis: '3.000 €/Monat' },
          { label: 'Plus feste Kosten', formel: '+ 450 KV + 300 Rente + 200 Betrieb', ergebnis: '+ 950 €' },
          { label: 'Netto-Bedarf', formel: '3.000 + 950', ergebnis: '3.950 €/Monat' },
          { label: 'Steuer einrechnen', formel: '3.950 ÷ (1 − 0,30)', ergebnis: '5.643 €/Monat' },
          { label: 'Jahresbedarf', formel: '5.643 × 12', ergebnis: '67.714 €/Jahr' },
          { label: 'Stundensatz netto', formel: '67.714 ÷ 1.200 fakturierbare Std', ergebnis: '56,43 €/Std' },
        ],
        fazit: 'Aus 3.000 € Wunsch-Netto wird bei 30 % Steuersatz und rund 1.200 fakturierbaren Jahresstunden ein Netto-Stundensatz von 56,43 €. Bei Regelbesteuerung kommen darauf noch 19 % Umsatzsteuer, die für Geschäftskunden ein durchlaufender Posten ist. Der Tagessatz ergibt sich aus Stundensatz × produktive Stunden pro Tag — bei sechs Stunden also rund 339 €. Diese drei Zahlen — Stundensatz netto, Stundensatz brutto und Tagessatz — sollten in jedem Angebot zueinander passen.',
      },
      {
        typ: 'text',
        titel: 'Welche Kosten in den Stundensatz gehören',
        html: `<p>In einen tragfähigen Stundensatz fließen weit mehr Posten ein als das reine Wunsch-Einkommen. Den größten Brocken bildet die <strong>Krankenversicherung</strong>: Als Selbstständiger zahlen Sie den vollen Beitrag allein, je nach Tarif und Einkommen rund 450 bis 900 Euro im Monat. Dazu kommt die <strong>Altersvorsorge</strong> — wer im Alter nicht abrutschen will, sollte mindestens 300 bis 500 Euro monatlich zurücklegen.</p><p>Hinzu treten die laufenden <strong>Betriebsausgaben</strong>: Büro oder Coworking, Software-Abos, Telefon und Internet, Fachliteratur, Versicherungen und der Steuerberater. Auch <strong>Rücklagen</strong> für Krankheit, Auftragsflauten und Weiterbildung gehören in die Kalkulation, denn anders als Angestellte erhalten Freelancer keine Lohnfortzahlung. Erst auf die Summe all dieser Posten wird die <a href="/finanzen/einkommensteuer-rechner">Einkommensteuer</a> aufgeschlagen — je nach Gewinn zwischen 25 und 42 Prozent. Was dann übrig bleibt, ist der monatliche Brutto-Bedarf, den der Stundensatz erwirtschaften muss.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Kostenaufschlüsselung am Beispiel',
        kopf: ['Posten', 'Betrag/Monat', 'Anteil'],
        zeilen: [
        ...
        fussnote: 'Aufschlüsselung des monatlichen Brutto-Bedarfs aus dem Beispiel (3.000 € Wunsch-Netto, 30 % Steuersatz). Die Einkommensteuer ergibt sich als Differenz zwischen dem Netto-Bedarf von 3.950 € und dem Brutto-Bedarf von 5.643 €. Die Anteile machen deutlich, dass weniger als die Hälfte des erwirtschafteten Umsatzes als verfügbares Einkommen ankommt — der Rest fließt in Steuern, Vorsorge und Betrieb. Wer das ausblendet, kalkuliert seinen Satz zwangsläufig zu niedrig. Der konkrete Steuersatz hängt vom Gewinn ab und steigt mit zunehmendem Einkommen: Bei einem höheren Wunsch-Netto verschiebt sich der Anteil der Einkommensteuer nach oben, weil der progressive Tarif greift. Deshalb lohnt es sich, die eigene Aufstellung mit den persönlichen Werten zu wiederholen, statt pauschal mit 30 Prozent zu rechnen.',
      },
      {
        typ: 'text',
        titel: 'Fakturierbare Stunden realistisch ansetzen',
        html: `<p>Der zweite große Hebel neben den Kosten sind die <strong>fakturierbaren Stunden</strong> — und genau hier verrechnen sich die meisten. Ein Jahr hat 365 Tage, doch nach Abzug von Wochenenden, Urlaub, Krankheit und Feiertagen bleiben nur rund 200 bis 220 Arbeitstage. Schon das reduziert die theoretisch verfügbare Zeit erheblich.</p><p>Von diesen Arbeitstagen ist zudem nicht jede Stunde abrechenbar. <strong>Akquise, Angebotserstellung, Buchhaltung, E-Mails, Weiterbildung und Verwaltung</strong> verschlingen typischerweise 20 bis 30 Prozent der Arbeitszeit, ohne dass eine Rechnung dabei herausspringt. Realistisch bleiben damit nur etwa 100 bis 120 fakturierbare Stunden pro Monat. Wer mit 160 Stunden kalkuliert, setzt seinen Stundensatz systematisch zu niedrig an und arbeitet die Differenz unbezahlt nach. Die Faustregel lautet deshalb: lieber konservativ planen und sich über jede zusätzliche abrechenbare Stunde freuen, als die Auslastung schönzurechnen und am Monatsende ins Minus zu rutschen.</p>`,
      },
      {
        typ: 'tabelle',
        titel: 'Typische Stundensätze nach Branche 2026',
        kopf: ['Branche', 'Erfahren', 'Einsteiger (−20–40 %)'],
        zeilen: [
        ...
        fussnote: 'Marktübliche Netto-Stundensätze für Freelancer in Deutschland 2026, je nach Branche, Erfahrung und Region. Berufseinsteiger liegen meist 20 bis 40 Prozent unter den Sätzen erfahrener Kräfte. Die Spannen sind Orientierungswerte und keine festen Tarife — gleichen Sie Ihren kalkulierten Satz immer mit dem aktuellen Marktniveau Ihrer Branche ab, um konkurrenzfähig und zugleich auskömmlich zu bleiben. Innerhalb einer Branche entscheidet vor allem die Spezialisierung über die Position in der Spanne: Wer ein gefragtes Nischenwissen mitbringt oder nachweisbare Projekterfolge vorweist, kann das obere Ende verlangen, während breit aufgestellte Generalisten eher im Mittelfeld landen. Auch die Region spielt eine Rolle — in Ballungsräumen werden tendenziell höhere Sätze gezahlt als in strukturschwächeren Gegenden.',
      },
      {
        typ: 'text',
        titel: 'Warum Freelancer mehr brauchen als Angestellte',
        html: `<p>Ein verbreitetes Missverständnis: Viele orientieren sich am Stundenlohn von Angestellten. Ein Angestellter mit 4.000 Euro brutto kommt rechnerisch auf etwa 23 Euro pro Stunde — als Freelancer kämen Sie damit nicht aus. Der Grund liegt in drei Lücken. Erstens trägt bei Angestellten der Arbeitgeber rund 20 Prozent <strong>Sozialversicherungsbeiträge</strong> obendrauf; als Selbstständiger zahlen Sie diese komplett selbst. Ein Blick in den <a href="/finanzen/brutto-netto-rechner">Brutto-Netto-Rechner</a> zeigt, wie viel vom Angestelltenbrutto netto übrig bleibt.</p><p>Zweitens gibt es weder bezahlten Urlaub noch Lohnfortzahlung im Krankheitsfall. Drittens ist ein erheblicher Teil der Arbeitszeit unbezahlte Verwaltung. Als Faustregel sollte der Freelancer-Satz mindestens das 1,5- bis 2-Fache des vergleichbaren Angestellten-Stundenlohns betragen. Je nach Rechtsform kann zusätzlich <a href="/finanzen/gewerbesteuer-rechner">Gewerbesteuer</a> anfallen — Freiberufler sind davon befreit, Gewerbetreibende nicht.</p>`,
      },
      {
        typ: 'infobox',
        variante: 'hinweis',
        titel: 'Netto- oder Brutto-Stundensatz?',
        text: 'Der kalkulierte Stundensatz ist zunächst ein Netto-Satz — er deckt Ihre Kosten und Ihr Wunsch-Einkommen. Bei Regelbesteuerung kommen darauf 19 Prozent Umsatzsteuer, die Sie auf der Rechnung gesondert ausweisen und ans Finanzamt abführen. Für Geschäftskunden ist diese Umsatzsteuer ein durchlaufender Posten, den sie als Vorsteuer zurückholen — der Brutto-Satz ist für B2B-Kunden also kein echter Mehrpreis. Kleinunternehmer nach § 19 UStG weisen dagegen keine Umsatzsteuer aus. Der Tagessatz schließlich ergibt sich direkt aus dem Stundensatz: Stundensatz × produktive Stunden pro Tag. Bei 56,43 € und sechs Stunden sind das rund 339 € am Tag. Wer mit Tagessätzen kalkuliert, sollte dieselbe konservative Stundenbasis verwenden wie bei der Stundensatz-Rechnung, damit beide Werte zueinander passen. In manchen Branchen ist der Tagessatz die übliche Verhandlungsgröße, in anderen der Stundensatz — wichtig ist nur, dass beide aus derselben Kalkulation stammen und nicht unabhängig voneinander geschätzt werden.',
      },
      {
        typ: 'tabelle',
        titel: 'Kleinunternehmer oder Regelbesteuerung?',
        kopf: ['Merkmal', 'Kleinunternehmer (§ 19)', 'Regelbesteuerung'],
        zeilen: [
      ...
      },
      {
        ...
        variante: 'warnung',
        titel: 'Kurzfazit',
        text: 'Der nötige Stundensatz ergibt sich aus dem gewünschten Netto-Einkommen, allen Versicherungen, der Altersvorsorge, den Betriebskosten, der Einkommensteuer und den realistisch fakturierbaren Stunden — und liegt fast immer deutlich höher, als man auf den ersten Blick vermutet. Die naive Rechnung „Wunsch-Netto geteilt durch Monatsstunden" führt regelmäßig zu Sätzen, die nicht einmal die Sozialversicherung decken. Nutzen Sie das Ergebnis dieses Rechners als Orientierung für die eigene Kalkulation und Verhandlung, nicht als verbindliche Vorgabe: Die tatsächlich durchsetzbaren Honorare hängen von Branche, Erfahrung, Region und Verhandlungsgeschick ab. Dieser Rechner ersetzt keine Steuer- oder Honorarberatung — bei steuerlichen Fragen, etwa zur Besteuerungsform oder zur Gewinnermittlung, ist ein Steuerberater die richtige Adresse. Prüfen Sie Ihre Kalkulation außerdem mindestens einmal im Jahr und passen Sie den Satz an gestiegene Kosten und Marktveränderungen an.',
      },
    ],
    quellen: [
      { titel: 'UStG § 19 – Kleinunternehmer (Grenzen 25.000 € / 100.000 € seit 01.01.2025)', url: 'https://www.gesetze-im-internet.de/ustg_1980/__19.html' },
      { titel: 'BMF-Schreiben v. 18.03.2025 – Neuregelung der Kleinunternehmerbesteuerung', url: 'https://www.bundesfinanzministerium.de/' },
      { titel: 'EStG § 32a – Einkommensteuertarif (Brutto-Bedarf/Steuersatz)', url: 'https://www.gesetze-im-internet.de/estg/__32a.html' },
      { titel: 'Deutsche Rentenversicherung – Selbstständige & Altersvorsorge', url: 'https://www.deutsche-rentenversicherung.de/' },
    ],
  },
  {

...
export default function WitwenrenteRechner() {
  ...
  return (
    <div>
      {/* Art der Witwenrente */}
      <div className="mb-5">
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Art der Witwenrente</label>
        <div className="flex gap-2">
          <button
            onClick={() => setArt('gross')}
      ...
      {/* Kinder */}
      <div className="mb-4">
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Kinder unter 18 Jahren</label>
        <select
          value={kinder}

...
export default function PoolkostenRechner() {
  ...
  return (
    <div>
      {/* Poolgröße */}
      <div className="mb-5">
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Poolgröße</label>
        <select
          value={groesse}
      ...
      {/* Saison */}
      <div className="mb-5">
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Saison</label>
        <select
          value={saison}

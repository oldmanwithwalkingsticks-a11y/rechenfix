...
export default function KalorienRechner() {
  ...
  return (
    <div>
      ...
      {/* Aktivitätslevel */}
      <div className="mb-4">
        <label htmlFor="kalorien-select-1" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Aktivitätslevel</label>
        <select id="kalorien-select-1"
          value={aktivitaet}
      ...
      {ergebnis && nAlter > 0 && nGroesse > 0 && nGewicht > 0 && (
        <>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-5 mb-6">
            <h2 className="font-bold text-gray-700 dark:text-gray-200 mb-4">Makronährstoff-Verteilung</h2>
            <div className="space-y-3">
              {/* Protein */}
              <div>

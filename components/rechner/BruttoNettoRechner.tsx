...
export default function BruttoNettoRechner() {
  ...
  const erzeugePdf = async () => {
    ...
    autoTable(doc, {
      ...
      foot: [[{ content: 'Steuern gesamt', styles: { halign: 'left' } }, `- ${eur(ergebnis.steuernGesamt)}`]],
      theme: 'striped',
      headStyles: { fillColor: [29, 78, 216], textColor: 255, fontStyle: 'bold' },
      footStyles: { fillColor: [235, 240, 250], textColor: [30, 30, 30], fontStyle: 'bold', halign: 'right' },
    ...
    autoTable(doc, {
      ...
      foot: [[{ content: 'Sozialabgaben gesamt', styles: { halign: 'left' } }, `- ${eur(ergebnis.sozialabgabenGesamt)}`]],
      theme: 'striped',
      headStyles: { fillColor: [29, 78, 216], textColor: 255, fontStyle: 'bold' },
      footStyles: { fillColor: [235, 240, 250], textColor: [30, 30, 30], fontStyle: 'bold', halign: 'right' },
      columnStyles: { 1: { halign: 'right' } },

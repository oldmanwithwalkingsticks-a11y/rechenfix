  ...
  return (
    <footer className="bg-primary-700 dark:bg-slate-950 text-white mt-16 no-print">
      <div className="max-w-6xl mx-auto px-4">
        {/* Hauptbereich */}
        <div className="py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.15fr_1.05fr_1.15fr_0.85fr_0.62fr] gap-8 lg:gap-6 xl:gap-8">
          {/* Logo & Beschreibung */}
          <div>
          ...
          {/* Mehr — seit W72 eine eigene Rasterspalte, damit die Ueberschrift oben mitlaeuft. */}
          <div>
